...
ffffffffc020006e:	6c6030ef          	jal	ra,ffffffffc0203734 <vmm_init>
...
ffffffffc02000ac:	c602                	sw	zero,12(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02000ae:	705030ef          	jal	ra,ffffffffc0203fb2 <vprintfmt>
    return cnt;
}
...
ffffffffc02000e2:	c202                	sw	zero,4(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02000e4:	6cf030ef          	jal	ra,ffffffffc0203fb2 <vprintfmt>
    cnt = vcprintf(fmt, ap);
    va_end(ap);
    return cnt;
}
...
ffffffffc0200188:	3d450513          	addi	a0,a0,980 # ffffffffc0204558 <etext+0xca>
}
...
ffffffffc0200196:	3f660613          	addi	a2,a2,1014 # ffffffffc0204588 <etext+0xfa>
ffffffffc020019a:	04e00593          	li	a1,78
ffffffffc020019e:	00004517          	auipc	a0,0x4
ffffffffc02001a2:	40250513          	addi	a0,a0,1026 # ffffffffc02045a0 <etext+0x112>
void print_stackframe(void) {
...
ffffffffc02001b2:	40a60613          	addi	a2,a2,1034 # ffffffffc02045b8 <etext+0x12a>
ffffffffc02001b6:	00004597          	auipc	a1,0x4
ffffffffc02001ba:	42258593          	addi	a1,a1,1058 # ffffffffc02045d8 <etext+0x14a>
ffffffffc02001be:	00004517          	auipc	a0,0x4
ffffffffc02001c2:	42250513          	addi	a0,a0,1058 # ffffffffc02045e0 <etext+0x152>
mon_help(int argc, char **argv, struct trapframe *tf) {
...
ffffffffc02001d0:	42460613          	addi	a2,a2,1060 # ffffffffc02045f0 <etext+0x162>
ffffffffc02001d4:	00004597          	auipc	a1,0x4
ffffffffc02001d8:	44458593          	addi	a1,a1,1092 # ffffffffc0204618 <etext+0x18a>
ffffffffc02001dc:	00004517          	auipc	a0,0x4
ffffffffc02001e0:	40450513          	addi	a0,a0,1028 # ffffffffc02045e0 <etext+0x152>
ffffffffc02001e4:	ed7ff0ef          	jal	ra,ffffffffc02000ba <cprintf>
ffffffffc02001e8:	00004617          	auipc	a2,0x4
ffffffffc02001ec:	44060613          	addi	a2,a2,1088 # ffffffffc0204628 <etext+0x19a>
ffffffffc02001f0:	00004597          	auipc	a1,0x4
ffffffffc02001f4:	45858593          	addi	a1,a1,1112 # ffffffffc0204648 <etext+0x1ba>
ffffffffc02001f8:	00004517          	auipc	a0,0x4
ffffffffc02001fc:	3e850513          	addi	a0,a0,1000 # ffffffffc02045e0 <etext+0x152>
...
ffffffffc0200236:	42650513          	addi	a0,a0,1062 # ffffffffc0204658 <etext+0x1ca>
kmonitor(struct trapframe *tf) {
...
ffffffffc0200258:	42c50513          	addi	a0,a0,1068 # ffffffffc0204680 <etext+0x1f2>
...
ffffffffc020026e:	47ec0c13          	addi	s8,s8,1150 # ffffffffc02046e8 <commands>
...
ffffffffc020027e:	42e48493          	addi	s1,s1,1070 # ffffffffc02046a8 <etext+0x21a>
        if (argc == MAXARGS - 1) {
ffffffffc0200282:	49bd                	li	s3,15
            cprintf("Too many arguments (max %d).\n", MAXARGS);
ffffffffc0200284:	00004b17          	auipc	s6,0x4
ffffffffc0200288:	42cb0b13          	addi	s6,s6,1068 # ffffffffc02046b0 <etext+0x222>
        argv[argc ++] = buf;
ffffffffc020028c:	00004a17          	auipc	s4,0x4
ffffffffc0200290:	34ca0a13          	addi	s4,s4,844 # ffffffffc02045d8 <etext+0x14a>
    for (i = 0; i < NCOMMANDS; i ++) {
ffffffffc0200294:	4a8d                	li	s5,3
        if ((buf = readline("")) != NULL) {
ffffffffc0200296:	854a                	mv	a0,s2
ffffffffc0200298:	09c040ef          	jal	ra,ffffffffc0204334 <readline>
...
ffffffffc02002b2:	43ad0d13          	addi	s10,s10,1082 # ffffffffc02046e8 <commands>
        argv[argc ++] = buf;
...
ffffffffc02002ba:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02002bc:	174040ef          	jal	ra,ffffffffc0204430 <strcmp>
...
ffffffffc02002ce:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02002d0:	160040ef          	jal	ra,ffffffffc0204430 <strcmp>
...
ffffffffc020030e:	140040ef          	jal	ra,ffffffffc020444e <strchr>
...
ffffffffc020034c:	102040ef          	jal	ra,ffffffffc020444e <strchr>
...
ffffffffc020036a:	36a50513          	addi	a0,a0,874 # ffffffffc02046d0 <etext+0x242>
...
ffffffffc02003a6:	38e50513          	addi	a0,a0,910 # ffffffffc0204730 <commands+0x48>
    va_start(ap, fmt);
...
ffffffffc02003fa:	35a50513          	addi	a0,a0,858 # ffffffffc0204750 <commands+0x68>
    ticks = 0;
...
ffffffffc02004b6:	e406                	sd	ra,8(sp)
    memcpy(dst, &ide[iobase], nsecs * SECTSIZE);
ffffffffc02004b8:	7bf030ef          	jal	ra,ffffffffc0204476 <memcpy>
    return 0;
}
...
ffffffffc02004da:	e406                	sd	ra,8(sp)
    memcpy(&ide[iobase], src, nsecs * SECTSIZE);
ffffffffc02004dc:	79b030ef          	jal	ra,ffffffffc0204476 <memcpy>
    return 0;
}
...
ffffffffc0200528:	24c50513          	addi	a0,a0,588 # ffffffffc0204770 <commands+0x88>
...
ffffffffc0200546:	0141                	addi	sp,sp,16
        return do_pgfault(check_mm_struct, tf->cause, tf->badvaddr);
ffffffffc0200548:	7c40306f          	j	ffffffffc0203d0c <do_pgfault>
    panic("unhandled page fault.\n");
ffffffffc020054c:	00004617          	auipc	a2,0x4
ffffffffc0200550:	24460613          	addi	a2,a2,580 # ffffffffc0204790 <commands+0xa8>
ffffffffc0200554:	07800593          	li	a1,120
ffffffffc0200558:	00004517          	auipc	a0,0x4
ffffffffc020055c:	25050513          	addi	a0,a0,592 # ffffffffc02047a8 <commands+0xc0>
...
ffffffffc020058e:	23650513          	addi	a0,a0,566 # ffffffffc02047c0 <commands+0xd8>
void print_regs(struct pushregs *gpr) {
...
ffffffffc0200746:	36650513          	addi	a0,a0,870 # ffffffffc0204aa8 <commands+0x3c0>
}
...
ffffffffc020075a:	36a50513          	addi	a0,a0,874 # ffffffffc0204ac0 <commands+0x3d8>
void print_trapframe(struct trapframe *tf) {
...
ffffffffc0200772:	36a50513          	addi	a0,a0,874 # ffffffffc0204ad8 <commands+0x3f0>
ffffffffc0200776:	945ff0ef          	jal	ra,ffffffffc02000ba <cprintf>
    cprintf("  epc      0x%08x\n", tf->epc);
ffffffffc020077a:	10843583          	ld	a1,264(s0)
ffffffffc020077e:	00004517          	auipc	a0,0x4
ffffffffc0200782:	37250513          	addi	a0,a0,882 # ffffffffc0204af0 <commands+0x408>
ffffffffc0200786:	935ff0ef          	jal	ra,ffffffffc02000ba <cprintf>
    cprintf("  badvaddr 0x%08x\n", tf->badvaddr);
ffffffffc020078a:	11043583          	ld	a1,272(s0)
ffffffffc020078e:	00004517          	auipc	a0,0x4
ffffffffc0200792:	37a50513          	addi	a0,a0,890 # ffffffffc0204b08 <commands+0x420>
...
ffffffffc02007a6:	37e50513          	addi	a0,a0,894 # ffffffffc0204b20 <commands+0x438>
}
...
ffffffffc02007c2:	42a70713          	addi	a4,a4,1066 # ffffffffc0204be8 <commands+0x500>
...
ffffffffc02007d4:	3c850513          	addi	a0,a0,968 # ffffffffc0204b98 <commands+0x4b0>
ffffffffc02007d8:	8e3ff06f          	j	ffffffffc02000ba <cprintf>
            cprintf("Hypervisor software interrupt\n");
ffffffffc02007dc:	00004517          	auipc	a0,0x4
ffffffffc02007e0:	39c50513          	addi	a0,a0,924 # ffffffffc0204b78 <commands+0x490>
ffffffffc02007e4:	8d7ff06f          	j	ffffffffc02000ba <cprintf>
            cprintf("User software interrupt\n");
ffffffffc02007e8:	00004517          	auipc	a0,0x4
ffffffffc02007ec:	35050513          	addi	a0,a0,848 # ffffffffc0204b38 <commands+0x450>
ffffffffc02007f0:	8cbff06f          	j	ffffffffc02000ba <cprintf>
            cprintf("Supervisor software interrupt\n");
ffffffffc02007f4:	00004517          	auipc	a0,0x4
ffffffffc02007f8:	36450513          	addi	a0,a0,868 # ffffffffc0204b58 <commands+0x470>
...
ffffffffc020082a:	3a250513          	addi	a0,a0,930 # ffffffffc0204bc8 <commands+0x4e0>
...
ffffffffc020083e:	37e50513          	addi	a0,a0,894 # ffffffffc0204bb8 <commands+0x4d0>
}
...
ffffffffc0200860:	57470713          	addi	a4,a4,1396 # ffffffffc0204dd0 <commands+0x6e8>
...
ffffffffc0200872:	54a50513          	addi	a0,a0,1354 # ffffffffc0204db8 <commands+0x6d0>
...
ffffffffc0200894:	38850513          	addi	a0,a0,904 # ffffffffc0204c18 <commands+0x530>
}
...
ffffffffc02008a8:	39450513          	addi	a0,a0,916 # ffffffffc0204c38 <commands+0x550>
ffffffffc02008ac:	b7f5                	j	ffffffffc0200898 <exception_handler+0x50>
            cprintf("Illegal instruction\n");
ffffffffc02008ae:	00004517          	auipc	a0,0x4
ffffffffc02008b2:	3aa50513          	addi	a0,a0,938 # ffffffffc0204c58 <commands+0x570>
ffffffffc02008b6:	b7cd                	j	ffffffffc0200898 <exception_handler+0x50>
            cprintf("Breakpoint\n");
ffffffffc02008b8:	00004517          	auipc	a0,0x4
ffffffffc02008bc:	3b850513          	addi	a0,a0,952 # ffffffffc0204c70 <commands+0x588>
ffffffffc02008c0:	bfe1                	j	ffffffffc0200898 <exception_handler+0x50>
            cprintf("Load address misaligned\n");
ffffffffc02008c2:	00004517          	auipc	a0,0x4
ffffffffc02008c6:	3be50513          	addi	a0,a0,958 # ffffffffc0204c80 <commands+0x598>
ffffffffc02008ca:	b7f9                	j	ffffffffc0200898 <exception_handler+0x50>
            cprintf("Load access fault\n");
ffffffffc02008cc:	00004517          	auipc	a0,0x4
ffffffffc02008d0:	3d450513          	addi	a0,a0,980 # ffffffffc0204ca0 <commands+0x5b8>
...
ffffffffc02008ee:	3ce60613          	addi	a2,a2,974 # ffffffffc0204cb8 <commands+0x5d0>
ffffffffc02008f2:	0ca00593          	li	a1,202
ffffffffc02008f6:	00004517          	auipc	a0,0x4
ffffffffc02008fa:	eb250513          	addi	a0,a0,-334 # ffffffffc02047a8 <commands+0xc0>
ffffffffc02008fe:	a77ff0ef          	jal	ra,ffffffffc0200374 <__panic>
            cprintf("AMO address misaligned\n");
ffffffffc0200902:	00004517          	auipc	a0,0x4
ffffffffc0200906:	3d650513          	addi	a0,a0,982 # ffffffffc0204cd8 <commands+0x5f0>
ffffffffc020090a:	b779                	j	ffffffffc0200898 <exception_handler+0x50>
            cprintf("Store/AMO access fault\n");
ffffffffc020090c:	00004517          	auipc	a0,0x4
ffffffffc0200910:	3e450513          	addi	a0,a0,996 # ffffffffc0204cf0 <commands+0x608>
...
ffffffffc0200998:	32460613          	addi	a2,a2,804 # ffffffffc0204cb8 <commands+0x5d0>
ffffffffc020099c:	0ea00593          	li	a1,234
ffffffffc02009a0:	00004517          	auipc	a0,0x4
ffffffffc02009a4:	e0850513          	addi	a0,a0,-504 # ffffffffc02047a8 <commands+0xc0>
...
ffffffffc02009c4:	2f860613          	addi	a2,a2,760 # ffffffffc0204cb8 <commands+0x5d0>
ffffffffc02009c8:	0f100593          	li	a1,241
ffffffffc02009cc:	00004517          	auipc	a0,0x4
ffffffffc02009d0:	ddc50513          	addi	a0,a0,-548 # ffffffffc02047a8 <commands+0xc0>
...
ffffffffc0200b6e:	80e5b583          	ld	a1,-2034(a1) # ffffffffc0206378 <error_string+0x38>
ffffffffc0200b72:	02b70733          	mul	a4,a4,a1
ffffffffc0200b76:	00006617          	auipc	a2,0x6
ffffffffc0200b7a:	80a63603          	ld	a2,-2038(a2) # ffffffffc0206380 <nbase>
...
ffffffffc0200dc6:	04e68693          	addi	a3,a3,78 # ffffffffc0204e10 <commands+0x728>
ffffffffc0200dca:	00004617          	auipc	a2,0x4
ffffffffc0200dce:	05660613          	addi	a2,a2,86 # ffffffffc0204e20 <commands+0x738>
ffffffffc0200dd2:	0f000593          	li	a1,240
ffffffffc0200dd6:	00004517          	auipc	a0,0x4
ffffffffc0200dda:	06250513          	addi	a0,a0,98 # ffffffffc0204e38 <commands+0x750>
ffffffffc0200dde:	d96ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(p0 != p1 && p0 != p2 && p1 != p2);
ffffffffc0200de2:	00004697          	auipc	a3,0x4
ffffffffc0200de6:	0ee68693          	addi	a3,a3,238 # ffffffffc0204ed0 <commands+0x7e8>
ffffffffc0200dea:	00004617          	auipc	a2,0x4
ffffffffc0200dee:	03660613          	addi	a2,a2,54 # ffffffffc0204e20 <commands+0x738>
ffffffffc0200df2:	0bd00593          	li	a1,189
ffffffffc0200df6:	00004517          	auipc	a0,0x4
ffffffffc0200dfa:	04250513          	addi	a0,a0,66 # ffffffffc0204e38 <commands+0x750>
ffffffffc0200dfe:	d76ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p0) == 0 && page_ref(p1) == 0 && page_ref(p2) == 0);
ffffffffc0200e02:	00004697          	auipc	a3,0x4
ffffffffc0200e06:	0f668693          	addi	a3,a3,246 # ffffffffc0204ef8 <commands+0x810>
ffffffffc0200e0a:	00004617          	auipc	a2,0x4
ffffffffc0200e0e:	01660613          	addi	a2,a2,22 # ffffffffc0204e20 <commands+0x738>
ffffffffc0200e12:	0be00593          	li	a1,190
ffffffffc0200e16:	00004517          	auipc	a0,0x4
ffffffffc0200e1a:	02250513          	addi	a0,a0,34 # ffffffffc0204e38 <commands+0x750>
ffffffffc0200e1e:	d56ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page2pa(p0) < npage * PGSIZE);
ffffffffc0200e22:	00004697          	auipc	a3,0x4
ffffffffc0200e26:	11668693          	addi	a3,a3,278 # ffffffffc0204f38 <commands+0x850>
ffffffffc0200e2a:	00004617          	auipc	a2,0x4
ffffffffc0200e2e:	ff660613          	addi	a2,a2,-10 # ffffffffc0204e20 <commands+0x738>
ffffffffc0200e32:	0c000593          	li	a1,192
ffffffffc0200e36:	00004517          	auipc	a0,0x4
ffffffffc0200e3a:	00250513          	addi	a0,a0,2 # ffffffffc0204e38 <commands+0x750>
ffffffffc0200e3e:	d36ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(!list_empty(&free_list));
ffffffffc0200e42:	00004697          	auipc	a3,0x4
ffffffffc0200e46:	17e68693          	addi	a3,a3,382 # ffffffffc0204fc0 <commands+0x8d8>
ffffffffc0200e4a:	00004617          	auipc	a2,0x4
ffffffffc0200e4e:	fd660613          	addi	a2,a2,-42 # ffffffffc0204e20 <commands+0x738>
ffffffffc0200e52:	0d900593          	li	a1,217
ffffffffc0200e56:	00004517          	auipc	a0,0x4
ffffffffc0200e5a:	fe250513          	addi	a0,a0,-30 # ffffffffc0204e38 <commands+0x750>
ffffffffc0200e5e:	d16ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc0200e62:	00004697          	auipc	a3,0x4
ffffffffc0200e66:	00e68693          	addi	a3,a3,14 # ffffffffc0204e70 <commands+0x788>
ffffffffc0200e6a:	00004617          	auipc	a2,0x4
ffffffffc0200e6e:	fb660613          	addi	a2,a2,-74 # ffffffffc0204e20 <commands+0x738>
ffffffffc0200e72:	0d200593          	li	a1,210
ffffffffc0200e76:	00004517          	auipc	a0,0x4
ffffffffc0200e7a:	fc250513          	addi	a0,a0,-62 # ffffffffc0204e38 <commands+0x750>
ffffffffc0200e7e:	cf6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free == 3);
ffffffffc0200e82:	00004697          	auipc	a3,0x4
ffffffffc0200e86:	12e68693          	addi	a3,a3,302 # ffffffffc0204fb0 <commands+0x8c8>
ffffffffc0200e8a:	00004617          	auipc	a2,0x4
ffffffffc0200e8e:	f9660613          	addi	a2,a2,-106 # ffffffffc0204e20 <commands+0x738>
ffffffffc0200e92:	0d000593          	li	a1,208
ffffffffc0200e96:	00004517          	auipc	a0,0x4
ffffffffc0200e9a:	fa250513          	addi	a0,a0,-94 # ffffffffc0204e38 <commands+0x750>
ffffffffc0200e9e:	cd6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0200ea2:	00004697          	auipc	a3,0x4
ffffffffc0200ea6:	0f668693          	addi	a3,a3,246 # ffffffffc0204f98 <commands+0x8b0>
ffffffffc0200eaa:	00004617          	auipc	a2,0x4
ffffffffc0200eae:	f7660613          	addi	a2,a2,-138 # ffffffffc0204e20 <commands+0x738>
ffffffffc0200eb2:	0cb00593          	li	a1,203
ffffffffc0200eb6:	00004517          	auipc	a0,0x4
ffffffffc0200eba:	f8250513          	addi	a0,a0,-126 # ffffffffc0204e38 <commands+0x750>
ffffffffc0200ebe:	cb6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page2pa(p2) < npage * PGSIZE);
ffffffffc0200ec2:	00004697          	auipc	a3,0x4
ffffffffc0200ec6:	0b668693          	addi	a3,a3,182 # ffffffffc0204f78 <commands+0x890>
ffffffffc0200eca:	00004617          	auipc	a2,0x4
ffffffffc0200ece:	f5660613          	addi	a2,a2,-170 # ffffffffc0204e20 <commands+0x738>
ffffffffc0200ed2:	0c200593          	li	a1,194
ffffffffc0200ed6:	00004517          	auipc	a0,0x4
ffffffffc0200eda:	f6250513          	addi	a0,a0,-158 # ffffffffc0204e38 <commands+0x750>
ffffffffc0200ede:	c96ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(p0 != NULL);
ffffffffc0200ee2:	00004697          	auipc	a3,0x4
ffffffffc0200ee6:	12668693          	addi	a3,a3,294 # ffffffffc0205008 <commands+0x920>
ffffffffc0200eea:	00004617          	auipc	a2,0x4
ffffffffc0200eee:	f3660613          	addi	a2,a2,-202 # ffffffffc0204e20 <commands+0x738>
ffffffffc0200ef2:	0f800593          	li	a1,248
ffffffffc0200ef6:	00004517          	auipc	a0,0x4
ffffffffc0200efa:	f4250513          	addi	a0,a0,-190 # ffffffffc0204e38 <commands+0x750>
ffffffffc0200efe:	c76ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free == 0);
ffffffffc0200f02:	00004697          	auipc	a3,0x4
ffffffffc0200f06:	0f668693          	addi	a3,a3,246 # ffffffffc0204ff8 <commands+0x910>
ffffffffc0200f0a:	00004617          	auipc	a2,0x4
ffffffffc0200f0e:	f1660613          	addi	a2,a2,-234 # ffffffffc0204e20 <commands+0x738>
ffffffffc0200f12:	0df00593          	li	a1,223
ffffffffc0200f16:	00004517          	auipc	a0,0x4
ffffffffc0200f1a:	f2250513          	addi	a0,a0,-222 # ffffffffc0204e38 <commands+0x750>
ffffffffc0200f1e:	c56ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0200f22:	00004697          	auipc	a3,0x4
ffffffffc0200f26:	07668693          	addi	a3,a3,118 # ffffffffc0204f98 <commands+0x8b0>
ffffffffc0200f2a:	00004617          	auipc	a2,0x4
ffffffffc0200f2e:	ef660613          	addi	a2,a2,-266 # ffffffffc0204e20 <commands+0x738>
ffffffffc0200f32:	0dd00593          	li	a1,221
ffffffffc0200f36:	00004517          	auipc	a0,0x4
ffffffffc0200f3a:	f0250513          	addi	a0,a0,-254 # ffffffffc0204e38 <commands+0x750>
ffffffffc0200f3e:	c36ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p = alloc_page()) == p0);
ffffffffc0200f42:	00004697          	auipc	a3,0x4
ffffffffc0200f46:	09668693          	addi	a3,a3,150 # ffffffffc0204fd8 <commands+0x8f0>
ffffffffc0200f4a:	00004617          	auipc	a2,0x4
ffffffffc0200f4e:	ed660613          	addi	a2,a2,-298 # ffffffffc0204e20 <commands+0x738>
ffffffffc0200f52:	0dc00593          	li	a1,220
ffffffffc0200f56:	00004517          	auipc	a0,0x4
ffffffffc0200f5a:	ee250513          	addi	a0,a0,-286 # ffffffffc0204e38 <commands+0x750>
ffffffffc0200f5e:	c16ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc0200f62:	00004697          	auipc	a3,0x4
ffffffffc0200f66:	f0e68693          	addi	a3,a3,-242 # ffffffffc0204e70 <commands+0x788>
ffffffffc0200f6a:	00004617          	auipc	a2,0x4
ffffffffc0200f6e:	eb660613          	addi	a2,a2,-330 # ffffffffc0204e20 <commands+0x738>
ffffffffc0200f72:	0b900593          	li	a1,185
ffffffffc0200f76:	00004517          	auipc	a0,0x4
ffffffffc0200f7a:	ec250513          	addi	a0,a0,-318 # ffffffffc0204e38 <commands+0x750>
ffffffffc0200f7e:	bf6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0200f82:	00004697          	auipc	a3,0x4
ffffffffc0200f86:	01668693          	addi	a3,a3,22 # ffffffffc0204f98 <commands+0x8b0>
ffffffffc0200f8a:	00004617          	auipc	a2,0x4
ffffffffc0200f8e:	e9660613          	addi	a2,a2,-362 # ffffffffc0204e20 <commands+0x738>
ffffffffc0200f92:	0d600593          	li	a1,214
ffffffffc0200f96:	00004517          	auipc	a0,0x4
ffffffffc0200f9a:	ea250513          	addi	a0,a0,-350 # ffffffffc0204e38 <commands+0x750>
ffffffffc0200f9e:	bd6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc0200fa2:	00004697          	auipc	a3,0x4
ffffffffc0200fa6:	f0e68693          	addi	a3,a3,-242 # ffffffffc0204eb0 <commands+0x7c8>
ffffffffc0200faa:	00004617          	auipc	a2,0x4
ffffffffc0200fae:	e7660613          	addi	a2,a2,-394 # ffffffffc0204e20 <commands+0x738>
ffffffffc0200fb2:	0d400593          	li	a1,212
ffffffffc0200fb6:	00004517          	auipc	a0,0x4
ffffffffc0200fba:	e8250513          	addi	a0,a0,-382 # ffffffffc0204e38 <commands+0x750>
ffffffffc0200fbe:	bb6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc0200fc2:	00004697          	auipc	a3,0x4
ffffffffc0200fc6:	ece68693          	addi	a3,a3,-306 # ffffffffc0204e90 <commands+0x7a8>
ffffffffc0200fca:	00004617          	auipc	a2,0x4
ffffffffc0200fce:	e5660613          	addi	a2,a2,-426 # ffffffffc0204e20 <commands+0x738>
ffffffffc0200fd2:	0d300593          	li	a1,211
ffffffffc0200fd6:	00004517          	auipc	a0,0x4
ffffffffc0200fda:	e6250513          	addi	a0,a0,-414 # ffffffffc0204e38 <commands+0x750>
ffffffffc0200fde:	b96ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc0200fe2:	00004697          	auipc	a3,0x4
ffffffffc0200fe6:	ece68693          	addi	a3,a3,-306 # ffffffffc0204eb0 <commands+0x7c8>
ffffffffc0200fea:	00004617          	auipc	a2,0x4
ffffffffc0200fee:	e3660613          	addi	a2,a2,-458 # ffffffffc0204e20 <commands+0x738>
ffffffffc0200ff2:	0bb00593          	li	a1,187
ffffffffc0200ff6:	00004517          	auipc	a0,0x4
ffffffffc0200ffa:	e4250513          	addi	a0,a0,-446 # ffffffffc0204e38 <commands+0x750>
ffffffffc0200ffe:	b76ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(count == 0);
ffffffffc0201002:	00004697          	auipc	a3,0x4
ffffffffc0201006:	15668693          	addi	a3,a3,342 # ffffffffc0205158 <commands+0xa70>
ffffffffc020100a:	00004617          	auipc	a2,0x4
ffffffffc020100e:	e1660613          	addi	a2,a2,-490 # ffffffffc0204e20 <commands+0x738>
ffffffffc0201012:	12500593          	li	a1,293
ffffffffc0201016:	00004517          	auipc	a0,0x4
ffffffffc020101a:	e2250513          	addi	a0,a0,-478 # ffffffffc0204e38 <commands+0x750>
ffffffffc020101e:	b56ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free == 0);
ffffffffc0201022:	00004697          	auipc	a3,0x4
ffffffffc0201026:	fd668693          	addi	a3,a3,-42 # ffffffffc0204ff8 <commands+0x910>
ffffffffc020102a:	00004617          	auipc	a2,0x4
ffffffffc020102e:	df660613          	addi	a2,a2,-522 # ffffffffc0204e20 <commands+0x738>
ffffffffc0201032:	11a00593          	li	a1,282
ffffffffc0201036:	00004517          	auipc	a0,0x4
ffffffffc020103a:	e0250513          	addi	a0,a0,-510 # ffffffffc0204e38 <commands+0x750>
ffffffffc020103e:	b36ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201042:	00004697          	auipc	a3,0x4
ffffffffc0201046:	f5668693          	addi	a3,a3,-170 # ffffffffc0204f98 <commands+0x8b0>
ffffffffc020104a:	00004617          	auipc	a2,0x4
ffffffffc020104e:	dd660613          	addi	a2,a2,-554 # ffffffffc0204e20 <commands+0x738>
ffffffffc0201052:	11800593          	li	a1,280
ffffffffc0201056:	00004517          	auipc	a0,0x4
ffffffffc020105a:	de250513          	addi	a0,a0,-542 # ffffffffc0204e38 <commands+0x750>
ffffffffc020105e:	b16ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page2pa(p1) < npage * PGSIZE);
ffffffffc0201062:	00004697          	auipc	a3,0x4
ffffffffc0201066:	ef668693          	addi	a3,a3,-266 # ffffffffc0204f58 <commands+0x870>
ffffffffc020106a:	00004617          	auipc	a2,0x4
ffffffffc020106e:	db660613          	addi	a2,a2,-586 # ffffffffc0204e20 <commands+0x738>
ffffffffc0201072:	0c100593          	li	a1,193
ffffffffc0201076:	00004517          	auipc	a0,0x4
ffffffffc020107a:	dc250513          	addi	a0,a0,-574 # ffffffffc0204e38 <commands+0x750>
ffffffffc020107e:	af6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p0 = alloc_pages(2)) == p2 + 1);
ffffffffc0201082:	00004697          	auipc	a3,0x4
ffffffffc0201086:	09668693          	addi	a3,a3,150 # ffffffffc0205118 <commands+0xa30>
ffffffffc020108a:	00004617          	auipc	a2,0x4
ffffffffc020108e:	d9660613          	addi	a2,a2,-618 # ffffffffc0204e20 <commands+0x738>
ffffffffc0201092:	11200593          	li	a1,274
ffffffffc0201096:	00004517          	auipc	a0,0x4
ffffffffc020109a:	da250513          	addi	a0,a0,-606 # ffffffffc0204e38 <commands+0x750>
ffffffffc020109e:	ad6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p0 = alloc_page()) == p2 - 1);
ffffffffc02010a2:	00004697          	auipc	a3,0x4
ffffffffc02010a6:	05668693          	addi	a3,a3,86 # ffffffffc02050f8 <commands+0xa10>
ffffffffc02010aa:	00004617          	auipc	a2,0x4
ffffffffc02010ae:	d7660613          	addi	a2,a2,-650 # ffffffffc0204e20 <commands+0x738>
ffffffffc02010b2:	11000593          	li	a1,272
ffffffffc02010b6:	00004517          	auipc	a0,0x4
ffffffffc02010ba:	d8250513          	addi	a0,a0,-638 # ffffffffc0204e38 <commands+0x750>
ffffffffc02010be:	ab6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(PageProperty(p1) && p1->property == 3);
ffffffffc02010c2:	00004697          	auipc	a3,0x4
ffffffffc02010c6:	00e68693          	addi	a3,a3,14 # ffffffffc02050d0 <commands+0x9e8>
ffffffffc02010ca:	00004617          	auipc	a2,0x4
ffffffffc02010ce:	d5660613          	addi	a2,a2,-682 # ffffffffc0204e20 <commands+0x738>
ffffffffc02010d2:	10e00593          	li	a1,270
ffffffffc02010d6:	00004517          	auipc	a0,0x4
ffffffffc02010da:	d6250513          	addi	a0,a0,-670 # ffffffffc0204e38 <commands+0x750>
ffffffffc02010de:	a96ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(PageProperty(p0) && p0->property == 1);
ffffffffc02010e2:	00004697          	auipc	a3,0x4
ffffffffc02010e6:	fc668693          	addi	a3,a3,-58 # ffffffffc02050a8 <commands+0x9c0>
ffffffffc02010ea:	00004617          	auipc	a2,0x4
ffffffffc02010ee:	d3660613          	addi	a2,a2,-714 # ffffffffc0204e20 <commands+0x738>
ffffffffc02010f2:	10d00593          	li	a1,269
ffffffffc02010f6:	00004517          	auipc	a0,0x4
ffffffffc02010fa:	d4250513          	addi	a0,a0,-702 # ffffffffc0204e38 <commands+0x750>
ffffffffc02010fe:	a76ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(p0 + 2 == p1);
ffffffffc0201102:	00004697          	auipc	a3,0x4
ffffffffc0201106:	f9668693          	addi	a3,a3,-106 # ffffffffc0205098 <commands+0x9b0>
ffffffffc020110a:	00004617          	auipc	a2,0x4
ffffffffc020110e:	d1660613          	addi	a2,a2,-746 # ffffffffc0204e20 <commands+0x738>
ffffffffc0201112:	10800593          	li	a1,264
ffffffffc0201116:	00004517          	auipc	a0,0x4
ffffffffc020111a:	d2250513          	addi	a0,a0,-734 # ffffffffc0204e38 <commands+0x750>
ffffffffc020111e:	a56ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201122:	00004697          	auipc	a3,0x4
ffffffffc0201126:	e7668693          	addi	a3,a3,-394 # ffffffffc0204f98 <commands+0x8b0>
ffffffffc020112a:	00004617          	auipc	a2,0x4
ffffffffc020112e:	cf660613          	addi	a2,a2,-778 # ffffffffc0204e20 <commands+0x738>
ffffffffc0201132:	10700593          	li	a1,263
ffffffffc0201136:	00004517          	auipc	a0,0x4
ffffffffc020113a:	d0250513          	addi	a0,a0,-766 # ffffffffc0204e38 <commands+0x750>
ffffffffc020113e:	a36ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p1 = alloc_pages(3)) != NULL);
ffffffffc0201142:	00004697          	auipc	a3,0x4
ffffffffc0201146:	f3668693          	addi	a3,a3,-202 # ffffffffc0205078 <commands+0x990>
ffffffffc020114a:	00004617          	auipc	a2,0x4
ffffffffc020114e:	cd660613          	addi	a2,a2,-810 # ffffffffc0204e20 <commands+0x738>
ffffffffc0201152:	10600593          	li	a1,262
ffffffffc0201156:	00004517          	auipc	a0,0x4
ffffffffc020115a:	ce250513          	addi	a0,a0,-798 # ffffffffc0204e38 <commands+0x750>
ffffffffc020115e:	a16ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(PageProperty(p0 + 2) && p0[2].property == 3);
ffffffffc0201162:	00004697          	auipc	a3,0x4
ffffffffc0201166:	ee668693          	addi	a3,a3,-282 # ffffffffc0205048 <commands+0x960>
ffffffffc020116a:	00004617          	auipc	a2,0x4
ffffffffc020116e:	cb660613          	addi	a2,a2,-842 # ffffffffc0204e20 <commands+0x738>
ffffffffc0201172:	10500593          	li	a1,261
ffffffffc0201176:	00004517          	auipc	a0,0x4
ffffffffc020117a:	cc250513          	addi	a0,a0,-830 # ffffffffc0204e38 <commands+0x750>
ffffffffc020117e:	9f6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_pages(4) == NULL);
ffffffffc0201182:	00004697          	auipc	a3,0x4
ffffffffc0201186:	eae68693          	addi	a3,a3,-338 # ffffffffc0205030 <commands+0x948>
ffffffffc020118a:	00004617          	auipc	a2,0x4
ffffffffc020118e:	c9660613          	addi	a2,a2,-874 # ffffffffc0204e20 <commands+0x738>
ffffffffc0201192:	10400593          	li	a1,260
ffffffffc0201196:	00004517          	auipc	a0,0x4
ffffffffc020119a:	ca250513          	addi	a0,a0,-862 # ffffffffc0204e38 <commands+0x750>
ffffffffc020119e:	9d6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc02011a2:	00004697          	auipc	a3,0x4
ffffffffc02011a6:	df668693          	addi	a3,a3,-522 # ffffffffc0204f98 <commands+0x8b0>
ffffffffc02011aa:	00004617          	auipc	a2,0x4
ffffffffc02011ae:	c7660613          	addi	a2,a2,-906 # ffffffffc0204e20 <commands+0x738>
ffffffffc02011b2:	0fe00593          	li	a1,254
ffffffffc02011b6:	00004517          	auipc	a0,0x4
ffffffffc02011ba:	c8250513          	addi	a0,a0,-894 # ffffffffc0204e38 <commands+0x750>
ffffffffc02011be:	9b6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(!PageProperty(p0));
ffffffffc02011c2:	00004697          	auipc	a3,0x4
ffffffffc02011c6:	e5668693          	addi	a3,a3,-426 # ffffffffc0205018 <commands+0x930>
ffffffffc02011ca:	00004617          	auipc	a2,0x4
ffffffffc02011ce:	c5660613          	addi	a2,a2,-938 # ffffffffc0204e20 <commands+0x738>
ffffffffc02011d2:	0f900593          	li	a1,249
ffffffffc02011d6:	00004517          	auipc	a0,0x4
ffffffffc02011da:	c6250513          	addi	a0,a0,-926 # ffffffffc0204e38 <commands+0x750>
ffffffffc02011de:	996ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p0 = alloc_pages(5)) != NULL);
ffffffffc02011e2:	00004697          	auipc	a3,0x4
ffffffffc02011e6:	f5668693          	addi	a3,a3,-170 # ffffffffc0205138 <commands+0xa50>
ffffffffc02011ea:	00004617          	auipc	a2,0x4
ffffffffc02011ee:	c3660613          	addi	a2,a2,-970 # ffffffffc0204e20 <commands+0x738>
ffffffffc02011f2:	11700593          	li	a1,279
ffffffffc02011f6:	00004517          	auipc	a0,0x4
ffffffffc02011fa:	c4250513          	addi	a0,a0,-958 # ffffffffc0204e38 <commands+0x750>
ffffffffc02011fe:	976ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(total == 0);
ffffffffc0201202:	00004697          	auipc	a3,0x4
ffffffffc0201206:	f6668693          	addi	a3,a3,-154 # ffffffffc0205168 <commands+0xa80>
ffffffffc020120a:	00004617          	auipc	a2,0x4
ffffffffc020120e:	c1660613          	addi	a2,a2,-1002 # ffffffffc0204e20 <commands+0x738>
ffffffffc0201212:	12600593          	li	a1,294
ffffffffc0201216:	00004517          	auipc	a0,0x4
ffffffffc020121a:	c2250513          	addi	a0,a0,-990 # ffffffffc0204e38 <commands+0x750>
ffffffffc020121e:	956ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(total == nr_free_pages());
ffffffffc0201222:	00004697          	auipc	a3,0x4
ffffffffc0201226:	c2e68693          	addi	a3,a3,-978 # ffffffffc0204e50 <commands+0x768>
ffffffffc020122a:	00004617          	auipc	a2,0x4
ffffffffc020122e:	bf660613          	addi	a2,a2,-1034 # ffffffffc0204e20 <commands+0x738>
ffffffffc0201232:	0f300593          	li	a1,243
ffffffffc0201236:	00004517          	auipc	a0,0x4
ffffffffc020123a:	c0250513          	addi	a0,a0,-1022 # ffffffffc0204e38 <commands+0x750>
ffffffffc020123e:	936ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc0201242:	00004697          	auipc	a3,0x4
ffffffffc0201246:	c4e68693          	addi	a3,a3,-946 # ffffffffc0204e90 <commands+0x7a8>
ffffffffc020124a:	00004617          	auipc	a2,0x4
ffffffffc020124e:	bd660613          	addi	a2,a2,-1066 # ffffffffc0204e20 <commands+0x738>
ffffffffc0201252:	0ba00593          	li	a1,186
ffffffffc0201256:	00004517          	auipc	a0,0x4
ffffffffc020125a:	be250513          	addi	a0,a0,-1054 # ffffffffc0204e38 <commands+0x750>
...
ffffffffc020139e:	de668693          	addi	a3,a3,-538 # ffffffffc0205180 <commands+0xa98>
ffffffffc02013a2:	00004617          	auipc	a2,0x4
ffffffffc02013a6:	a7e60613          	addi	a2,a2,-1410 # ffffffffc0204e20 <commands+0x738>
ffffffffc02013aa:	08300593          	li	a1,131
ffffffffc02013ae:	00004517          	auipc	a0,0x4
ffffffffc02013b2:	a8a50513          	addi	a0,a0,-1398 # ffffffffc0204e38 <commands+0x750>
ffffffffc02013b6:	fbffe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(n > 0);
ffffffffc02013ba:	00004697          	auipc	a3,0x4
ffffffffc02013be:	dbe68693          	addi	a3,a3,-578 # ffffffffc0205178 <commands+0xa90>
ffffffffc02013c2:	00004617          	auipc	a2,0x4
ffffffffc02013c6:	a5e60613          	addi	a2,a2,-1442 # ffffffffc0204e20 <commands+0x738>
ffffffffc02013ca:	08000593          	li	a1,128
ffffffffc02013ce:	00004517          	auipc	a0,0x4
ffffffffc02013d2:	a6a50513          	addi	a0,a0,-1430 # ffffffffc0204e38 <commands+0x750>
...
ffffffffc0201476:	d0668693          	addi	a3,a3,-762 # ffffffffc0205178 <commands+0xa90>
ffffffffc020147a:	00004617          	auipc	a2,0x4
ffffffffc020147e:	9a660613          	addi	a2,a2,-1626 # ffffffffc0204e20 <commands+0x738>
ffffffffc0201482:	06200593          	li	a1,98
ffffffffc0201486:	00004517          	auipc	a0,0x4
ffffffffc020148a:	9b250513          	addi	a0,a0,-1614 # ffffffffc0204e38 <commands+0x750>
default_alloc_pages(size_t n) {
...
ffffffffc020154c:	c6068693          	addi	a3,a3,-928 # ffffffffc02051a8 <commands+0xac0>
ffffffffc0201550:	00004617          	auipc	a2,0x4
ffffffffc0201554:	8d060613          	addi	a2,a2,-1840 # ffffffffc0204e20 <commands+0x738>
ffffffffc0201558:	04900593          	li	a1,73
ffffffffc020155c:	00004517          	auipc	a0,0x4
ffffffffc0201560:	8dc50513          	addi	a0,a0,-1828 # ffffffffc0204e38 <commands+0x750>
ffffffffc0201564:	e11fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(n > 0);
ffffffffc0201568:	00004697          	auipc	a3,0x4
ffffffffc020156c:	c1068693          	addi	a3,a3,-1008 # ffffffffc0205178 <commands+0xa90>
ffffffffc0201570:	00004617          	auipc	a2,0x4
ffffffffc0201574:	8b060613          	addi	a2,a2,-1872 # ffffffffc0204e20 <commands+0x738>
ffffffffc0201578:	04600593          	li	a1,70
ffffffffc020157c:	00004517          	auipc	a0,0x4
ffffffffc0201580:	8bc50513          	addi	a0,a0,-1860 # ffffffffc0204e38 <commands+0x750>
...
ffffffffc020158e:	c7e60613          	addi	a2,a2,-898 # ffffffffc0205208 <default_pmm_manager+0x38>
ffffffffc0201592:	06500593          	li	a1,101
ffffffffc0201596:	00004517          	auipc	a0,0x4
ffffffffc020159a:	c9250513          	addi	a0,a0,-878 # ffffffffc0205228 <default_pmm_manager+0x58>
static inline struct Page *pa2page(uintptr_t pa) {
...
ffffffffc02015aa:	c9260613          	addi	a2,a2,-878 # ffffffffc0205238 <default_pmm_manager+0x68>
ffffffffc02015ae:	07000593          	li	a1,112
ffffffffc02015b2:	00004517          	auipc	a0,0x4
ffffffffc02015b6:	c7650513          	addi	a0,a0,-906 # ffffffffc0205228 <default_pmm_manager+0x58>
static inline struct Page *pte2page(pte_t pte) {
...
ffffffffc0201722:	c5ab3b03          	ld	s6,-934(s6) # ffffffffc0206378 <error_string+0x38>
...
ffffffffc0201760:	505020ef          	jal	ra,ffffffffc0204464 <memset>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
...
ffffffffc02017d0:	bacb3b03          	ld	s6,-1108(s6) # ffffffffc0206378 <error_string+0x38>
...
ffffffffc0201802:	463020ef          	jal	ra,ffffffffc0204464 <memset>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
...
ffffffffc0201862:	a0260613          	addi	a2,a2,-1534 # ffffffffc0205260 <default_pmm_manager+0x90>
ffffffffc0201866:	10800593          	li	a1,264
ffffffffc020186a:	00004517          	auipc	a0,0x4
ffffffffc020186e:	a1e50513          	addi	a0,a0,-1506 # ffffffffc0205288 <default_pmm_manager+0xb8>
ffffffffc0201872:	b03fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    return &((pte_t *)KADDR(PDE_ADDR(*pdep0)))[PTX(la)];
ffffffffc0201876:	00004617          	auipc	a2,0x4
ffffffffc020187a:	9ea60613          	addi	a2,a2,-1558 # ffffffffc0205260 <default_pmm_manager+0x90>
ffffffffc020187e:	11500593          	li	a1,277
ffffffffc0201882:	00004517          	auipc	a0,0x4
ffffffffc0201886:	a0650513          	addi	a0,a0,-1530 # ffffffffc0205288 <default_pmm_manager+0xb8>
...
ffffffffc0201894:	9d060613          	addi	a2,a2,-1584 # ffffffffc0205260 <default_pmm_manager+0x90>
ffffffffc0201898:	11100593          	li	a1,273
ffffffffc020189c:	00004517          	auipc	a0,0x4
ffffffffc02018a0:	9ec50513          	addi	a0,a0,-1556 # ffffffffc0205288 <default_pmm_manager+0xb8>
...
ffffffffc02018ae:	9b660613          	addi	a2,a2,-1610 # ffffffffc0205260 <default_pmm_manager+0x90>
ffffffffc02018b2:	10500593          	li	a1,261
ffffffffc02018b6:	00004517          	auipc	a0,0x4
ffffffffc02018ba:	9d250513          	addi	a0,a0,-1582 # ffffffffc0205288 <default_pmm_manager+0xb8>
...
ffffffffc02019f8:	98443403          	ld	s0,-1660(s0) # ffffffffc0206378 <error_string+0x38>
...
ffffffffc0201aba:	71a78793          	addi	a5,a5,1818 # ffffffffc02051d0 <default_pmm_manager>
...
ffffffffc0201ac8:	7d450513          	addi	a0,a0,2004 # ffffffffc0205298 <default_pmm_manager+0xc8>
    pmm_manager = &default_pmm_manager;
...
ffffffffc0201b24:	79050513          	addi	a0,a0,1936 # ffffffffc02052b0 <default_pmm_manager+0xe0>
    va_pa_offset = KERNBASE - 0x80200000;
...
ffffffffc0201b34:	7b050513          	addi	a0,a0,1968 # ffffffffc02052e0 <default_pmm_manager+0x110>
...
ffffffffc0201b4e:	7ae50513          	addi	a0,a0,1966 # ffffffffc02052f8 <default_pmm_manager+0x128>
...
ffffffffc0201bda:	77250513          	addi	a0,a0,1906 # ffffffffc0205348 <default_pmm_manager+0x178>
...
ffffffffc0201c9c:	16f71fe3          	bne	a4,a5,ffffffffc020261a <pmm_init+0xb64>
    ...
    ptep = (pte_t *)KADDR(PDE_ADDR(boot_pgdir[0])); //页目录中第一个页表的地址
...
ffffffffc0201cb4:	0009bc03          	ld	s8,0(s3)
    ptep = (pte_t *)KADDR(PDE_ADDR(ptep[0])) + 1;   //页表第二个页表项地址
...
ffffffffc0201dfe:	57ecbc83          	ld	s9,1406(s9) # ffffffffc0206378 <error_string+0x38>
...
ffffffffc0201ea2:	79250513          	addi	a0,a0,1938 # ffffffffc0205630 <default_pmm_manager+0x460>
...
ffffffffc0201f58:	81458593          	addi	a1,a1,-2028 # ffffffffc0205768 <default_pmm_manager+0x598>
ffffffffc0201f5c:	10000513          	li	a0,256
ffffffffc0201f60:	4be020ef          	jal	ra,ffffffffc020441e <strcpy>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc0201f64:	10040593          	addi	a1,s0,256
ffffffffc0201f68:	10000513          	li	a0,256
ffffffffc0201f6c:	4c4020ef          	jal	ra,ffffffffc0204430 <strcmp>
...
ffffffffc0201fa2:	10068023          	sb	zero,256(a3) # fffffffffff80100 <end+0x3fd6eb9c>
    assert(strlen((const char *)0x100) == 0);
ffffffffc0201fa6:	442020ef          	jal	ra,ffffffffc02043e8 <strlen>
...
ffffffffc020209c:	74850513          	addi	a0,a0,1864 # ffffffffc02057e0 <default_pmm_manager+0x610>
}
...
ffffffffc02021a2:	4f268693          	addi	a3,a3,1266 # ffffffffc0205690 <default_pmm_manager+0x4c0>
ffffffffc02021a6:	00003617          	auipc	a2,0x3
ffffffffc02021aa:	c7a60613          	addi	a2,a2,-902 # ffffffffc0204e20 <commands+0x738>
ffffffffc02021ae:	1ec00593          	li	a1,492
ffffffffc02021b2:	00003517          	auipc	a0,0x3
ffffffffc02021b6:	0d650513          	addi	a0,a0,214 # ffffffffc0205288 <default_pmm_manager+0xb8>
ffffffffc02021ba:	9bafe0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert((ptep = get_pte(boot_pgdir, (uintptr_t)KADDR(i), 0)) != NULL);
ffffffffc02021be:	00003697          	auipc	a3,0x3
ffffffffc02021c2:	49268693          	addi	a3,a3,1170 # ffffffffc0205650 <default_pmm_manager+0x480>
ffffffffc02021c6:	00003617          	auipc	a2,0x3
ffffffffc02021ca:	c5a60613          	addi	a2,a2,-934 # ffffffffc0204e20 <commands+0x738>
ffffffffc02021ce:	1eb00593          	li	a1,491
ffffffffc02021d2:	00003517          	auipc	a0,0x3
ffffffffc02021d6:	0b650513          	addi	a0,a0,182 # ffffffffc0205288 <default_pmm_manager+0xb8>
...
ffffffffc02021e4:	08060613          	addi	a2,a2,128 # ffffffffc0205260 <default_pmm_manager+0x90>
ffffffffc02021e8:	1eb00593          	li	a1,491
ffffffffc02021ec:	00003517          	auipc	a0,0x3
ffffffffc02021f0:	09c50513          	addi	a0,a0,156 # ffffffffc0205288 <default_pmm_manager+0xb8>
...
ffffffffc0202200:	12460613          	addi	a2,a2,292 # ffffffffc0205320 <default_pmm_manager+0x150>
ffffffffc0202204:	07900593          	li	a1,121
ffffffffc0202208:	00003517          	auipc	a0,0x3
ffffffffc020220c:	08050513          	addi	a0,a0,128 # ffffffffc0205288 <default_pmm_manager+0xb8>
ffffffffc0202210:	964fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    boot_cr3 = PADDR(boot_pgdir);
ffffffffc0202214:	00003617          	auipc	a2,0x3
ffffffffc0202218:	10c60613          	addi	a2,a2,268 # ffffffffc0205320 <default_pmm_manager+0x150>
ffffffffc020221c:	0c300593          	li	a1,195
ffffffffc0202220:	00003517          	auipc	a0,0x3
ffffffffc0202224:	06850513          	addi	a0,a0,104 # ffffffffc0205288 <default_pmm_manager+0xb8>
ffffffffc0202228:	94cfe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(boot_pgdir != NULL && (uint32_t)PGOFF(boot_pgdir) == 0);
ffffffffc020222c:	00003697          	auipc	a3,0x3
ffffffffc0202230:	15c68693          	addi	a3,a3,348 # ffffffffc0205388 <default_pmm_manager+0x1b8>
ffffffffc0202234:	00003617          	auipc	a2,0x3
ffffffffc0202238:	bec60613          	addi	a2,a2,-1044 # ffffffffc0204e20 <commands+0x738>
ffffffffc020223c:	1a600593          	li	a1,422
ffffffffc0202240:	00003517          	auipc	a0,0x3
ffffffffc0202244:	04850513          	addi	a0,a0,72 # ffffffffc0205288 <default_pmm_manager+0xb8>
ffffffffc0202248:	92cfe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(npage <= KERNTOP / PGSIZE);
ffffffffc020224c:	00003697          	auipc	a3,0x3
ffffffffc0202250:	11c68693          	addi	a3,a3,284 # ffffffffc0205368 <default_pmm_manager+0x198>
ffffffffc0202254:	00003617          	auipc	a2,0x3
ffffffffc0202258:	bcc60613          	addi	a2,a2,-1076 # ffffffffc0204e20 <commands+0x738>
ffffffffc020225c:	1a500593          	li	a1,421
ffffffffc0202260:	00003517          	auipc	a0,0x3
ffffffffc0202264:	02850513          	addi	a0,a0,40 # ffffffffc0205288 <default_pmm_manager+0xb8>
...
ffffffffc0202274:	1a868693          	addi	a3,a3,424 # ffffffffc0205418 <default_pmm_manager+0x248>
ffffffffc0202278:	00003617          	auipc	a2,0x3
ffffffffc020227c:	ba860613          	addi	a2,a2,-1112 # ffffffffc0204e20 <commands+0x738>
ffffffffc0202280:	1b000593          	li	a1,432
ffffffffc0202284:	00003517          	auipc	a0,0x3
ffffffffc0202288:	00450513          	addi	a0,a0,4 # ffffffffc0205288 <default_pmm_manager+0xb8>
ffffffffc020228c:	8e8fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_insert(boot_pgdir, p1, 0x0, 0) == 0);
ffffffffc0202290:	00003697          	auipc	a3,0x3
ffffffffc0202294:	15868693          	addi	a3,a3,344 # ffffffffc02053e8 <default_pmm_manager+0x218>
ffffffffc0202298:	00003617          	auipc	a2,0x3
ffffffffc020229c:	b8860613          	addi	a2,a2,-1144 # ffffffffc0204e20 <commands+0x738>
ffffffffc02022a0:	1ac00593          	li	a1,428
ffffffffc02022a4:	00003517          	auipc	a0,0x3
ffffffffc02022a8:	fe450513          	addi	a0,a0,-28 # ffffffffc0205288 <default_pmm_manager+0xb8>
ffffffffc02022ac:	8c8fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(get_page(boot_pgdir, 0x0, NULL) == NULL);
ffffffffc02022b0:	00003697          	auipc	a3,0x3
ffffffffc02022b4:	11068693          	addi	a3,a3,272 # ffffffffc02053c0 <default_pmm_manager+0x1f0>
ffffffffc02022b8:	00003617          	auipc	a2,0x3
ffffffffc02022bc:	b6860613          	addi	a2,a2,-1176 # ffffffffc0204e20 <commands+0x738>
ffffffffc02022c0:	1a700593          	li	a1,423
ffffffffc02022c4:	00003517          	auipc	a0,0x3
ffffffffc02022c8:	fc450513          	addi	a0,a0,-60 # ffffffffc0205288 <default_pmm_manager+0xb8>
ffffffffc02022cc:	8a8fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_insert(boot_pgdir, p2, PGSIZE, PTE_U | PTE_W) == 0);
ffffffffc02022d0:	00003697          	auipc	a3,0x3
ffffffffc02022d4:	1d068693          	addi	a3,a3,464 # ffffffffc02054a0 <default_pmm_manager+0x2d0>
ffffffffc02022d8:	00003617          	auipc	a2,0x3
ffffffffc02022dc:	b4860613          	addi	a2,a2,-1208 # ffffffffc0204e20 <commands+0x738>
ffffffffc02022e0:	1bc00593          	li	a1,444
...
ffffffffc02022f4:	25068693          	addi	a3,a3,592 # ffffffffc0205540 <default_pmm_manager+0x370>
ffffffffc02022f8:	00003617          	auipc	a2,0x3
ffffffffc02022fc:	b2860613          	addi	a2,a2,-1240 # ffffffffc0204e20 <commands+0x738>
ffffffffc0202300:	1c300593          	li	a1,451
...
ffffffffc0202314:	16868693          	addi	a3,a3,360 # ffffffffc0205478 <default_pmm_manager+0x2a8>
ffffffffc0202318:	00003617          	auipc	a2,0x3
ffffffffc020231c:	b0860613          	addi	a2,a2,-1272 # ffffffffc0204e20 <commands+0x738>
ffffffffc0202320:	1b800593          	li	a1,440
...
ffffffffc0202336:	f2e60613          	addi	a2,a2,-210 # ffffffffc0205260 <default_pmm_manager+0x90>
ffffffffc020233a:	1b600593          	li	a1,438
ffffffffc020233e:	00003517          	auipc	a0,0x3
ffffffffc0202342:	f4a50513          	addi	a0,a0,-182 # ffffffffc0205288 <default_pmm_manager+0xb8>
ffffffffc0202346:	82efe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((ptep = get_pte(boot_pgdir, PGSIZE, 0)) != NULL);
ffffffffc020234a:	00003697          	auipc	a3,0x3
ffffffffc020234e:	18e68693          	addi	a3,a3,398 # ffffffffc02054d8 <default_pmm_manager+0x308>
ffffffffc0202352:	00003617          	auipc	a2,0x3
ffffffffc0202356:	ace60613          	addi	a2,a2,-1330 # ffffffffc0204e20 <commands+0x738>
ffffffffc020235a:	1c900593          	li	a1,457
ffffffffc020235e:	00003517          	auipc	a0,0x3
ffffffffc0202362:	f2a50513          	addi	a0,a0,-214 # ffffffffc0205288 <default_pmm_manager+0xb8>
ffffffffc0202366:	80efe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc020236a:	00003697          	auipc	a3,0x3
ffffffffc020236e:	23668693          	addi	a3,a3,566 # ffffffffc02055a0 <default_pmm_manager+0x3d0>
ffffffffc0202372:	00003617          	auipc	a2,0x3
ffffffffc0202376:	aae60613          	addi	a2,a2,-1362 # ffffffffc0204e20 <commands+0x738>
ffffffffc020237a:	1c800593          	li	a1,456
ffffffffc020237e:	00003517          	auipc	a0,0x3
ffffffffc0202382:	f0a50513          	addi	a0,a0,-246 # ffffffffc0205288 <default_pmm_manager+0xb8>
ffffffffc0202386:	feffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p1) == 2);
ffffffffc020238a:	00003697          	auipc	a3,0x3
ffffffffc020238e:	1fe68693          	addi	a3,a3,510 # ffffffffc0205588 <default_pmm_manager+0x3b8>
ffffffffc0202392:	00003617          	auipc	a2,0x3
ffffffffc0202396:	a8e60613          	addi	a2,a2,-1394 # ffffffffc0204e20 <commands+0x738>
ffffffffc020239a:	1c700593          	li	a1,455
...
ffffffffc02023ae:	1ae68693          	addi	a3,a3,430 # ffffffffc0205558 <default_pmm_manager+0x388>
ffffffffc02023b2:	00003617          	auipc	a2,0x3
ffffffffc02023b6:	a6e60613          	addi	a2,a2,-1426 # ffffffffc0204e20 <commands+0x738>
ffffffffc02023ba:	1c600593          	li	a1,454
...
ffffffffc02023ce:	34668693          	addi	a3,a3,838 # ffffffffc0205710 <default_pmm_manager+0x540>
ffffffffc02023d2:	00003617          	auipc	a2,0x3
ffffffffc02023d6:	a4e60613          	addi	a2,a2,-1458 # ffffffffc0204e20 <commands+0x738>
ffffffffc02023da:	1f600593          	li	a1,502
...
ffffffffc02023ee:	13e68693          	addi	a3,a3,318 # ffffffffc0205528 <default_pmm_manager+0x358>
ffffffffc02023f2:	00003617          	auipc	a2,0x3
ffffffffc02023f6:	a2e60613          	addi	a2,a2,-1490 # ffffffffc0204e20 <commands+0x738>
ffffffffc02023fa:	1c200593          	li	a1,450
...
ffffffffc020240e:	10e68693          	addi	a3,a3,270 # ffffffffc0205518 <default_pmm_manager+0x348>
ffffffffc0202412:	00003617          	auipc	a2,0x3
ffffffffc0202416:	a0e60613          	addi	a2,a2,-1522 # ffffffffc0204e20 <commands+0x738>
ffffffffc020241a:	1c100593          	li	a1,449
...
ffffffffc020242e:	1e668693          	addi	a3,a3,486 # ffffffffc0205610 <default_pmm_manager+0x440>
ffffffffc0202432:	00003617          	auipc	a2,0x3
ffffffffc0202436:	9ee60613          	addi	a2,a2,-1554 # ffffffffc0204e20 <commands+0x738>
ffffffffc020243a:	20600593          	li	a1,518
...
ffffffffc020244e:	0be68693          	addi	a3,a3,190 # ffffffffc0205508 <default_pmm_manager+0x338>
ffffffffc0202452:	00003617          	auipc	a2,0x3
ffffffffc0202456:	9ce60613          	addi	a2,a2,-1586 # ffffffffc0204e20 <commands+0x738>
ffffffffc020245a:	1c000593          	li	a1,448
...
ffffffffc020246e:	ff668693          	addi	a3,a3,-10 # ffffffffc0205460 <default_pmm_manager+0x290>
ffffffffc0202472:	00003617          	auipc	a2,0x3
ffffffffc0202476:	9ae60613          	addi	a2,a2,-1618 # ffffffffc0204e20 <commands+0x738>
ffffffffc020247a:	1cf00593          	li	a1,463
...
ffffffffc020248e:	12e68693          	addi	a3,a3,302 # ffffffffc02055b8 <default_pmm_manager+0x3e8>
ffffffffc0202492:	00003617          	auipc	a2,0x3
ffffffffc0202496:	98e60613          	addi	a2,a2,-1650 # ffffffffc0204e20 <commands+0x738>
ffffffffc020249a:	1cb00593          	li	a1,459
...
ffffffffc02024ae:	f9e68693          	addi	a3,a3,-98 # ffffffffc0205448 <default_pmm_manager+0x278>
ffffffffc02024b2:	00003617          	auipc	a2,0x3
ffffffffc02024b6:	96e60613          	addi	a2,a2,-1682 # ffffffffc0204e20 <commands+0x738>
ffffffffc02024ba:	1ca00593          	li	a1,458
...
ffffffffc02024ce:	d9660613          	addi	a2,a2,-618 # ffffffffc0205260 <default_pmm_manager+0x90>
ffffffffc02024d2:	06a00593          	li	a1,106
ffffffffc02024d6:	00003517          	auipc	a0,0x3
ffffffffc02024da:	d5250513          	addi	a0,a0,-686 # ffffffffc0205228 <default_pmm_manager+0x58>
ffffffffc02024de:	e97fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(pde2page(boot_pgdir[0])) == 1);
ffffffffc02024e2:	00003697          	auipc	a3,0x3
ffffffffc02024e6:	10668693          	addi	a3,a3,262 # ffffffffc02055e8 <default_pmm_manager+0x418>
ffffffffc02024ea:	00003617          	auipc	a2,0x3
ffffffffc02024ee:	93660613          	addi	a2,a2,-1738 # ffffffffc0204e20 <commands+0x738>
ffffffffc02024f2:	1d700593          	li	a1,471
ffffffffc02024f6:	00003517          	auipc	a0,0x3
ffffffffc02024fa:	d9250513          	addi	a0,a0,-622 # ffffffffc0205288 <default_pmm_manager+0xb8>
ffffffffc02024fe:	e77fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc0202502:	00003697          	auipc	a3,0x3
ffffffffc0202506:	09e68693          	addi	a3,a3,158 # ffffffffc02055a0 <default_pmm_manager+0x3d0>
ffffffffc020250a:	00003617          	auipc	a2,0x3
ffffffffc020250e:	91660613          	addi	a2,a2,-1770 # ffffffffc0204e20 <commands+0x738>
ffffffffc0202512:	1d500593          	li	a1,469
ffffffffc0202516:	00003517          	auipc	a0,0x3
ffffffffc020251a:	d7250513          	addi	a0,a0,-654 # ffffffffc0205288 <default_pmm_manager+0xb8>
ffffffffc020251e:	e57fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p1) == 0);
ffffffffc0202522:	00003697          	auipc	a3,0x3
ffffffffc0202526:	0ae68693          	addi	a3,a3,174 # ffffffffc02055d0 <default_pmm_manager+0x400>
ffffffffc020252a:	00003617          	auipc	a2,0x3
ffffffffc020252e:	8f660613          	addi	a2,a2,-1802 # ffffffffc0204e20 <commands+0x738>
ffffffffc0202532:	1d400593          	li	a1,468
ffffffffc0202536:	00003517          	auipc	a0,0x3
ffffffffc020253a:	d5250513          	addi	a0,a0,-686 # ffffffffc0205288 <default_pmm_manager+0xb8>
ffffffffc020253e:	e37fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc0202542:	00003697          	auipc	a3,0x3
ffffffffc0202546:	05e68693          	addi	a3,a3,94 # ffffffffc02055a0 <default_pmm_manager+0x3d0>
ffffffffc020254a:	00003617          	auipc	a2,0x3
ffffffffc020254e:	8d660613          	addi	a2,a2,-1834 # ffffffffc0204e20 <commands+0x738>
ffffffffc0202552:	1d000593          	li	a1,464
...
ffffffffc0202566:	19668693          	addi	a3,a3,406 # ffffffffc02056f8 <default_pmm_manager+0x528>
ffffffffc020256a:	00003617          	auipc	a2,0x3
ffffffffc020256e:	8b660613          	addi	a2,a2,-1866 # ffffffffc0204e20 <commands+0x738>
ffffffffc0202572:	1f500593          	li	a1,501
...
ffffffffc0202586:	13e68693          	addi	a3,a3,318 # ffffffffc02056c0 <default_pmm_manager+0x4f0>
ffffffffc020258a:	00003617          	auipc	a2,0x3
ffffffffc020258e:	89660613          	addi	a2,a2,-1898 # ffffffffc0204e20 <commands+0x738>
ffffffffc0202592:	1f400593          	li	a1,500
...
ffffffffc02025a6:	10668693          	addi	a3,a3,262 # ffffffffc02056a8 <default_pmm_manager+0x4d8>
ffffffffc02025aa:	00003617          	auipc	a2,0x3
ffffffffc02025ae:	87660613          	addi	a2,a2,-1930 # ffffffffc0204e20 <commands+0x738>
ffffffffc02025b2:	1f000593          	li	a1,496
...
ffffffffc02025c6:	04e68693          	addi	a3,a3,78 # ffffffffc0205610 <default_pmm_manager+0x440>
ffffffffc02025ca:	00003617          	auipc	a2,0x3
ffffffffc02025ce:	85660613          	addi	a2,a2,-1962 # ffffffffc0204e20 <commands+0x738>
ffffffffc02025d2:	1de00593          	li	a1,478
...
ffffffffc02025e6:	e6668693          	addi	a3,a3,-410 # ffffffffc0205448 <default_pmm_manager+0x278>
ffffffffc02025ea:	00003617          	auipc	a2,0x3
ffffffffc02025ee:	83660613          	addi	a2,a2,-1994 # ffffffffc0204e20 <commands+0x738>
ffffffffc02025f2:	1b100593          	li	a1,433
...
ffffffffc0202606:	c5e60613          	addi	a2,a2,-930 # ffffffffc0205260 <default_pmm_manager+0x90>
ffffffffc020260a:	1b500593          	li	a1,437
ffffffffc020260e:	00003517          	auipc	a0,0x3
ffffffffc0202612:	c7a50513          	addi	a0,a0,-902 # ffffffffc0205288 <default_pmm_manager+0xb8>
ffffffffc0202616:	d5ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p1) == 1);
ffffffffc020261a:	00003697          	auipc	a3,0x3
ffffffffc020261e:	e4668693          	addi	a3,a3,-442 # ffffffffc0205460 <default_pmm_manager+0x290>
ffffffffc0202622:	00002617          	auipc	a2,0x2
ffffffffc0202626:	7fe60613          	addi	a2,a2,2046 # ffffffffc0204e20 <commands+0x738>
ffffffffc020262a:	1b300593          	li	a1,435
ffffffffc020262e:	00003517          	auipc	a0,0x3
ffffffffc0202632:	c5a50513          	addi	a0,a0,-934 # ffffffffc0205288 <default_pmm_manager+0xb8>
ffffffffc0202636:	d3ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((ptep = get_pte(boot_pgdir, PGSIZE, 0)) != NULL);
ffffffffc020263a:	00003697          	auipc	a3,0x3
ffffffffc020263e:	e9e68693          	addi	a3,a3,-354 # ffffffffc02054d8 <default_pmm_manager+0x308>
ffffffffc0202642:	00002617          	auipc	a2,0x2
ffffffffc0202646:	7de60613          	addi	a2,a2,2014 # ffffffffc0204e20 <commands+0x738>
ffffffffc020264a:	1be00593          	li	a1,446
ffffffffc020264e:	00003517          	auipc	a0,0x3
ffffffffc0202652:	c3a50513          	addi	a0,a0,-966 # ffffffffc0205288 <default_pmm_manager+0xb8>
ffffffffc0202656:	d1ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(strlen((const char *)0x100) == 0);
ffffffffc020265a:	00003697          	auipc	a3,0x3
ffffffffc020265e:	15e68693          	addi	a3,a3,350 # ffffffffc02057b8 <default_pmm_manager+0x5e8>
ffffffffc0202662:	00002617          	auipc	a2,0x2
ffffffffc0202666:	7be60613          	addi	a2,a2,1982 # ffffffffc0204e20 <commands+0x738>
ffffffffc020266a:	1fe00593          	li	a1,510
...
ffffffffc020267e:	10668693          	addi	a3,a3,262 # ffffffffc0205780 <default_pmm_manager+0x5b0>
ffffffffc0202682:	00002617          	auipc	a2,0x2
ffffffffc0202686:	79e60613          	addi	a2,a2,1950 # ffffffffc0204e20 <commands+0x738>
ffffffffc020268a:	1fb00593          	li	a1,507
...
ffffffffc020269e:	0b668693          	addi	a3,a3,182 # ffffffffc0205750 <default_pmm_manager+0x580>
ffffffffc02026a2:	00002617          	auipc	a2,0x2
ffffffffc02026a6:	77e60613          	addi	a2,a2,1918 # ffffffffc0204e20 <commands+0x738>
ffffffffc02026aa:	1f700593          	li	a1,503
...
ffffffffc0202724:	0e068693          	addi	a3,a3,224 # ffffffffc0205800 <default_pmm_manager+0x630>
ffffffffc0202728:	00002617          	auipc	a2,0x2
ffffffffc020272c:	6f860613          	addi	a2,a2,1784 # ffffffffc0204e20 <commands+0x738>
ffffffffc0202730:	18b00593          	li	a1,395
ffffffffc0202734:	00003517          	auipc	a0,0x3
ffffffffc0202738:	b5450513          	addi	a0,a0,-1196 # ffffffffc0205288 <default_pmm_manager+0xb8>
...
ffffffffc02027a4:	bd86b683          	ld	a3,-1064(a3) # ffffffffc0206378 <error_string+0x38>
...
ffffffffc02027dc:	04068693          	addi	a3,a3,64 # ffffffffc0205818 <default_pmm_manager+0x648>
ffffffffc02027e0:	00002617          	auipc	a2,0x2
ffffffffc02027e4:	64060613          	addi	a2,a2,1600 # ffffffffc0204e20 <commands+0x738>
ffffffffc02027e8:	20e00593          	li	a1,526
ffffffffc02027ec:	00003517          	auipc	a0,0x3
ffffffffc02027f0:	a9c50513          	addi	a0,a0,-1380 # ffffffffc0205288 <default_pmm_manager+0xb8>
...
ffffffffc02027fe:	a6660613          	addi	a2,a2,-1434 # ffffffffc0205260 <default_pmm_manager+0x90>
ffffffffc0202802:	06a00593          	li	a1,106
ffffffffc0202806:	00003517          	auipc	a0,0x3
ffffffffc020280a:	a2250513          	addi	a0,a0,-1502 # ffffffffc0205228 <default_pmm_manager+0x58>
ffffffffc020280e:	b67fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(base != NULL);
ffffffffc0202812:	00003697          	auipc	a3,0x3
ffffffffc0202816:	02668693          	addi	a3,a3,38 # ffffffffc0205838 <default_pmm_manager+0x668>
ffffffffc020281a:	00002617          	auipc	a2,0x2
ffffffffc020281e:	60660613          	addi	a2,a2,1542 # ffffffffc0204e20 <commands+0x738>
ffffffffc0202822:	21100593          	li	a1,529
ffffffffc0202826:	00003517          	auipc	a0,0x3
ffffffffc020282a:	a6250513          	addi	a0,a0,-1438 # ffffffffc0205288 <default_pmm_manager+0xb8>
...
ffffffffc02028c6:	a5e60613          	addi	a2,a2,-1442 # ffffffffc0205320 <default_pmm_manager+0x150>
ffffffffc02028ca:	06c00593          	li	a1,108
ffffffffc02028ce:	00003517          	auipc	a0,0x3
ffffffffc02028d2:	95a50513          	addi	a0,a0,-1702 # ffffffffc0205228 <default_pmm_manager+0x58>
ffffffffc02028d6:	a9ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(ptr != NULL);
ffffffffc02028da:	00003697          	auipc	a3,0x3
ffffffffc02028de:	f6e68693          	addi	a3,a3,-146 # ffffffffc0205848 <default_pmm_manager+0x678>
ffffffffc02028e2:	00002617          	auipc	a2,0x2
ffffffffc02028e6:	53e60613          	addi	a2,a2,1342 # ffffffffc0204e20 <commands+0x738>
ffffffffc02028ea:	21800593          	li	a1,536
ffffffffc02028ee:	00003517          	auipc	a0,0x3
ffffffffc02028f2:	99a50513          	addi	a0,a0,-1638 # ffffffffc0205288 <default_pmm_manager+0xb8>
ffffffffc02028f6:	a7ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(n > 0 && n < 1024 * 0124);
ffffffffc02028fa:	00003697          	auipc	a3,0x3
ffffffffc02028fe:	f1e68693          	addi	a3,a3,-226 # ffffffffc0205818 <default_pmm_manager+0x648>
ffffffffc0202902:	00002617          	auipc	a2,0x2
ffffffffc0202906:	51e60613          	addi	a2,a2,1310 # ffffffffc0204e20 <commands+0x738>
ffffffffc020290a:	21700593          	li	a1,535
ffffffffc020290e:	00003517          	auipc	a0,0x3
ffffffffc0202912:	97a50513          	addi	a0,a0,-1670 # ffffffffc0205288 <default_pmm_manager+0xb8>
...
ffffffffc0202934:	fc6e                	sd	s11,56(sp)
     swapfs_init();
ffffffffc0202936:	4a4010ef          	jal	ra,ffffffffc0203dda <swapfs_init>
...
ffffffffc0202994:	ef850513          	addi	a0,a0,-264 # ffffffffc0205888 <default_pmm_manager+0x6b8>
    return listelm->next;
...
ffffffffc02029e4:	ec050513          	addi	a0,a0,-320 # ffffffffc02058a0 <default_pmm_manager+0x6d0>
ffffffffc02029e8:	ed2fd0ef          	jal	ra,ffffffffc02000ba <cprintf>
     
     //now we set the phy pages env     
     struct mm_struct *mm = mm_create();
ffffffffc02029ec:	38d000ef          	jal	ra,ffffffffc0203578 <mm_create>
...
ffffffffc0202a20:	3a1000ef          	jal	ra,ffffffffc02035c0 <vma_create>
...
ffffffffc0202a2c:	403000ef          	jal	ra,ffffffffc020362e <insert_vma_struct>

     //setup the temp Page Table vaddr 0~4MB
     cprintf("setup Page Table for vaddr 0X1000, so alloc a page\n");
ffffffffc0202a30:	00003517          	auipc	a0,0x3
ffffffffc0202a34:	ee050513          	addi	a0,a0,-288 # ffffffffc0205910 <default_pmm_manager+0x740>
...
ffffffffc0202a50:	f1450513          	addi	a0,a0,-236 # ffffffffc0205960 <default_pmm_manager+0x790>
...
ffffffffc0202ac4:	f2850513          	addi	a0,a0,-216 # ffffffffc02059e8 <default_pmm_manager+0x818>
...
ffffffffc0202ba0:	7e4c0c13          	addi	s8,s8,2020 # ffffffffc0206380 <nbase>
...
ffffffffc0202c10:	e8450513          	addi	a0,a0,-380 # ffffffffc0205a90 <default_pmm_manager+0x8c0>
...
ffffffffc0202c36:	2c9000ef          	jal	ra,ffffffffc02036fe <mm_destroy>
...
ffffffffc0202c62:	e6250513          	addi	a0,a0,-414 # ffffffffc0205ac0 <default_pmm_manager+0x8f0>
ffffffffc0202c66:	c54fd0ef          	jal	ra,ffffffffc02000ba <cprintf>
     //assert(count == 0);
     
     cprintf("check_swap() succeeded!\n");
ffffffffc0202c6a:	00003517          	auipc	a0,0x3
ffffffffc0202c6e:	e7650513          	addi	a0,a0,-394 # ffffffffc0205ae0 <default_pmm_manager+0x910>
...
ffffffffc0202c80:	19468693          	addi	a3,a3,404 # ffffffffc0204e10 <commands+0x728>
ffffffffc0202c84:	00002617          	auipc	a2,0x2
ffffffffc0202c88:	19c60613          	addi	a2,a2,412 # ffffffffc0204e20 <commands+0x738>
ffffffffc0202c8c:	0bd00593          	li	a1,189
ffffffffc0202c90:	00003517          	auipc	a0,0x3
ffffffffc0202c94:	be850513          	addi	a0,a0,-1048 # ffffffffc0205878 <default_pmm_manager+0x6a8>
ffffffffc0202c98:	edcfd0ef          	jal	ra,ffffffffc0200374 <__panic>
         assert(pte2page(*check_ptep[i]) == check_rp[i]);
ffffffffc0202c9c:	00003697          	auipc	a3,0x3
ffffffffc0202ca0:	dcc68693          	addi	a3,a3,-564 # ffffffffc0205a68 <default_pmm_manager+0x898>
ffffffffc0202ca4:	00002617          	auipc	a2,0x2
ffffffffc0202ca8:	17c60613          	addi	a2,a2,380 # ffffffffc0204e20 <commands+0x738>
ffffffffc0202cac:	0fd00593          	li	a1,253
ffffffffc0202cb0:	00003517          	auipc	a0,0x3
ffffffffc0202cb4:	bc850513          	addi	a0,a0,-1080 # ffffffffc0205878 <default_pmm_manager+0x6a8>
ffffffffc0202cb8:	ebcfd0ef          	jal	ra,ffffffffc0200374 <__panic>
        panic("pte2page called with invalid pte");
ffffffffc0202cbc:	00002617          	auipc	a2,0x2
ffffffffc0202cc0:	57c60613          	addi	a2,a2,1404 # ffffffffc0205238 <default_pmm_manager+0x68>
ffffffffc0202cc4:	07000593          	li	a1,112
ffffffffc0202cc8:	00002517          	auipc	a0,0x2
ffffffffc0202ccc:	56050513          	addi	a0,a0,1376 # ffffffffc0205228 <default_pmm_manager+0x58>
ffffffffc0202cd0:	ea4fd0ef          	jal	ra,ffffffffc0200374 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0202cd4:	00002617          	auipc	a2,0x2
ffffffffc0202cd8:	53460613          	addi	a2,a2,1332 # ffffffffc0205208 <default_pmm_manager+0x38>
ffffffffc0202cdc:	06500593          	li	a1,101
ffffffffc0202ce0:	00002517          	auipc	a0,0x2
ffffffffc0202ce4:	54850513          	addi	a0,a0,1352 # ffffffffc0205228 <default_pmm_manager+0x58>
ffffffffc0202ce8:	e8cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
          assert(!PageProperty(check_rp[i]));
ffffffffc0202cec:	00003697          	auipc	a3,0x3
ffffffffc0202cf0:	cb468693          	addi	a3,a3,-844 # ffffffffc02059a0 <default_pmm_manager+0x7d0>
ffffffffc0202cf4:	00002617          	auipc	a2,0x2
ffffffffc0202cf8:	12c60613          	addi	a2,a2,300 # ffffffffc0204e20 <commands+0x738>
ffffffffc0202cfc:	0de00593          	li	a1,222
ffffffffc0202d00:	00003517          	auipc	a0,0x3
ffffffffc0202d04:	b7850513          	addi	a0,a0,-1160 # ffffffffc0205878 <default_pmm_manager+0x6a8>
ffffffffc0202d08:	e6cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
          assert(check_rp[i] != NULL );
ffffffffc0202d0c:	00003697          	auipc	a3,0x3
ffffffffc0202d10:	c7c68693          	addi	a3,a3,-900 # ffffffffc0205988 <default_pmm_manager+0x7b8>
ffffffffc0202d14:	00002617          	auipc	a2,0x2
ffffffffc0202d18:	10c60613          	addi	a2,a2,268 # ffffffffc0204e20 <commands+0x738>
ffffffffc0202d1c:	0dd00593          	li	a1,221
ffffffffc0202d20:	00003517          	auipc	a0,0x3
ffffffffc0202d24:	b5850513          	addi	a0,a0,-1192 # ffffffffc0205878 <default_pmm_manager+0x6a8>
ffffffffc0202d28:	e4cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
        panic("bad max_swap_offset %08x.\n", max_swap_offset);
ffffffffc0202d2c:	00003617          	auipc	a2,0x3
ffffffffc0202d30:	b2c60613          	addi	a2,a2,-1236 # ffffffffc0205858 <default_pmm_manager+0x688>
ffffffffc0202d34:	02800593          	li	a1,40
ffffffffc0202d38:	00003517          	auipc	a0,0x3
ffffffffc0202d3c:	b4050513          	addi	a0,a0,-1216 # ffffffffc0205878 <default_pmm_manager+0x6a8>
ffffffffc0202d40:	e34fd0ef          	jal	ra,ffffffffc0200374 <__panic>
         assert(check_ptep[i] != NULL);
ffffffffc0202d44:	00003697          	auipc	a3,0x3
ffffffffc0202d48:	d0c68693          	addi	a3,a3,-756 # ffffffffc0205a50 <default_pmm_manager+0x880>
...
ffffffffc0202d5c:	b2050513          	addi	a0,a0,-1248 # ffffffffc0205878 <default_pmm_manager+0x6a8>
ffffffffc0202d60:	e14fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==4);
ffffffffc0202d64:	00003697          	auipc	a3,0x3
ffffffffc0202d68:	cdc68693          	addi	a3,a3,-804 # ffffffffc0205a40 <default_pmm_manager+0x870>
ffffffffc0202d6c:	00002617          	auipc	a2,0x2
ffffffffc0202d70:	0b460613          	addi	a2,a2,180 # ffffffffc0204e20 <commands+0x738>
ffffffffc0202d74:	0a000593          	li	a1,160
ffffffffc0202d78:	00003517          	auipc	a0,0x3
ffffffffc0202d7c:	b0050513          	addi	a0,a0,-1280 # ffffffffc0205878 <default_pmm_manager+0x6a8>
ffffffffc0202d80:	df4fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==4);
ffffffffc0202d84:	00003697          	auipc	a3,0x3
ffffffffc0202d88:	cbc68693          	addi	a3,a3,-836 # ffffffffc0205a40 <default_pmm_manager+0x870>
ffffffffc0202d8c:	00002617          	auipc	a2,0x2
ffffffffc0202d90:	09460613          	addi	a2,a2,148 # ffffffffc0204e20 <commands+0x738>
...
ffffffffc0202da8:	25468693          	addi	a3,a3,596 # ffffffffc0204ff8 <commands+0x910>
ffffffffc0202dac:	00002617          	auipc	a2,0x2
ffffffffc0202db0:	07460613          	addi	a2,a2,116 # ffffffffc0204e20 <commands+0x738>
...
ffffffffc0202dc8:	cf468693          	addi	a3,a3,-780 # ffffffffc0205ab8 <default_pmm_manager+0x8e8>
ffffffffc0202dcc:	00002617          	auipc	a2,0x2
ffffffffc0202dd0:	05460613          	addi	a2,a2,84 # ffffffffc0204e20 <commands+0x738>
...
ffffffffc0202de8:	b0c68693          	addi	a3,a3,-1268 # ffffffffc02058f0 <default_pmm_manager+0x720>
ffffffffc0202dec:	00002617          	auipc	a2,0x2
ffffffffc0202df0:	03460613          	addi	a2,a2,52 # ffffffffc0204e20 <commands+0x738>
...
ffffffffc0202e08:	afc68693          	addi	a3,a3,-1284 # ffffffffc0205900 <default_pmm_manager+0x730>
ffffffffc0202e0c:	00002617          	auipc	a2,0x2
ffffffffc0202e10:	01460613          	addi	a2,a2,20 # ffffffffc0204e20 <commands+0x738>
...
ffffffffc0202e28:	b2468693          	addi	a3,a3,-1244 # ffffffffc0205948 <default_pmm_manager+0x778>
ffffffffc0202e2c:	00002617          	auipc	a2,0x2
ffffffffc0202e30:	ff460613          	addi	a2,a2,-12 # ffffffffc0204e20 <commands+0x738>
...
ffffffffc0202e48:	00c68693          	addi	a3,a3,12 # ffffffffc0204e50 <commands+0x768>
ffffffffc0202e4c:	00002617          	auipc	a2,0x2
ffffffffc0202e50:	fd460613          	addi	a2,a2,-44 # ffffffffc0204e20 <commands+0x738>
...
ffffffffc0202e68:	bbc68693          	addi	a3,a3,-1092 # ffffffffc0205a20 <default_pmm_manager+0x850>
ffffffffc0202e6c:	00002617          	auipc	a2,0x2
ffffffffc0202e70:	fb460613          	addi	a2,a2,-76 # ffffffffc0204e20 <commands+0x738>
...
ffffffffc0202e88:	b9c68693          	addi	a3,a3,-1124 # ffffffffc0205a20 <default_pmm_manager+0x850>
ffffffffc0202e8c:	00002617          	auipc	a2,0x2
ffffffffc0202e90:	f9460613          	addi	a2,a2,-108 # ffffffffc0204e20 <commands+0x738>
...
ffffffffc0202ea8:	b8c68693          	addi	a3,a3,-1140 # ffffffffc0205a30 <default_pmm_manager+0x860>
ffffffffc0202eac:	00002617          	auipc	a2,0x2
ffffffffc0202eb0:	f7460613          	addi	a2,a2,-140 # ffffffffc0204e20 <commands+0x738>
...
ffffffffc0202ec8:	b6c68693          	addi	a3,a3,-1172 # ffffffffc0205a30 <default_pmm_manager+0x860>
ffffffffc0202ecc:	00002617          	auipc	a2,0x2
ffffffffc0202ed0:	f5460613          	addi	a2,a2,-172 # ffffffffc0204e20 <commands+0x738>
...
ffffffffc0202ee8:	b2c68693          	addi	a3,a3,-1236 # ffffffffc0205a10 <default_pmm_manager+0x840>
ffffffffc0202eec:	00002617          	auipc	a2,0x2
ffffffffc0202ef0:	f3460613          	addi	a2,a2,-204 # ffffffffc0204e20 <commands+0x738>
...
ffffffffc0202f08:	b0c68693          	addi	a3,a3,-1268 # ffffffffc0205a10 <default_pmm_manager+0x840>
ffffffffc0202f0c:	00002617          	auipc	a2,0x2
ffffffffc0202f10:	f1460613          	addi	a2,a2,-236 # ffffffffc0204e20 <commands+0x738>
...
ffffffffc0202f28:	9a468693          	addi	a3,a3,-1628 # ffffffffc02058c8 <default_pmm_manager+0x6f8>
ffffffffc0202f2c:	00002617          	auipc	a2,0x2
ffffffffc0202f30:	ef460613          	addi	a2,a2,-268 # ffffffffc0204e20 <commands+0x738>
...
ffffffffc0202f48:	99468693          	addi	a3,a3,-1644 # ffffffffc02058d8 <default_pmm_manager+0x708>
ffffffffc0202f4c:	00002617          	auipc	a2,0x2
ffffffffc0202f50:	ed460613          	addi	a2,a2,-300 # ffffffffc0204e20 <commands+0x738>
...
ffffffffc0202f68:	a5c68693          	addi	a3,a3,-1444 # ffffffffc02059c0 <default_pmm_manager+0x7f0>
ffffffffc0202f6c:	00002617          	auipc	a2,0x2
ffffffffc0202f70:	eb460613          	addi	a2,a2,-332 # ffffffffc0204e20 <commands+0x738>
...
ffffffffc0202fc8:	b9cb0b13          	addi	s6,s6,-1124 # ffffffffc0205b60 <default_pmm_manager+0x990>
                    cprintf("SWAP: failed to save\n");
ffffffffc0202fcc:	00003b97          	auipc	s7,0x3
ffffffffc0202fd0:	b7cb8b93          	addi	s7,s7,-1156 # ffffffffc0205b48 <default_pmm_manager+0x978>
...
ffffffffc0203008:	048a0d63          	beq	s4,s0,ffffffffc0203062 <swap_out+0xc6>
          int r = sm->swap_out_victim(mm, &page, in_tick);//ѡ�񱻻�����ҳ��
...
ffffffffc020301c:	67a2                	ld	a5,8(sp)
          pte_t *ptep = get_pte(mm->pgdir, v, 0);//��ȡ��Ӧҳ����
...
ffffffffc0203040:	66d000ef          	jal	ra,ffffffffc0203eac <swapfs_write>
...
ffffffffc0203082:	a8250513          	addi	a0,a0,-1406 # ffffffffc0205b00 <default_pmm_manager+0x930>
...
ffffffffc0203094:	aa068693          	addi	a3,a3,-1376 # ffffffffc0205b30 <default_pmm_manager+0x960>
ffffffffc0203098:	00002617          	auipc	a2,0x2
ffffffffc020309c:	d8860613          	addi	a2,a2,-632 # ffffffffc0204e20 <commands+0x738>
ffffffffc02030a0:	06900593          	li	a1,105
ffffffffc02030a4:	00002517          	auipc	a0,0x2
ffffffffc02030a8:	7d450513          	addi	a0,a0,2004 # ffffffffc0205878 <default_pmm_manager+0x6a8>
...
ffffffffc02030de:	535000ef          	jal	ra,ffffffffc0203e12 <swapfs_read>
     cprintf("swap_in: load disk swap entry %d with swap_page in vadr 0x%x\n", (*ptep)>>8, addr);
ffffffffc02030e2:	00093583          	ld	a1,0(s2)
ffffffffc02030e6:	8626                	mv	a2,s1
ffffffffc02030e8:	00003517          	auipc	a0,0x3
ffffffffc02030ec:	ac850513          	addi	a0,a0,-1336 # ffffffffc0205bb0 <default_pmm_manager+0x9e0>
...
ffffffffc020310e:	a9668693          	addi	a3,a3,-1386 # ffffffffc0205ba0 <default_pmm_manager+0x9d0>
ffffffffc0203112:	00002617          	auipc	a2,0x2
ffffffffc0203116:	d0e60613          	addi	a2,a2,-754 # ffffffffc0204e20 <commands+0x738>
ffffffffc020311a:	07f00593          	li	a1,127
ffffffffc020311e:	00002517          	auipc	a0,0x2
ffffffffc0203122:	75a50513          	addi	a0,a0,1882 # ffffffffc0205878 <default_pmm_manager+0x6a8>
...
ffffffffc0203152:	aa250513          	addi	a0,a0,-1374 # ffffffffc0205bf0 <default_pmm_manager+0xa20>
    *(unsigned char *)0x3000 = 0x0c;
...
ffffffffc0203188:	aac50513          	addi	a0,a0,-1364 # ffffffffc0205c30 <default_pmm_manager+0xa60>
    *(unsigned char *)0x1000 = 0x0a;
...
ffffffffc02031ac:	ab050513          	addi	a0,a0,-1360 # ffffffffc0205c58 <default_pmm_manager+0xa88>
    *(unsigned char *)0x4000 = 0x0d;
...
ffffffffc02031ca:	aba50513          	addi	a0,a0,-1350 # ffffffffc0205c80 <default_pmm_manager+0xab0>
    *(unsigned char *)0x2000 = 0x0b;
...
ffffffffc02031e6:	ac650513          	addi	a0,a0,-1338 # ffffffffc0205ca8 <default_pmm_manager+0xad8>
...
ffffffffc0203204:	a8050513          	addi	a0,a0,-1408 # ffffffffc0205c80 <default_pmm_manager+0xab0>
...
ffffffffc020321c:	a1850513          	addi	a0,a0,-1512 # ffffffffc0205c30 <default_pmm_manager+0xa60>
...
ffffffffc0203236:	a4e50513          	addi	a0,a0,-1458 # ffffffffc0205c80 <default_pmm_manager+0xab0>
...
ffffffffc0203250:	9a450513          	addi	a0,a0,-1628 # ffffffffc0205bf0 <default_pmm_manager+0xa20>
...
ffffffffc020326a:	9f250513          	addi	a0,a0,-1550 # ffffffffc0205c58 <default_pmm_manager+0xa88>
...
ffffffffc0203284:	a2850513          	addi	a0,a0,-1496 # ffffffffc0205ca8 <default_pmm_manager+0xad8>
...
ffffffffc02032a2:	99250513          	addi	a0,a0,-1646 # ffffffffc0205c30 <default_pmm_manager+0xa60>
...
ffffffffc02032e0:	76468693          	addi	a3,a3,1892 # ffffffffc0205a40 <default_pmm_manager+0x870>
ffffffffc02032e4:	00002617          	auipc	a2,0x2
ffffffffc02032e8:	b3c60613          	addi	a2,a2,-1220 # ffffffffc0204e20 <commands+0x738>
ffffffffc02032ec:	04e00593          	li	a1,78
ffffffffc02032f0:	00003517          	auipc	a0,0x3
ffffffffc02032f4:	92850513          	addi	a0,a0,-1752 # ffffffffc0205c18 <default_pmm_manager+0xa48>
ffffffffc02032f8:	87cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==11);
ffffffffc02032fc:	00003697          	auipc	a3,0x3
ffffffffc0203300:	a5c68693          	addi	a3,a3,-1444 # ffffffffc0205d58 <default_pmm_manager+0xb88>
ffffffffc0203304:	00002617          	auipc	a2,0x2
ffffffffc0203308:	b1c60613          	addi	a2,a2,-1252 # ffffffffc0204e20 <commands+0x738>
ffffffffc020330c:	07000593          	li	a1,112
ffffffffc0203310:	00003517          	auipc	a0,0x3
ffffffffc0203314:	90850513          	addi	a0,a0,-1784 # ffffffffc0205c18 <default_pmm_manager+0xa48>
ffffffffc0203318:	85cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(*(unsigned char *)0x1000 == 0x0a);
ffffffffc020331c:	00003697          	auipc	a3,0x3
ffffffffc0203320:	a1468693          	addi	a3,a3,-1516 # ffffffffc0205d30 <default_pmm_manager+0xb60>
ffffffffc0203324:	00002617          	auipc	a2,0x2
ffffffffc0203328:	afc60613          	addi	a2,a2,-1284 # ffffffffc0204e20 <commands+0x738>
ffffffffc020332c:	06e00593          	li	a1,110
ffffffffc0203330:	00003517          	auipc	a0,0x3
ffffffffc0203334:	8e850513          	addi	a0,a0,-1816 # ffffffffc0205c18 <default_pmm_manager+0xa48>
ffffffffc0203338:	83cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==10);
ffffffffc020333c:	00003697          	auipc	a3,0x3
ffffffffc0203340:	9e468693          	addi	a3,a3,-1564 # ffffffffc0205d20 <default_pmm_manager+0xb50>
ffffffffc0203344:	00002617          	auipc	a2,0x2
ffffffffc0203348:	adc60613          	addi	a2,a2,-1316 # ffffffffc0204e20 <commands+0x738>
ffffffffc020334c:	06c00593          	li	a1,108
ffffffffc0203350:	00003517          	auipc	a0,0x3
ffffffffc0203354:	8c850513          	addi	a0,a0,-1848 # ffffffffc0205c18 <default_pmm_manager+0xa48>
ffffffffc0203358:	81cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==9);
ffffffffc020335c:	00003697          	auipc	a3,0x3
ffffffffc0203360:	9b468693          	addi	a3,a3,-1612 # ffffffffc0205d10 <default_pmm_manager+0xb40>
ffffffffc0203364:	00002617          	auipc	a2,0x2
ffffffffc0203368:	abc60613          	addi	a2,a2,-1348 # ffffffffc0204e20 <commands+0x738>
ffffffffc020336c:	06900593          	li	a1,105
ffffffffc0203370:	00003517          	auipc	a0,0x3
ffffffffc0203374:	8a850513          	addi	a0,a0,-1880 # ffffffffc0205c18 <default_pmm_manager+0xa48>
ffffffffc0203378:	ffdfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==8);
ffffffffc020337c:	00003697          	auipc	a3,0x3
ffffffffc0203380:	98468693          	addi	a3,a3,-1660 # ffffffffc0205d00 <default_pmm_manager+0xb30>
ffffffffc0203384:	00002617          	auipc	a2,0x2
ffffffffc0203388:	a9c60613          	addi	a2,a2,-1380 # ffffffffc0204e20 <commands+0x738>
ffffffffc020338c:	06600593          	li	a1,102
ffffffffc0203390:	00003517          	auipc	a0,0x3
ffffffffc0203394:	88850513          	addi	a0,a0,-1912 # ffffffffc0205c18 <default_pmm_manager+0xa48>
ffffffffc0203398:	fddfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==7);
ffffffffc020339c:	00003697          	auipc	a3,0x3
ffffffffc02033a0:	95468693          	addi	a3,a3,-1708 # ffffffffc0205cf0 <default_pmm_manager+0xb20>
ffffffffc02033a4:	00002617          	auipc	a2,0x2
ffffffffc02033a8:	a7c60613          	addi	a2,a2,-1412 # ffffffffc0204e20 <commands+0x738>
ffffffffc02033ac:	06300593          	li	a1,99
ffffffffc02033b0:	00003517          	auipc	a0,0x3
ffffffffc02033b4:	86850513          	addi	a0,a0,-1944 # ffffffffc0205c18 <default_pmm_manager+0xa48>
ffffffffc02033b8:	fbdfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==6);
ffffffffc02033bc:	00003697          	auipc	a3,0x3
ffffffffc02033c0:	92468693          	addi	a3,a3,-1756 # ffffffffc0205ce0 <default_pmm_manager+0xb10>
ffffffffc02033c4:	00002617          	auipc	a2,0x2
ffffffffc02033c8:	a5c60613          	addi	a2,a2,-1444 # ffffffffc0204e20 <commands+0x738>
ffffffffc02033cc:	06000593          	li	a1,96
ffffffffc02033d0:	00003517          	auipc	a0,0x3
ffffffffc02033d4:	84850513          	addi	a0,a0,-1976 # ffffffffc0205c18 <default_pmm_manager+0xa48>
ffffffffc02033d8:	f9dfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc02033dc:	00003697          	auipc	a3,0x3
ffffffffc02033e0:	8f468693          	addi	a3,a3,-1804 # ffffffffc0205cd0 <default_pmm_manager+0xb00>
ffffffffc02033e4:	00002617          	auipc	a2,0x2
ffffffffc02033e8:	a3c60613          	addi	a2,a2,-1476 # ffffffffc0204e20 <commands+0x738>
ffffffffc02033ec:	05d00593          	li	a1,93
ffffffffc02033f0:	00003517          	auipc	a0,0x3
ffffffffc02033f4:	82850513          	addi	a0,a0,-2008 # ffffffffc0205c18 <default_pmm_manager+0xa48>
ffffffffc02033f8:	f7dfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc02033fc:	00003697          	auipc	a3,0x3
ffffffffc0203400:	8d468693          	addi	a3,a3,-1836 # ffffffffc0205cd0 <default_pmm_manager+0xb00>
ffffffffc0203404:	00002617          	auipc	a2,0x2
ffffffffc0203408:	a1c60613          	addi	a2,a2,-1508 # ffffffffc0204e20 <commands+0x738>
ffffffffc020340c:	05a00593          	li	a1,90
ffffffffc0203410:	00003517          	auipc	a0,0x3
ffffffffc0203414:	80850513          	addi	a0,a0,-2040 # ffffffffc0205c18 <default_pmm_manager+0xa48>
ffffffffc0203418:	f5dfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==4);
ffffffffc020341c:	00002697          	auipc	a3,0x2
ffffffffc0203420:	62468693          	addi	a3,a3,1572 # ffffffffc0205a40 <default_pmm_manager+0x870>
ffffffffc0203424:	00002617          	auipc	a2,0x2
ffffffffc0203428:	9fc60613          	addi	a2,a2,-1540 # ffffffffc0204e20 <commands+0x738>
ffffffffc020342c:	05700593          	li	a1,87
ffffffffc0203430:	00002517          	auipc	a0,0x2
ffffffffc0203434:	7e850513          	addi	a0,a0,2024 # ffffffffc0205c18 <default_pmm_manager+0xa48>
ffffffffc0203438:	f3dfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==4);
ffffffffc020343c:	00002697          	auipc	a3,0x2
ffffffffc0203440:	60468693          	addi	a3,a3,1540 # ffffffffc0205a40 <default_pmm_manager+0x870>
ffffffffc0203444:	00002617          	auipc	a2,0x2
ffffffffc0203448:	9dc60613          	addi	a2,a2,-1572 # ffffffffc0204e20 <commands+0x738>
ffffffffc020344c:	05400593          	li	a1,84
ffffffffc0203450:	00002517          	auipc	a0,0x2
ffffffffc0203454:	7c850513          	addi	a0,a0,1992 # ffffffffc0205c18 <default_pmm_manager+0xa48>
ffffffffc0203458:	f1dfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==4);
ffffffffc020345c:	00002697          	auipc	a3,0x2
ffffffffc0203460:	5e468693          	addi	a3,a3,1508 # ffffffffc0205a40 <default_pmm_manager+0x870>
ffffffffc0203464:	00002617          	auipc	a2,0x2
ffffffffc0203468:	9bc60613          	addi	a2,a2,-1604 # ffffffffc0204e20 <commands+0x738>
ffffffffc020346c:	05100593          	li	a1,81
ffffffffc0203470:	00002517          	auipc	a0,0x2
ffffffffc0203474:	7a850513          	addi	a0,a0,1960 # ffffffffc0205c18 <default_pmm_manager+0xa48>
...
ffffffffc0203480:	e406                	sd	ra,8(sp)
         assert(head != NULL);
ffffffffc0203482:	c731                	beqz	a4,ffffffffc02034ce <_lru_swap_out_victim+0x52>
     assert(in_tick==0);
ffffffffc0203484:	e60d                	bnez	a2,ffffffffc02034ae <_lru_swap_out_victim+0x32>
    return listelm->prev;
ffffffffc0203486:	631c                	ld	a5,0(a4)
    if (entry != head) {
ffffffffc0203488:	00f70d63          	beq	a4,a5,ffffffffc02034a2 <_lru_swap_out_victim+0x26>
    __list_del(listelm->prev, listelm->next);
...
ffffffffc02034b2:	8ca68693          	addi	a3,a3,-1846 # ffffffffc0205d78 <default_pmm_manager+0xba8>
ffffffffc02034b6:	00002617          	auipc	a2,0x2
ffffffffc02034ba:	96a60613          	addi	a2,a2,-1686 # ffffffffc0204e20 <commands+0x738>
ffffffffc02034be:	03c00593          	li	a1,60
ffffffffc02034c2:	00002517          	auipc	a0,0x2
ffffffffc02034c6:	75650513          	addi	a0,a0,1878 # ffffffffc0205c18 <default_pmm_manager+0xa48>
ffffffffc02034ca:	eabfc0ef          	jal	ra,ffffffffc0200374 <__panic>
         assert(head != NULL);
ffffffffc02034ce:	00003697          	auipc	a3,0x3
ffffffffc02034d2:	89a68693          	addi	a3,a3,-1894 # ffffffffc0205d68 <default_pmm_manager+0xb98>
ffffffffc02034d6:	00002617          	auipc	a2,0x2
ffffffffc02034da:	94a60613          	addi	a2,a2,-1718 # ffffffffc0204e20 <commands+0x738>
ffffffffc02034de:	03b00593          	li	a1,59
ffffffffc02034e2:	00002517          	auipc	a0,0x2
ffffffffc02034e6:	73650513          	addi	a0,a0,1846 # ffffffffc0205c18 <default_pmm_manager+0xa48>
ffffffffc02034ea:	e8bfc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc02034ee <_lru_map_swappable>:
    list_entry_t *head=(list_entry_t*) mm->sm_priv;
ffffffffc02034ee:	7518                	ld	a4,40(a0)
    assert(entry != NULL && head != NULL);
ffffffffc02034f0:	c321                	beqz	a4,ffffffffc0203530 <_lru_map_swappable+0x42>
    return listelm->next;
ffffffffc02034f2:	670c                	ld	a1,8(a4)
ffffffffc02034f4:	03060693          	addi	a3,a2,48
    while (current != head) {
ffffffffc02034f8:	00b70b63          	beq	a4,a1,ffffffffc020350e <_lru_map_swappable+0x20>
        if (current == entry) {
ffffffffc02034fc:	00b68f63          	beq	a3,a1,ffffffffc020351a <_lru_map_swappable+0x2c>
ffffffffc0203500:	87ae                	mv	a5,a1
ffffffffc0203502:	a019                	j	ffffffffc0203508 <_lru_map_swappable+0x1a>
ffffffffc0203504:	00f68b63          	beq	a3,a5,ffffffffc020351a <_lru_map_swappable+0x2c>
ffffffffc0203508:	679c                	ld	a5,8(a5)
    while (current != head) {
ffffffffc020350a:	fef71de3          	bne	a4,a5,ffffffffc0203504 <_lru_map_swappable+0x16>
    prev->next = next->prev = elm;
ffffffffc020350e:	e194                	sd	a3,0(a1)
ffffffffc0203510:	e714                	sd	a3,8(a4)
    elm->next = next;
ffffffffc0203512:	fe0c                	sd	a1,56(a2)
    elm->prev = prev;
ffffffffc0203514:	fa18                	sd	a4,48(a2)
}
ffffffffc0203516:	4501                	li	a0,0
ffffffffc0203518:	8082                	ret
    __list_del(listelm->prev, listelm->next);
ffffffffc020351a:	7a08                	ld	a0,48(a2)
ffffffffc020351c:	7e1c                	ld	a5,56(a2)
    prev->next = next;
ffffffffc020351e:	e51c                	sd	a5,8(a0)
    __list_add(elm, listelm, listelm->next);
ffffffffc0203520:	670c                	ld	a1,8(a4)
    next->prev = prev;
ffffffffc0203522:	e388                	sd	a0,0(a5)
ffffffffc0203524:	4501                	li	a0,0
    prev->next = next->prev = elm;
ffffffffc0203526:	e194                	sd	a3,0(a1)
ffffffffc0203528:	e714                	sd	a3,8(a4)
    elm->next = next;
ffffffffc020352a:	fe0c                	sd	a1,56(a2)
    elm->prev = prev;
ffffffffc020352c:	fa18                	sd	a4,48(a2)
ffffffffc020352e:	8082                	ret
{
ffffffffc0203530:	1141                	addi	sp,sp,-16
    assert(entry != NULL && head != NULL);
ffffffffc0203532:	00003697          	auipc	a3,0x3
ffffffffc0203536:	85668693          	addi	a3,a3,-1962 # ffffffffc0205d88 <default_pmm_manager+0xbb8>
ffffffffc020353a:	00002617          	auipc	a2,0x2
ffffffffc020353e:	8e660613          	addi	a2,a2,-1818 # ffffffffc0204e20 <commands+0x738>
ffffffffc0203542:	02300593          	li	a1,35
ffffffffc0203546:	00002517          	auipc	a0,0x2
ffffffffc020354a:	6d250513          	addi	a0,a0,1746 # ffffffffc0205c18 <default_pmm_manager+0xa48>
{
ffffffffc020354e:	e406                	sd	ra,8(sp)
    assert(entry != NULL && head != NULL);
ffffffffc0203550:	e25fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203554 <check_vma_overlap.part.0>:
...
ffffffffc020355a:	86a68693          	addi	a3,a3,-1942 # ffffffffc0205dc0 <default_pmm_manager+0xbf0>
ffffffffc020355e:	00002617          	auipc	a2,0x2
ffffffffc0203562:	8c260613          	addi	a2,a2,-1854 # ffffffffc0204e20 <commands+0x738>
ffffffffc0203566:	07e00593          	li	a1,126
ffffffffc020356a:	00003517          	auipc	a0,0x3
ffffffffc020356e:	87650513          	addi	a0,a0,-1930 # ffffffffc0205de0 <default_pmm_manager+0xc10>
check_vma_overlap(struct vma_struct *prev, struct vma_struct *next) {
ffffffffc0203572:	e406                	sd	ra,8(sp)
    assert(next->vm_start < next->vm_end);
ffffffffc0203574:	e01fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203578 <mm_create>:
mm_create(void) {
...
mm_create(void) {
ffffffffc020357e:	e022                	sd	s0,0(sp)
ffffffffc0203580:	e406                	sd	ra,8(sp)
    struct mm_struct *mm = kmalloc(sizeof(struct mm_struct));//分配内存
ffffffffc0203582:	9f6ff0ef          	jal	ra,ffffffffc0202778 <kmalloc>
ffffffffc0203586:	842a                	mv	s0,a0
    if (mm != NULL) {   //检查分配是否成功
ffffffffc0203588:	c105                	beqz	a0,ffffffffc02035a8 <mm_create+0x30>
    elm->prev = elm->next = elm;
ffffffffc020358a:	e408                	sd	a0,8(s0)
ffffffffc020358c:	e008                	sd	a0,0(s0)
        mm->mmap_cache = NULL;
ffffffffc020358e:	00053823          	sd	zero,16(a0)
        mm->pgdir = NULL;
ffffffffc0203592:	00053c23          	sd	zero,24(a0)
        mm->map_count = 0;
ffffffffc0203596:	02052023          	sw	zero,32(a0)
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc020359a:	0000e797          	auipc	a5,0xe
ffffffffc020359e:	fb67a783          	lw	a5,-74(a5) # ffffffffc0211550 <swap_init_ok>
ffffffffc02035a2:	eb81                	bnez	a5,ffffffffc02035b2 <mm_create+0x3a>
...
ffffffffc02035b0:	8082                	ret
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc02035b2:	9d3ff0ef          	jal	ra,ffffffffc0202f84 <swap_init_mm>
}
ffffffffc02035b6:	60a2                	ld	ra,8(sp)
...
ffffffffc02035d2:	8432                	mv	s0,a2
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc02035d4:	9a4ff0ef          	jal	ra,ffffffffc0202778 <kmalloc>
    if (vma != NULL) {
...
ffffffffc02035ee:	86aa                	mv	a3,a0
    if (mm != NULL) {
ffffffffc02035f0:	c505                	beqz	a0,ffffffffc0203618 <find_vma+0x2a>
        vma = mm->mmap_cache;
ffffffffc02035f2:	6908                	ld	a0,16(a0)
        if (!(vma != NULL && vma->vm_start <= addr && vma->vm_end > addr)) {
ffffffffc02035f4:	c501                	beqz	a0,ffffffffc02035fc <find_vma+0xe>
ffffffffc02035f6:	651c                	ld	a5,8(a0)
ffffffffc02035f8:	02f5f263          	bgeu	a1,a5,ffffffffc020361c <find_vma+0x2e>
    return listelm->next;
ffffffffc02035fc:	669c                	ld	a5,8(a3)
                while ((le = list_next(le)) != list) {
ffffffffc02035fe:	00f68d63          	beq	a3,a5,ffffffffc0203618 <find_vma+0x2a>
                    if (vma->vm_start<=addr && addr < vma->vm_end) {
ffffffffc0203602:	fe87b703          	ld	a4,-24(a5)
ffffffffc0203606:	00e5e663          	bltu	a1,a4,ffffffffc0203612 <find_vma+0x24>
ffffffffc020360a:	ff07b703          	ld	a4,-16(a5)
ffffffffc020360e:	00e5ec63          	bltu	a1,a4,ffffffffc0203626 <find_vma+0x38>
ffffffffc0203612:	679c                	ld	a5,8(a5)
                while ((le = list_next(le)) != list) {
ffffffffc0203614:	fef697e3          	bne	a3,a5,ffffffffc0203602 <find_vma+0x14>
    struct vma_struct *vma = NULL;
ffffffffc0203618:	4501                	li	a0,0
}
ffffffffc020361a:	8082                	ret
        if (!(vma != NULL && vma->vm_start <= addr && vma->vm_end > addr)) {
ffffffffc020361c:	691c                	ld	a5,16(a0)
ffffffffc020361e:	fcf5ffe3          	bgeu	a1,a5,ffffffffc02035fc <find_vma+0xe>
            mm->mmap_cache = vma;
ffffffffc0203622:	ea88                	sd	a0,16(a3)
ffffffffc0203624:	8082                	ret
                    vma = le2vma(le, list_link);
ffffffffc0203626:	fe078513          	addi	a0,a5,-32
            mm->mmap_cache = vma;
ffffffffc020362a:	ea88                	sd	a0,16(a3)
ffffffffc020362c:	8082                	ret

ffffffffc020362e <insert_vma_struct>:
...
ffffffffc020362e:	6590                	ld	a2,8(a1)
ffffffffc0203630:	0105b803          	ld	a6,16(a1)
insert_vma_struct(struct mm_struct *mm, struct vma_struct *vma) {
ffffffffc0203634:	1141                	addi	sp,sp,-16
ffffffffc0203636:	e406                	sd	ra,8(sp)
ffffffffc0203638:	87aa                	mv	a5,a0
    assert(vma->vm_start < vma->vm_end);    //确保start < end
ffffffffc020363a:	01066763          	bltu	a2,a6,ffffffffc0203648 <insert_vma_struct+0x1a>
ffffffffc020363e:	a085                	j	ffffffffc020369e <insert_vma_struct+0x70>
...
ffffffffc0203644:	04e66863          	bltu	a2,a4,ffffffffc0203694 <insert_vma_struct+0x66>
ffffffffc0203648:	86be                	mv	a3,a5
ffffffffc020364a:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list) {
ffffffffc020364c:	fef51ae3          	bne	a0,a5,ffffffffc0203640 <insert_vma_struct+0x12>
        }
    //遍历链表，按照start有序插入
    ...
    /* check overlap */
    if (le_prev != list) {
ffffffffc0203650:	02a68463          	beq	a3,a0,ffffffffc0203678 <insert_vma_struct+0x4a>
        check_vma_overlap(le2vma(le_prev, list_link), vma);
ffffffffc0203654:	ff06b703          	ld	a4,-16(a3)
    assert(prev->vm_start < prev->vm_end);
ffffffffc0203658:	fe86b883          	ld	a7,-24(a3)
ffffffffc020365c:	08e8f163          	bgeu	a7,a4,ffffffffc02036de <insert_vma_struct+0xb0>
    assert(prev->vm_end <= next->vm_start);
ffffffffc0203660:	04e66f63          	bltu	a2,a4,ffffffffc02036be <insert_vma_struct+0x90>
    }
    if (le_next != list) {
ffffffffc0203664:	00f50a63          	beq	a0,a5,ffffffffc0203678 <insert_vma_struct+0x4a>
            if (mmap_prev->vm_start > vma->vm_start) {
ffffffffc0203668:	fe87b703          	ld	a4,-24(a5)
    assert(prev->vm_end <= next->vm_start);
ffffffffc020366c:	05076963          	bltu	a4,a6,ffffffffc02036be <insert_vma_struct+0x90>
    assert(next->vm_start < next->vm_end);
ffffffffc0203670:	ff07b603          	ld	a2,-16(a5)
ffffffffc0203674:	02c77363          	bgeu	a4,a2,ffffffffc020369a <insert_vma_struct+0x6c>
    }
    ...
    mm->map_count ++;
ffffffffc0203678:	5118                	lw	a4,32(a0)
    vma->vm_mm = mm;
ffffffffc020367a:	e188                	sd	a0,0(a1)
    list_add_after(le_prev, &(vma->list_link));
ffffffffc020367c:	02058613          	addi	a2,a1,32
    prev->next = next->prev = elm;
ffffffffc0203680:	e390                	sd	a2,0(a5)
ffffffffc0203682:	e690                	sd	a2,8(a3)
}
ffffffffc0203684:	60a2                	ld	ra,8(sp)
    elm->next = next;
ffffffffc0203686:	f59c                	sd	a5,40(a1)
    elm->prev = prev;
ffffffffc0203688:	f194                	sd	a3,32(a1)
    mm->map_count ++;
ffffffffc020368a:	0017079b          	addiw	a5,a4,1
ffffffffc020368e:	d11c                	sw	a5,32(a0)
}
ffffffffc0203690:	0141                	addi	sp,sp,16
ffffffffc0203692:	8082                	ret
    if (le_prev != list) {
ffffffffc0203694:	fca690e3          	bne	a3,a0,ffffffffc0203654 <insert_vma_struct+0x26>
ffffffffc0203698:	bfd1                	j	ffffffffc020366c <insert_vma_struct+0x3e>
ffffffffc020369a:	ebbff0ef          	jal	ra,ffffffffc0203554 <check_vma_overlap.part.0>
    assert(vma->vm_start < vma->vm_end);    //确保start < end
ffffffffc020369e:	00002697          	auipc	a3,0x2
ffffffffc02036a2:	75268693          	addi	a3,a3,1874 # ffffffffc0205df0 <default_pmm_manager+0xc20>
ffffffffc02036a6:	00001617          	auipc	a2,0x1
ffffffffc02036aa:	77a60613          	addi	a2,a2,1914 # ffffffffc0204e20 <commands+0x738>
ffffffffc02036ae:	08500593          	li	a1,133
ffffffffc02036b2:	00002517          	auipc	a0,0x2
ffffffffc02036b6:	72e50513          	addi	a0,a0,1838 # ffffffffc0205de0 <default_pmm_manager+0xc10>
ffffffffc02036ba:	cbbfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(prev->vm_end <= next->vm_start);
ffffffffc02036be:	00002697          	auipc	a3,0x2
ffffffffc02036c2:	77268693          	addi	a3,a3,1906 # ffffffffc0205e30 <default_pmm_manager+0xc60>
ffffffffc02036c6:	00001617          	auipc	a2,0x1
ffffffffc02036ca:	75a60613          	addi	a2,a2,1882 # ffffffffc0204e20 <commands+0x738>
ffffffffc02036ce:	07d00593          	li	a1,125
ffffffffc02036d2:	00002517          	auipc	a0,0x2
ffffffffc02036d6:	70e50513          	addi	a0,a0,1806 # ffffffffc0205de0 <default_pmm_manager+0xc10>
ffffffffc02036da:	c9bfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(prev->vm_start < prev->vm_end);
ffffffffc02036de:	00002697          	auipc	a3,0x2
ffffffffc02036e2:	73268693          	addi	a3,a3,1842 # ffffffffc0205e10 <default_pmm_manager+0xc40>
ffffffffc02036e6:	00001617          	auipc	a2,0x1
ffffffffc02036ea:	73a60613          	addi	a2,a2,1850 # ffffffffc0204e20 <commands+0x738>
ffffffffc02036ee:	07c00593          	li	a1,124
ffffffffc02036f2:	00002517          	auipc	a0,0x2
ffffffffc02036f6:	6ee50513          	addi	a0,a0,1774 # ffffffffc0205de0 <default_pmm_manager+0xc10>
ffffffffc02036fa:	c7bfc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc02036fe <mm_destroy>:

// mm_destroy - free mm and mm internal fields
//释放所有vma
void
mm_destroy(struct mm_struct *mm) {
ffffffffc02036fe:	1141                	addi	sp,sp,-16
ffffffffc0203700:	e022                	sd	s0,0(sp)
ffffffffc0203702:	842a                	mv	s0,a0
    return listelm->next;
ffffffffc0203704:	6508                	ld	a0,8(a0)
ffffffffc0203706:	e406                	sd	ra,8(sp)

    list_entry_t *list = &(mm->mmap_list), *le;
    while ((le = list_next(list)) != list) {
ffffffffc0203708:	00a40e63          	beq	s0,a0,ffffffffc0203724 <mm_destroy+0x26>
    __list_del(listelm->prev, listelm->next);
...
ffffffffc020371a:	918ff0ef          	jal	ra,ffffffffc0202832 <kfree>
    return listelm->next;
ffffffffc020371e:	6408                	ld	a0,8(s0)
    while ((le = list_next(list)) != list) {
ffffffffc0203720:	fea416e3          	bne	s0,a0,ffffffffc020370c <mm_destroy+0xe>
    }
    kfree(mm, sizeof(struct mm_struct)); //kfree mm
ffffffffc0203724:	8522                	mv	a0,s0
    mm=NULL;
}
ffffffffc0203726:	6402                	ld	s0,0(sp)
ffffffffc0203728:	60a2                	ld	ra,8(sp)
    kfree(mm, sizeof(struct mm_struct)); //kfree mm
ffffffffc020372a:	03000593          	li	a1,48
}
ffffffffc020372e:	0141                	addi	sp,sp,16
    kfree(mm, sizeof(struct mm_struct)); //kfree mm
ffffffffc0203730:	902ff06f          	j	ffffffffc0202832 <kfree>

ffffffffc0203734 <vmm_init>:

// vmm_init - initialize virtual memory management
//          - now just call check_vmm to check correctness of vmm
void
vmm_init(void) {
ffffffffc0203734:	715d                	addi	sp,sp,-80
ffffffffc0203736:	e486                	sd	ra,72(sp)
ffffffffc0203738:	f44e                	sd	s3,40(sp)
ffffffffc020373a:	f052                	sd	s4,32(sp)
ffffffffc020373c:	e0a2                	sd	s0,64(sp)
ffffffffc020373e:	fc26                	sd	s1,56(sp)
ffffffffc0203740:	f84a                	sd	s2,48(sp)
ffffffffc0203742:	ec56                	sd	s5,24(sp)
ffffffffc0203744:	e85a                	sd	s6,16(sp)
ffffffffc0203746:	e45e                	sd	s7,8(sp)
}
...
ffffffffc0203748:	f4bfd0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
...
ffffffffc0203752:	8a2a                	mv	s4,a0
    struct mm_struct *mm = kmalloc(sizeof(struct mm_struct));//分配内存
ffffffffc0203754:	03000513          	li	a0,48
ffffffffc0203758:	820ff0ef          	jal	ra,ffffffffc0202778 <kmalloc>
    if (mm != NULL) {   //检查分配是否成功
ffffffffc020375c:	56050863          	beqz	a0,ffffffffc0203ccc <vmm_init+0x598>
    elm->prev = elm->next = elm;
ffffffffc0203760:	e508                	sd	a0,8(a0)
ffffffffc0203762:	e108                	sd	a0,0(a0)
        mm->mmap_cache = NULL;
ffffffffc0203764:	00053823          	sd	zero,16(a0)
        mm->pgdir = NULL;
ffffffffc0203768:	00053c23          	sd	zero,24(a0)
        mm->map_count = 0;
ffffffffc020376c:	02052023          	sw	zero,32(a0)
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc0203770:	0000e797          	auipc	a5,0xe
ffffffffc0203774:	de07a783          	lw	a5,-544(a5) # ffffffffc0211550 <swap_init_ok>
ffffffffc0203778:	84aa                	mv	s1,a0
ffffffffc020377a:	e7b9                	bnez	a5,ffffffffc02037c8 <vmm_init+0x94>
        else mm->sm_priv = NULL;
ffffffffc020377c:	02053423          	sd	zero,40(a0)
vmm_init(void) {
ffffffffc0203780:	03200413          	li	s0,50
ffffffffc0203784:	a811                	j	ffffffffc0203798 <vmm_init+0x64>
        vma->vm_start = vm_start;
...
ffffffffc020378a:	00053c23          	sd	zero,24(a0)
    ...
    int i;
    for (i = step1; i >= 1; i --) {
ffffffffc020378e:	146d                	addi	s0,s0,-5
        struct vma_struct *vma = vma_create(i * 5, i * 5 + 2, 0);
        assert(vma != NULL);
        insert_vma_struct(mm, vma);
ffffffffc0203790:	8526                	mv	a0,s1
ffffffffc0203792:	e9dff0ef          	jal	ra,ffffffffc020362e <insert_vma_struct>
    for (i = step1; i >= 1; i --) {
ffffffffc0203796:	cc05                	beqz	s0,ffffffffc02037ce <vmm_init+0x9a>
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
...
ffffffffc02037a2:	00240793          	addi	a5,s0,2
    if (vma != NULL) {
ffffffffc02037a6:	f165                	bnez	a0,ffffffffc0203786 <vmm_init+0x52>
        assert(vma != NULL);
ffffffffc02037a8:	00002697          	auipc	a3,0x2
ffffffffc02037ac:	15868693          	addi	a3,a3,344 # ffffffffc0205900 <default_pmm_manager+0x730>
ffffffffc02037b0:	00001617          	auipc	a2,0x1
ffffffffc02037b4:	67060613          	addi	a2,a2,1648 # ffffffffc0204e20 <commands+0x738>
ffffffffc02037b8:	0d000593          	li	a1,208
ffffffffc02037bc:	00002517          	auipc	a0,0x2
ffffffffc02037c0:	62450513          	addi	a0,a0,1572 # ffffffffc0205de0 <default_pmm_manager+0xc10>
ffffffffc02037c4:	bb1fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc02037c8:	fbcff0ef          	jal	ra,ffffffffc0202f84 <swap_init_mm>
ffffffffc02037cc:	bf55                	j	ffffffffc0203780 <vmm_init+0x4c>
ffffffffc02037ce:	03700413          	li	s0,55
    }

    for (i = step1 + 1; i <= step2; i ++) {
ffffffffc02037d2:	1f900913          	li	s2,505
ffffffffc02037d6:	a819                	j	ffffffffc02037ec <vmm_init+0xb8>
        vma->vm_start = vm_start;
ffffffffc02037d8:	e500                	sd	s0,8(a0)
        vma->vm_end = vm_end;
ffffffffc02037da:	e91c                	sd	a5,16(a0)
        vma->vm_flags = vm_flags;
ffffffffc02037dc:	00053c23          	sd	zero,24(a0)
    for (i = step1 + 1; i <= step2; i ++) {
ffffffffc02037e0:	0415                	addi	s0,s0,5
        struct vma_struct *vma = vma_create(i * 5, i * 5 + 2, 0);
        assert(vma != NULL);
        insert_vma_struct(mm, vma);
ffffffffc02037e2:	8526                	mv	a0,s1
ffffffffc02037e4:	e4bff0ef          	jal	ra,ffffffffc020362e <insert_vma_struct>
    for (i = step1 + 1; i <= step2; i ++) {
ffffffffc02037e8:	03240a63          	beq	s0,s2,ffffffffc020381c <vmm_init+0xe8>
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc02037ec:	03000513          	li	a0,48
ffffffffc02037f0:	f89fe0ef          	jal	ra,ffffffffc0202778 <kmalloc>
ffffffffc02037f4:	85aa                	mv	a1,a0
ffffffffc02037f6:	00240793          	addi	a5,s0,2
    if (vma != NULL) {
ffffffffc02037fa:	fd79                	bnez	a0,ffffffffc02037d8 <vmm_init+0xa4>
        assert(vma != NULL);
ffffffffc02037fc:	00002697          	auipc	a3,0x2
ffffffffc0203800:	10468693          	addi	a3,a3,260 # ffffffffc0205900 <default_pmm_manager+0x730>
ffffffffc0203804:	00001617          	auipc	a2,0x1
ffffffffc0203808:	61c60613          	addi	a2,a2,1564 # ffffffffc0204e20 <commands+0x738>
ffffffffc020380c:	0d600593          	li	a1,214
ffffffffc0203810:	00002517          	auipc	a0,0x2
ffffffffc0203814:	5d050513          	addi	a0,a0,1488 # ffffffffc0205de0 <default_pmm_manager+0xc10>
ffffffffc0203818:	b5dfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    return listelm->next;
ffffffffc020381c:	649c                	ld	a5,8(s1)
ffffffffc020381e:	471d                	li	a4,7
    }

    list_entry_t *le = list_next(&(mm->mmap_list));

    for (i = 1; i <= step2; i ++) {
ffffffffc0203820:	1fb00593          	li	a1,507
        assert(le != &(mm->mmap_list));
ffffffffc0203824:	2ef48463          	beq	s1,a5,ffffffffc0203b0c <vmm_init+0x3d8>
        struct vma_struct *mmap = le2vma(le, list_link);
        assert(mmap->vm_start == i * 5 && mmap->vm_end == i * 5 + 2);
ffffffffc0203828:	fe87b603          	ld	a2,-24(a5)
ffffffffc020382c:	ffe70693          	addi	a3,a4,-2
ffffffffc0203830:	26d61e63          	bne	a2,a3,ffffffffc0203aac <vmm_init+0x378>
ffffffffc0203834:	ff07b683          	ld	a3,-16(a5)
ffffffffc0203838:	26e69a63          	bne	a3,a4,ffffffffc0203aac <vmm_init+0x378>
    for (i = 1; i <= step2; i ++) {
ffffffffc020383c:	0715                	addi	a4,a4,5
ffffffffc020383e:	679c                	ld	a5,8(a5)
ffffffffc0203840:	feb712e3          	bne	a4,a1,ffffffffc0203824 <vmm_init+0xf0>
ffffffffc0203844:	4b1d                	li	s6,7
ffffffffc0203846:	4415                	li	s0,5
        le = list_next(le);
    }

    for (i = 5; i <= 5 * step2; i +=5) {
ffffffffc0203848:	1f900b93          	li	s7,505
        struct vma_struct *vma1 = find_vma(mm, i);
ffffffffc020384c:	85a2                	mv	a1,s0
ffffffffc020384e:	8526                	mv	a0,s1
ffffffffc0203850:	d9fff0ef          	jal	ra,ffffffffc02035ee <find_vma>
ffffffffc0203854:	892a                	mv	s2,a0
        assert(vma1 != NULL);
ffffffffc0203856:	2c050b63          	beqz	a0,ffffffffc0203b2c <vmm_init+0x3f8>
        struct vma_struct *vma2 = find_vma(mm, i+1);
ffffffffc020385a:	00140593          	addi	a1,s0,1
ffffffffc020385e:	8526                	mv	a0,s1
ffffffffc0203860:	d8fff0ef          	jal	ra,ffffffffc02035ee <find_vma>
ffffffffc0203864:	8aaa                	mv	s5,a0
        assert(vma2 != NULL);
ffffffffc0203866:	2e050363          	beqz	a0,ffffffffc0203b4c <vmm_init+0x418>
        struct vma_struct *vma3 = find_vma(mm, i+2);
ffffffffc020386a:	85da                	mv	a1,s6
ffffffffc020386c:	8526                	mv	a0,s1
ffffffffc020386e:	d81ff0ef          	jal	ra,ffffffffc02035ee <find_vma>
        assert(vma3 == NULL);
ffffffffc0203872:	2e051d63          	bnez	a0,ffffffffc0203b6c <vmm_init+0x438>
        struct vma_struct *vma4 = find_vma(mm, i+3);
ffffffffc0203876:	00340593          	addi	a1,s0,3
ffffffffc020387a:	8526                	mv	a0,s1
ffffffffc020387c:	d73ff0ef          	jal	ra,ffffffffc02035ee <find_vma>
        assert(vma4 == NULL);
ffffffffc0203880:	30051663          	bnez	a0,ffffffffc0203b8c <vmm_init+0x458>
        struct vma_struct *vma5 = find_vma(mm, i+4);
ffffffffc0203884:	00440593          	addi	a1,s0,4
ffffffffc0203888:	8526                	mv	a0,s1
ffffffffc020388a:	d65ff0ef          	jal	ra,ffffffffc02035ee <find_vma>
        assert(vma5 == NULL);
ffffffffc020388e:	30051f63          	bnez	a0,ffffffffc0203bac <vmm_init+0x478>

        assert(vma1->vm_start == i  && vma1->vm_end == i  + 2);
ffffffffc0203892:	00893783          	ld	a5,8(s2)
ffffffffc0203896:	24879b63          	bne	a5,s0,ffffffffc0203aec <vmm_init+0x3b8>
ffffffffc020389a:	01093783          	ld	a5,16(s2)
ffffffffc020389e:	25679763          	bne	a5,s6,ffffffffc0203aec <vmm_init+0x3b8>
        assert(vma2->vm_start == i  && vma2->vm_end == i  + 2);
ffffffffc02038a2:	008ab783          	ld	a5,8(s5)
ffffffffc02038a6:	22879363          	bne	a5,s0,ffffffffc0203acc <vmm_init+0x398>
ffffffffc02038aa:	010ab783          	ld	a5,16(s5)
ffffffffc02038ae:	21679f63          	bne	a5,s6,ffffffffc0203acc <vmm_init+0x398>
    for (i = 5; i <= 5 * step2; i +=5) {
ffffffffc02038b2:	0415                	addi	s0,s0,5
ffffffffc02038b4:	0b15                	addi	s6,s6,5
ffffffffc02038b6:	f9741be3          	bne	s0,s7,ffffffffc020384c <vmm_init+0x118>
ffffffffc02038ba:	4411                	li	s0,4
    }

    for (i =4; i>=0; i--) {
ffffffffc02038bc:	597d                	li	s2,-1
        struct vma_struct *vma_below_5= find_vma(mm,i);
ffffffffc02038be:	85a2                	mv	a1,s0
ffffffffc02038c0:	8526                	mv	a0,s1
ffffffffc02038c2:	d2dff0ef          	jal	ra,ffffffffc02035ee <find_vma>
ffffffffc02038c6:	0004059b          	sext.w	a1,s0
        if (vma_below_5 != NULL ) {
ffffffffc02038ca:	c90d                	beqz	a0,ffffffffc02038fc <vmm_init+0x1c8>
           cprintf("vma_below_5: i %x, start %x, end %x\n",i, vma_below_5->vm_start, vma_below_5->vm_end); 
ffffffffc02038cc:	6914                	ld	a3,16(a0)
ffffffffc02038ce:	6510                	ld	a2,8(a0)
ffffffffc02038d0:	00002517          	auipc	a0,0x2
ffffffffc02038d4:	68050513          	addi	a0,a0,1664 # ffffffffc0205f50 <default_pmm_manager+0xd80>
ffffffffc02038d8:	fe2fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
        }
        assert(vma_below_5 == NULL);
ffffffffc02038dc:	00002697          	auipc	a3,0x2
ffffffffc02038e0:	69c68693          	addi	a3,a3,1692 # ffffffffc0205f78 <default_pmm_manager+0xda8>
ffffffffc02038e4:	00001617          	auipc	a2,0x1
ffffffffc02038e8:	53c60613          	addi	a2,a2,1340 # ffffffffc0204e20 <commands+0x738>
ffffffffc02038ec:	0f800593          	li	a1,248
ffffffffc02038f0:	00002517          	auipc	a0,0x2
ffffffffc02038f4:	4f050513          	addi	a0,a0,1264 # ffffffffc0205de0 <default_pmm_manager+0xc10>
ffffffffc02038f8:	a7dfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    for (i =4; i>=0; i--) {
ffffffffc02038fc:	147d                	addi	s0,s0,-1
ffffffffc02038fe:	fd2410e3          	bne	s0,s2,ffffffffc02038be <vmm_init+0x18a>
ffffffffc0203902:	a811                	j	ffffffffc0203916 <vmm_init+0x1e2>
    __list_del(listelm->prev, listelm->next);
ffffffffc0203904:	6118                	ld	a4,0(a0)
ffffffffc0203906:	651c                	ld	a5,8(a0)
        kfree(le2vma(le, list_link),sizeof(struct vma_struct));  //kfree vma        
ffffffffc0203908:	03000593          	li	a1,48
ffffffffc020390c:	1501                	addi	a0,a0,-32
    prev->next = next;
ffffffffc020390e:	e71c                	sd	a5,8(a4)
    next->prev = prev;
ffffffffc0203910:	e398                	sd	a4,0(a5)
ffffffffc0203912:	f21fe0ef          	jal	ra,ffffffffc0202832 <kfree>
    return listelm->next;
ffffffffc0203916:	6488                	ld	a0,8(s1)
    while ((le = list_next(list)) != list) {
ffffffffc0203918:	fea496e3          	bne	s1,a0,ffffffffc0203904 <vmm_init+0x1d0>
    kfree(mm, sizeof(struct mm_struct)); //kfree mm
ffffffffc020391c:	03000593          	li	a1,48
ffffffffc0203920:	8526                	mv	a0,s1
ffffffffc0203922:	f11fe0ef          	jal	ra,ffffffffc0202832 <kfree>
    }

    mm_destroy(mm);

    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203926:	d6dfd0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
ffffffffc020392a:	3caa1163          	bne	s4,a0,ffffffffc0203cec <vmm_init+0x5b8>

    cprintf("check_vma_struct() succeeded!\n");
ffffffffc020392e:	00002517          	auipc	a0,0x2
ffffffffc0203932:	68a50513          	addi	a0,a0,1674 # ffffffffc0205fb8 <default_pmm_manager+0xde8>
ffffffffc0203936:	f84fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
...
check_pgfault(void) {
    ...
    size_t nr_free_pages_store = nr_free_pages();
ffffffffc020393a:	d59fd0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
ffffffffc020393e:	84aa                	mv	s1,a0
    struct mm_struct *mm = kmalloc(sizeof(struct mm_struct));//分配内存
ffffffffc0203940:	03000513          	li	a0,48
ffffffffc0203944:	e35fe0ef          	jal	ra,ffffffffc0202778 <kmalloc>
ffffffffc0203948:	842a                	mv	s0,a0
    if (mm != NULL) {   //检查分配是否成功
ffffffffc020394a:	2a050163          	beqz	a0,ffffffffc0203bec <vmm_init+0x4b8>
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc020394e:	0000e797          	auipc	a5,0xe
ffffffffc0203952:	c027a783          	lw	a5,-1022(a5) # ffffffffc0211550 <swap_init_ok>
    elm->prev = elm->next = elm;
ffffffffc0203956:	e508                	sd	a0,8(a0)
ffffffffc0203958:	e108                	sd	a0,0(a0)
        mm->mmap_cache = NULL;
ffffffffc020395a:	00053823          	sd	zero,16(a0)
        mm->pgdir = NULL;
ffffffffc020395e:	00053c23          	sd	zero,24(a0)
        mm->map_count = 0;
ffffffffc0203962:	02052023          	sw	zero,32(a0)
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc0203966:	14079063          	bnez	a5,ffffffffc0203aa6 <vmm_init+0x372>
        else mm->sm_priv = NULL;
ffffffffc020396a:	02053423          	sd	zero,40(a0)
    ...
    pde_t *pgdir = mm->pgdir = boot_pgdir;
ffffffffc020396e:	0000e917          	auipc	s2,0xe
ffffffffc0203972:	baa93903          	ld	s2,-1110(s2) # ffffffffc0211518 <boot_pgdir>
    assert(pgdir[0] == 0);
ffffffffc0203976:	00093783          	ld	a5,0(s2)
    check_mm_struct = mm_create();
ffffffffc020397a:	0000e717          	auipc	a4,0xe
ffffffffc020397e:	bc873f23          	sd	s0,-1058(a4) # ffffffffc0211558 <check_mm_struct>
    pde_t *pgdir = mm->pgdir = boot_pgdir;
ffffffffc0203982:	01243c23          	sd	s2,24(s0)
    assert(pgdir[0] == 0);
ffffffffc0203986:	24079363          	bnez	a5,ffffffffc0203bcc <vmm_init+0x498>
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc020398a:	03000513          	li	a0,48
ffffffffc020398e:	debfe0ef          	jal	ra,ffffffffc0202778 <kmalloc>
ffffffffc0203992:	8a2a                	mv	s4,a0
    if (vma != NULL) {
ffffffffc0203994:	28050063          	beqz	a0,ffffffffc0203c14 <vmm_init+0x4e0>
        vma->vm_end = vm_end;
ffffffffc0203998:	002007b7          	lui	a5,0x200
ffffffffc020399c:	00fa3823          	sd	a5,16(s4)
        vma->vm_flags = vm_flags;
ffffffffc02039a0:	4789                	li	a5,2
...
ffffffffc02039a2:	85aa                	mv	a1,a0
        vma->vm_flags = vm_flags;
ffffffffc02039a4:	00fa3c23          	sd	a5,24(s4)
    insert_vma_struct(mm, vma);
ffffffffc02039a8:	8522                	mv	a0,s0
        vma->vm_start = vm_start;
ffffffffc02039aa:	000a3423          	sd	zero,8(s4)
    insert_vma_struct(mm, vma);
ffffffffc02039ae:	c81ff0ef          	jal	ra,ffffffffc020362e <insert_vma_struct>

    uintptr_t addr = 0x100;
    assert(find_vma(mm, addr) == vma);
ffffffffc02039b2:	10000593          	li	a1,256
ffffffffc02039b6:	8522                	mv	a0,s0
ffffffffc02039b8:	c37ff0ef          	jal	ra,ffffffffc02035ee <find_vma>
ffffffffc02039bc:	10000793          	li	a5,256

    int i, sum = 0;
    for (i = 0; i < 100; i ++) {
ffffffffc02039c0:	16400713          	li	a4,356
    assert(find_vma(mm, addr) == vma);
ffffffffc02039c4:	26aa1863          	bne	s4,a0,ffffffffc0203c34 <vmm_init+0x500>
        *(char *)(addr + i) = i;
ffffffffc02039c8:	00f78023          	sb	a5,0(a5) # 200000 <kern_entry-0xffffffffc0000000>
    for (i = 0; i < 100; i ++) {
ffffffffc02039cc:	0785                	addi	a5,a5,1
ffffffffc02039ce:	fee79de3          	bne	a5,a4,ffffffffc02039c8 <vmm_init+0x294>
        sum += i;
ffffffffc02039d2:	6705                	lui	a4,0x1
ffffffffc02039d4:	10000793          	li	a5,256
ffffffffc02039d8:	35670713          	addi	a4,a4,854 # 1356 <kern_entry-0xffffffffc01fecaa>
    }
    for (i = 0; i < 100; i ++) {
ffffffffc02039dc:	16400613          	li	a2,356
        sum -= *(char *)(addr + i);
ffffffffc02039e0:	0007c683          	lbu	a3,0(a5)
    for (i = 0; i < 100; i ++) {
ffffffffc02039e4:	0785                	addi	a5,a5,1
        sum -= *(char *)(addr + i);
ffffffffc02039e6:	9f15                	subw	a4,a4,a3
    for (i = 0; i < 100; i ++) {
ffffffffc02039e8:	fec79ce3          	bne	a5,a2,ffffffffc02039e0 <vmm_init+0x2ac>
    }
    assert(sum == 0);
ffffffffc02039ec:	26071463          	bnez	a4,ffffffffc0203c54 <vmm_init+0x520>

    page_remove(pgdir, ROUNDDOWN(addr, PGSIZE));
ffffffffc02039f0:	4581                	li	a1,0
ffffffffc02039f2:	854a                	mv	a0,s2
ffffffffc02039f4:	f29fd0ef          	jal	ra,ffffffffc020191c <page_remove>
    return pa2page(PDE_ADDR(pde));
ffffffffc02039f8:	00093783          	ld	a5,0(s2)
    if (PPN(pa) >= npage) {
ffffffffc02039fc:	0000e717          	auipc	a4,0xe
ffffffffc0203a00:	b2473703          	ld	a4,-1244(a4) # ffffffffc0211520 <npage>
    return pa2page(PDE_ADDR(pde));
ffffffffc0203a04:	078a                	slli	a5,a5,0x2
ffffffffc0203a06:	83b1                	srli	a5,a5,0xc
    if (PPN(pa) >= npage) {
ffffffffc0203a08:	26e7f663          	bgeu	a5,a4,ffffffffc0203c74 <vmm_init+0x540>
    return &pages[PPN(pa) - nbase];
ffffffffc0203a0c:	00003717          	auipc	a4,0x3
ffffffffc0203a10:	97473703          	ld	a4,-1676(a4) # ffffffffc0206380 <nbase>
ffffffffc0203a14:	8f99                	sub	a5,a5,a4
ffffffffc0203a16:	00379713          	slli	a4,a5,0x3
ffffffffc0203a1a:	97ba                	add	a5,a5,a4
ffffffffc0203a1c:	078e                	slli	a5,a5,0x3

    free_page(pde2page(pgdir[0]));
ffffffffc0203a1e:	0000e517          	auipc	a0,0xe
ffffffffc0203a22:	b0a53503          	ld	a0,-1270(a0) # ffffffffc0211528 <pages>
ffffffffc0203a26:	953e                	add	a0,a0,a5
ffffffffc0203a28:	4585                	li	a1,1
ffffffffc0203a2a:	c29fd0ef          	jal	ra,ffffffffc0201652 <free_pages>
    return listelm->next;
ffffffffc0203a2e:	6408                	ld	a0,8(s0)

    pgdir[0] = 0;
ffffffffc0203a30:	00093023          	sd	zero,0(s2)

    mm->pgdir = NULL;
ffffffffc0203a34:	00043c23          	sd	zero,24(s0)
    while ((le = list_next(list)) != list) {
ffffffffc0203a38:	00a40e63          	beq	s0,a0,ffffffffc0203a54 <vmm_init+0x320>
    __list_del(listelm->prev, listelm->next);
ffffffffc0203a3c:	6118                	ld	a4,0(a0)
ffffffffc0203a3e:	651c                	ld	a5,8(a0)
        kfree(le2vma(le, list_link),sizeof(struct vma_struct));  //kfree vma        
ffffffffc0203a40:	03000593          	li	a1,48
ffffffffc0203a44:	1501                	addi	a0,a0,-32
    prev->next = next;
ffffffffc0203a46:	e71c                	sd	a5,8(a4)
    next->prev = prev;
ffffffffc0203a48:	e398                	sd	a4,0(a5)
ffffffffc0203a4a:	de9fe0ef          	jal	ra,ffffffffc0202832 <kfree>
    return listelm->next;
ffffffffc0203a4e:	6408                	ld	a0,8(s0)
    while ((le = list_next(list)) != list) {
ffffffffc0203a50:	fea416e3          	bne	s0,a0,ffffffffc0203a3c <vmm_init+0x308>
    kfree(mm, sizeof(struct mm_struct)); //kfree mm
ffffffffc0203a54:	03000593          	li	a1,48
ffffffffc0203a58:	8522                	mv	a0,s0
ffffffffc0203a5a:	dd9fe0ef          	jal	ra,ffffffffc0202832 <kfree>
    mm_destroy(mm);
...
ffffffffc0203a5e:	14fd                	addi	s1,s1,-1
    check_mm_struct = NULL;
ffffffffc0203a60:	0000e797          	auipc	a5,0xe
ffffffffc0203a64:	ae07bc23          	sd	zero,-1288(a5) # ffffffffc0211558 <check_mm_struct>

    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203a68:	c2bfd0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
ffffffffc0203a6c:	22a49063          	bne	s1,a0,ffffffffc0203c8c <vmm_init+0x558>

    cprintf("check_pgfault() succeeded!\n");
ffffffffc0203a70:	00002517          	auipc	a0,0x2
ffffffffc0203a74:	59850513          	addi	a0,a0,1432 # ffffffffc0206008 <default_pmm_manager+0xe38>
ffffffffc0203a78:	e42fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203a7c:	c17fd0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
    nr_free_pages_store--;	// szx : Sv39三级页表多占一个内存页，所以执行此操作
ffffffffc0203a80:	19fd                	addi	s3,s3,-1
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203a82:	22a99563          	bne	s3,a0,ffffffffc0203cac <vmm_init+0x578>
}
ffffffffc0203a86:	6406                	ld	s0,64(sp)
ffffffffc0203a88:	60a6                	ld	ra,72(sp)
ffffffffc0203a8a:	74e2                	ld	s1,56(sp)
ffffffffc0203a8c:	7942                	ld	s2,48(sp)
ffffffffc0203a8e:	79a2                	ld	s3,40(sp)
ffffffffc0203a90:	7a02                	ld	s4,32(sp)
ffffffffc0203a92:	6ae2                	ld	s5,24(sp)
ffffffffc0203a94:	6b42                	ld	s6,16(sp)
ffffffffc0203a96:	6ba2                	ld	s7,8(sp)
    cprintf("check_vmm() succeeded.\n");
ffffffffc0203a98:	00002517          	auipc	a0,0x2
ffffffffc0203a9c:	59050513          	addi	a0,a0,1424 # ffffffffc0206028 <default_pmm_manager+0xe58>
}
ffffffffc0203aa0:	6161                	addi	sp,sp,80
    cprintf("check_vmm() succeeded.\n");
ffffffffc0203aa2:	e18fc06f          	j	ffffffffc02000ba <cprintf>
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc0203aa6:	cdeff0ef          	jal	ra,ffffffffc0202f84 <swap_init_mm>
ffffffffc0203aaa:	b5d1                	j	ffffffffc020396e <vmm_init+0x23a>
        assert(mmap->vm_start == i * 5 && mmap->vm_end == i * 5 + 2);
ffffffffc0203aac:	00002697          	auipc	a3,0x2
ffffffffc0203ab0:	3bc68693          	addi	a3,a3,956 # ffffffffc0205e68 <default_pmm_manager+0xc98>
ffffffffc0203ab4:	00001617          	auipc	a2,0x1
ffffffffc0203ab8:	36c60613          	addi	a2,a2,876 # ffffffffc0204e20 <commands+0x738>
ffffffffc0203abc:	0df00593          	li	a1,223
ffffffffc0203ac0:	00002517          	auipc	a0,0x2
ffffffffc0203ac4:	32050513          	addi	a0,a0,800 # ffffffffc0205de0 <default_pmm_manager+0xc10>
ffffffffc0203ac8:	8adfc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma2->vm_start == i  && vma2->vm_end == i  + 2);
ffffffffc0203acc:	00002697          	auipc	a3,0x2
ffffffffc0203ad0:	45468693          	addi	a3,a3,1108 # ffffffffc0205f20 <default_pmm_manager+0xd50>
ffffffffc0203ad4:	00001617          	auipc	a2,0x1
ffffffffc0203ad8:	34c60613          	addi	a2,a2,844 # ffffffffc0204e20 <commands+0x738>
ffffffffc0203adc:	0f000593          	li	a1,240
ffffffffc0203ae0:	00002517          	auipc	a0,0x2
ffffffffc0203ae4:	30050513          	addi	a0,a0,768 # ffffffffc0205de0 <default_pmm_manager+0xc10>
ffffffffc0203ae8:	88dfc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma1->vm_start == i  && vma1->vm_end == i  + 2);
ffffffffc0203aec:	00002697          	auipc	a3,0x2
ffffffffc0203af0:	40468693          	addi	a3,a3,1028 # ffffffffc0205ef0 <default_pmm_manager+0xd20>
ffffffffc0203af4:	00001617          	auipc	a2,0x1
ffffffffc0203af8:	32c60613          	addi	a2,a2,812 # ffffffffc0204e20 <commands+0x738>
ffffffffc0203afc:	0ef00593          	li	a1,239
ffffffffc0203b00:	00002517          	auipc	a0,0x2
ffffffffc0203b04:	2e050513          	addi	a0,a0,736 # ffffffffc0205de0 <default_pmm_manager+0xc10>
ffffffffc0203b08:	86dfc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(le != &(mm->mmap_list));
ffffffffc0203b0c:	00002697          	auipc	a3,0x2
ffffffffc0203b10:	34468693          	addi	a3,a3,836 # ffffffffc0205e50 <default_pmm_manager+0xc80>
ffffffffc0203b14:	00001617          	auipc	a2,0x1
ffffffffc0203b18:	30c60613          	addi	a2,a2,780 # ffffffffc0204e20 <commands+0x738>
ffffffffc0203b1c:	0dd00593          	li	a1,221
ffffffffc0203b20:	00002517          	auipc	a0,0x2
ffffffffc0203b24:	2c050513          	addi	a0,a0,704 # ffffffffc0205de0 <default_pmm_manager+0xc10>
ffffffffc0203b28:	84dfc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma1 != NULL);
ffffffffc0203b2c:	00002697          	auipc	a3,0x2
ffffffffc0203b30:	37468693          	addi	a3,a3,884 # ffffffffc0205ea0 <default_pmm_manager+0xcd0>
ffffffffc0203b34:	00001617          	auipc	a2,0x1
ffffffffc0203b38:	2ec60613          	addi	a2,a2,748 # ffffffffc0204e20 <commands+0x738>
ffffffffc0203b3c:	0e500593          	li	a1,229
ffffffffc0203b40:	00002517          	auipc	a0,0x2
ffffffffc0203b44:	2a050513          	addi	a0,a0,672 # ffffffffc0205de0 <default_pmm_manager+0xc10>
ffffffffc0203b48:	82dfc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma2 != NULL);
ffffffffc0203b4c:	00002697          	auipc	a3,0x2
ffffffffc0203b50:	36468693          	addi	a3,a3,868 # ffffffffc0205eb0 <default_pmm_manager+0xce0>
ffffffffc0203b54:	00001617          	auipc	a2,0x1
ffffffffc0203b58:	2cc60613          	addi	a2,a2,716 # ffffffffc0204e20 <commands+0x738>
ffffffffc0203b5c:	0e700593          	li	a1,231
ffffffffc0203b60:	00002517          	auipc	a0,0x2
ffffffffc0203b64:	28050513          	addi	a0,a0,640 # ffffffffc0205de0 <default_pmm_manager+0xc10>
ffffffffc0203b68:	80dfc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma3 == NULL);
ffffffffc0203b6c:	00002697          	auipc	a3,0x2
ffffffffc0203b70:	35468693          	addi	a3,a3,852 # ffffffffc0205ec0 <default_pmm_manager+0xcf0>
ffffffffc0203b74:	00001617          	auipc	a2,0x1
ffffffffc0203b78:	2ac60613          	addi	a2,a2,684 # ffffffffc0204e20 <commands+0x738>
ffffffffc0203b7c:	0e900593          	li	a1,233
ffffffffc0203b80:	00002517          	auipc	a0,0x2
ffffffffc0203b84:	26050513          	addi	a0,a0,608 # ffffffffc0205de0 <default_pmm_manager+0xc10>
ffffffffc0203b88:	fecfc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma4 == NULL);
ffffffffc0203b8c:	00002697          	auipc	a3,0x2
ffffffffc0203b90:	34468693          	addi	a3,a3,836 # ffffffffc0205ed0 <default_pmm_manager+0xd00>
ffffffffc0203b94:	00001617          	auipc	a2,0x1
ffffffffc0203b98:	28c60613          	addi	a2,a2,652 # ffffffffc0204e20 <commands+0x738>
ffffffffc0203b9c:	0eb00593          	li	a1,235
ffffffffc0203ba0:	00002517          	auipc	a0,0x2
ffffffffc0203ba4:	24050513          	addi	a0,a0,576 # ffffffffc0205de0 <default_pmm_manager+0xc10>
ffffffffc0203ba8:	fccfc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma5 == NULL);
ffffffffc0203bac:	00002697          	auipc	a3,0x2
ffffffffc0203bb0:	33468693          	addi	a3,a3,820 # ffffffffc0205ee0 <default_pmm_manager+0xd10>
ffffffffc0203bb4:	00001617          	auipc	a2,0x1
ffffffffc0203bb8:	26c60613          	addi	a2,a2,620 # ffffffffc0204e20 <commands+0x738>
ffffffffc0203bbc:	0ed00593          	li	a1,237
ffffffffc0203bc0:	00002517          	auipc	a0,0x2
ffffffffc0203bc4:	22050513          	addi	a0,a0,544 # ffffffffc0205de0 <default_pmm_manager+0xc10>
ffffffffc0203bc8:	facfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgdir[0] == 0);
ffffffffc0203bcc:	00002697          	auipc	a3,0x2
ffffffffc0203bd0:	d2468693          	addi	a3,a3,-732 # ffffffffc02058f0 <default_pmm_manager+0x720>
ffffffffc0203bd4:	00001617          	auipc	a2,0x1
ffffffffc0203bd8:	24c60613          	addi	a2,a2,588 # ffffffffc0204e20 <commands+0x738>
ffffffffc0203bdc:	10f00593          	li	a1,271
ffffffffc0203be0:	00002517          	auipc	a0,0x2
ffffffffc0203be4:	20050513          	addi	a0,a0,512 # ffffffffc0205de0 <default_pmm_manager+0xc10>
ffffffffc0203be8:	f8cfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(check_mm_struct != NULL);
ffffffffc0203bec:	00002697          	auipc	a3,0x2
ffffffffc0203bf0:	45468693          	addi	a3,a3,1108 # ffffffffc0206040 <default_pmm_manager+0xe70>
ffffffffc0203bf4:	00001617          	auipc	a2,0x1
ffffffffc0203bf8:	22c60613          	addi	a2,a2,556 # ffffffffc0204e20 <commands+0x738>
ffffffffc0203bfc:	10c00593          	li	a1,268
ffffffffc0203c00:	00002517          	auipc	a0,0x2
ffffffffc0203c04:	1e050513          	addi	a0,a0,480 # ffffffffc0205de0 <default_pmm_manager+0xc10>
    check_mm_struct = mm_create();
ffffffffc0203c08:	0000e797          	auipc	a5,0xe
ffffffffc0203c0c:	9407b823          	sd	zero,-1712(a5) # ffffffffc0211558 <check_mm_struct>
    assert(check_mm_struct != NULL);
ffffffffc0203c10:	f64fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(vma != NULL);
ffffffffc0203c14:	00002697          	auipc	a3,0x2
ffffffffc0203c18:	cec68693          	addi	a3,a3,-788 # ffffffffc0205900 <default_pmm_manager+0x730>
ffffffffc0203c1c:	00001617          	auipc	a2,0x1
ffffffffc0203c20:	20460613          	addi	a2,a2,516 # ffffffffc0204e20 <commands+0x738>
ffffffffc0203c24:	11300593          	li	a1,275
ffffffffc0203c28:	00002517          	auipc	a0,0x2
ffffffffc0203c2c:	1b850513          	addi	a0,a0,440 # ffffffffc0205de0 <default_pmm_manager+0xc10>
ffffffffc0203c30:	f44fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(find_vma(mm, addr) == vma);
ffffffffc0203c34:	00002697          	auipc	a3,0x2
ffffffffc0203c38:	3a468693          	addi	a3,a3,932 # ffffffffc0205fd8 <default_pmm_manager+0xe08>
ffffffffc0203c3c:	00001617          	auipc	a2,0x1
ffffffffc0203c40:	1e460613          	addi	a2,a2,484 # ffffffffc0204e20 <commands+0x738>
ffffffffc0203c44:	11800593          	li	a1,280
ffffffffc0203c48:	00002517          	auipc	a0,0x2
ffffffffc0203c4c:	19850513          	addi	a0,a0,408 # ffffffffc0205de0 <default_pmm_manager+0xc10>
ffffffffc0203c50:	f24fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(sum == 0);
ffffffffc0203c54:	00002697          	auipc	a3,0x2
ffffffffc0203c58:	3a468693          	addi	a3,a3,932 # ffffffffc0205ff8 <default_pmm_manager+0xe28>
ffffffffc0203c5c:	00001617          	auipc	a2,0x1
ffffffffc0203c60:	1c460613          	addi	a2,a2,452 # ffffffffc0204e20 <commands+0x738>
ffffffffc0203c64:	12200593          	li	a1,290
ffffffffc0203c68:	00002517          	auipc	a0,0x2
ffffffffc0203c6c:	17850513          	addi	a0,a0,376 # ffffffffc0205de0 <default_pmm_manager+0xc10>
ffffffffc0203c70:	f04fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0203c74:	00001617          	auipc	a2,0x1
ffffffffc0203c78:	59460613          	addi	a2,a2,1428 # ffffffffc0205208 <default_pmm_manager+0x38>
ffffffffc0203c7c:	06500593          	li	a1,101
ffffffffc0203c80:	00001517          	auipc	a0,0x1
ffffffffc0203c84:	5a850513          	addi	a0,a0,1448 # ffffffffc0205228 <default_pmm_manager+0x58>
ffffffffc0203c88:	eecfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203c8c:	00002697          	auipc	a3,0x2
ffffffffc0203c90:	30468693          	addi	a3,a3,772 # ffffffffc0205f90 <default_pmm_manager+0xdc0>
ffffffffc0203c94:	00001617          	auipc	a2,0x1
ffffffffc0203c98:	18c60613          	addi	a2,a2,396 # ffffffffc0204e20 <commands+0x738>
ffffffffc0203c9c:	13000593          	li	a1,304
ffffffffc0203ca0:	00002517          	auipc	a0,0x2
ffffffffc0203ca4:	14050513          	addi	a0,a0,320 # ffffffffc0205de0 <default_pmm_manager+0xc10>
ffffffffc0203ca8:	eccfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203cac:	00002697          	auipc	a3,0x2
ffffffffc0203cb0:	2e468693          	addi	a3,a3,740 # ffffffffc0205f90 <default_pmm_manager+0xdc0>
ffffffffc0203cb4:	00001617          	auipc	a2,0x1
ffffffffc0203cb8:	16c60613          	addi	a2,a2,364 # ffffffffc0204e20 <commands+0x738>
ffffffffc0203cbc:	0bf00593          	li	a1,191
ffffffffc0203cc0:	00002517          	auipc	a0,0x2
ffffffffc0203cc4:	12050513          	addi	a0,a0,288 # ffffffffc0205de0 <default_pmm_manager+0xc10>
ffffffffc0203cc8:	eacfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(mm != NULL);
ffffffffc0203ccc:	00002697          	auipc	a3,0x2
ffffffffc0203cd0:	bfc68693          	addi	a3,a3,-1028 # ffffffffc02058c8 <default_pmm_manager+0x6f8>
ffffffffc0203cd4:	00001617          	auipc	a2,0x1
ffffffffc0203cd8:	14c60613          	addi	a2,a2,332 # ffffffffc0204e20 <commands+0x738>
ffffffffc0203cdc:	0c900593          	li	a1,201
ffffffffc0203ce0:	00002517          	auipc	a0,0x2
ffffffffc0203ce4:	10050513          	addi	a0,a0,256 # ffffffffc0205de0 <default_pmm_manager+0xc10>
ffffffffc0203ce8:	e8cfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203cec:	00002697          	auipc	a3,0x2
ffffffffc0203cf0:	2a468693          	addi	a3,a3,676 # ffffffffc0205f90 <default_pmm_manager+0xdc0>
ffffffffc0203cf4:	00001617          	auipc	a2,0x1
ffffffffc0203cf8:	12c60613          	addi	a2,a2,300 # ffffffffc0204e20 <commands+0x738>
ffffffffc0203cfc:	0fd00593          	li	a1,253
ffffffffc0203d00:	00002517          	auipc	a0,0x2
ffffffffc0203d04:	0e050513          	addi	a0,a0,224 # ffffffffc0205de0 <default_pmm_manager+0xc10>
...
ffffffffc0203d0e:	85b2                	mv	a1,a2
do_pgfault(struct mm_struct *mm, uint_t error_code, uintptr_t addr) {
...
ffffffffc0203d18:	8432                	mv	s0,a2
ffffffffc0203d1a:	84aa                	mv	s1,a0
    struct vma_struct *vma = find_vma(mm, addr);
ffffffffc0203d1c:	8d3ff0ef          	jal	ra,ffffffffc02035ee <find_vma>

    pgfault_num++;
ffffffffc0203d20:	0000e797          	auipc	a5,0xe
ffffffffc0203d24:	8407a783          	lw	a5,-1984(a5) # ffffffffc0211560 <pgfault_num>
ffffffffc0203d28:	2785                	addiw	a5,a5,1
ffffffffc0203d2a:	0000e717          	auipc	a4,0xe
ffffffffc0203d2e:	82f72b23          	sw	a5,-1994(a4) # ffffffffc0211560 <pgfault_num>
    //If the addr is in the range of a mm's vma?
    //未找到vma或vma越界，打印错误信息，goto failed
    if (vma == NULL || vma->vm_start > addr) {
ffffffffc0203d32:	c159                	beqz	a0,ffffffffc0203db8 <do_pgfault+0xac>
ffffffffc0203d34:	651c                	ld	a5,8(a0)
ffffffffc0203d36:	08f46163          	bltu	s0,a5,ffffffffc0203db8 <do_pgfault+0xac>
     * THEN
     *    continue process
     */
    //设置权限位
...
ffffffffc0203d3a:	6d1c                	ld	a5,24(a0)
    uint32_t perm = PTE_U;
ffffffffc0203d3c:	4941                	li	s2,16
    if (vma->vm_flags & VM_WRITE) {
ffffffffc0203d3e:	8b89                	andi	a5,a5,2
ffffffffc0203d40:	ebb1                	bnez	a5,ffffffffc0203d94 <do_pgfault+0x88>
        perm |= (PTE_R | PTE_W);
    }

    //地址向下对齐
    addr = ROUNDDOWN(addr, PGSIZE);
ffffffffc0203d42:	75fd                	lui	a1,0xfffff
...
ffffffffc0203d44:	6c88                	ld	a0,24(s1)
    addr = ROUNDDOWN(addr, PGSIZE);
ffffffffc0203d46:	8c6d                	and	s0,s0,a1
    ptep = get_pte(mm->pgdir, addr, 1);  //(1) try to find a pte, if pte's
ffffffffc0203d48:	85a2                	mv	a1,s0
ffffffffc0203d4a:	4605                	li	a2,1
ffffffffc0203d4c:	981fd0ef          	jal	ra,ffffffffc02016cc <get_pte>
                                         //PT(Page Table) isn't existed, then
                                         //create a PT.
    if (*ptep == 0) {
ffffffffc0203d50:	610c                	ld	a1,0(a0)
ffffffffc0203d52:	c1b9                	beqz	a1,ffffffffc0203d98 <do_pgfault+0x8c>
...
ffffffffc0203d58:	7fc7a783          	lw	a5,2044(a5) # ffffffffc0211550 <swap_init_ok>
ffffffffc0203d5c:	c7bd                	beqz	a5,ffffffffc0203dca <do_pgfault+0xbe>
...
ffffffffc0203d60:	0030                	addi	a2,sp,8
ffffffffc0203d62:	8526                	mv	a0,s1
            struct Page *page = NULL;
ffffffffc0203d64:	e402                	sd	zero,8(sp)
            swap_in(mm, addr, &page);
ffffffffc0203d66:	b4aff0ef          	jal	ra,ffffffffc02030b0 <swap_in>
            //page_insert(pde_t *pgdir, struct Page *page, uintptr_t la, uint32_t perm)
            //page对应物理页面，la是虚拟地址
            page_insert(mm->pgdir, page, addr, perm);
ffffffffc0203d6a:	65a2                	ld	a1,8(sp)
ffffffffc0203d6c:	6c88                	ld	a0,24(s1)
ffffffffc0203d6e:	86ca                	mv	a3,s2
ffffffffc0203d70:	8622                	mv	a2,s0
ffffffffc0203d72:	c45fd0ef          	jal	ra,ffffffffc02019b6 <page_insert>
            swap_map_swappable(mm, addr, page, 1);
ffffffffc0203d76:	6622                	ld	a2,8(sp)
ffffffffc0203d78:	4685                	li	a3,1
ffffffffc0203d7a:	85a2                	mv	a1,s0
ffffffffc0203d7c:	8526                	mv	a0,s1
ffffffffc0203d7e:	a12ff0ef          	jal	ra,ffffffffc0202f90 <swap_map_swappable>

            page->pra_vaddr = addr;
ffffffffc0203d82:	67a2                	ld	a5,8(sp)
...
ffffffffc0203d84:	4501                	li	a0,0
            page->pra_vaddr = addr;
ffffffffc0203d86:	e3a0                	sd	s0,64(a5)
failed:
    return ret;
}
ffffffffc0203d88:	70a2                	ld	ra,40(sp)
ffffffffc0203d8a:	7402                	ld	s0,32(sp)
ffffffffc0203d8c:	64e2                	ld	s1,24(sp)
ffffffffc0203d8e:	6942                	ld	s2,16(sp)
ffffffffc0203d90:	6145                	addi	sp,sp,48
ffffffffc0203d92:	8082                	ret
        perm |= (PTE_R | PTE_W);
ffffffffc0203d94:	4959                	li	s2,22
ffffffffc0203d96:	b775                	j	ffffffffc0203d42 <do_pgfault+0x36>
        if (pgdir_alloc_page(mm->pgdir, addr, perm) == NULL) {
ffffffffc0203d98:	6c88                	ld	a0,24(s1)
ffffffffc0203d9a:	864a                	mv	a2,s2
ffffffffc0203d9c:	85a2                	mv	a1,s0
ffffffffc0203d9e:	923fe0ef          	jal	ra,ffffffffc02026c0 <pgdir_alloc_page>
ffffffffc0203da2:	87aa                	mv	a5,a0
   ret = 0;
ffffffffc0203da4:	4501                	li	a0,0
        if (pgdir_alloc_page(mm->pgdir, addr, perm) == NULL) {
ffffffffc0203da6:	f3ed                	bnez	a5,ffffffffc0203d88 <do_pgfault+0x7c>
            cprintf("pgdir_alloc_page in do_pgfault failed\n");
ffffffffc0203da8:	00002517          	auipc	a0,0x2
ffffffffc0203dac:	2e050513          	addi	a0,a0,736 # ffffffffc0206088 <default_pmm_manager+0xeb8>
ffffffffc0203db0:	b0afc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    ret = -E_NO_MEM;
ffffffffc0203db4:	5571                	li	a0,-4
            goto failed;
ffffffffc0203db6:	bfc9                	j	ffffffffc0203d88 <do_pgfault+0x7c>
        cprintf("not valid addr %x, and  can not find it in vma\n", addr);
ffffffffc0203db8:	85a2                	mv	a1,s0
ffffffffc0203dba:	00002517          	auipc	a0,0x2
ffffffffc0203dbe:	29e50513          	addi	a0,a0,670 # ffffffffc0206058 <default_pmm_manager+0xe88>
ffffffffc0203dc2:	af8fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    int ret = -E_INVAL;
ffffffffc0203dc6:	5575                	li	a0,-3
        goto failed;
ffffffffc0203dc8:	b7c1                	j	ffffffffc0203d88 <do_pgfault+0x7c>
            cprintf("no swap_init_ok but ptep is %x, failed\n", *ptep);
ffffffffc0203dca:	00002517          	auipc	a0,0x2
ffffffffc0203dce:	2e650513          	addi	a0,a0,742 # ffffffffc02060b0 <default_pmm_manager+0xee0>
ffffffffc0203dd2:	ae8fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    ret = -E_NO_MEM;
ffffffffc0203dd6:	5571                	li	a0,-4
            goto failed;
ffffffffc0203dd8:	bf45                	j	ffffffffc0203d88 <do_pgfault+0x7c>

ffffffffc0203dda <swapfs_init>:
#include <ide.h>
#include <pmm.h>
#include <assert.h>
...
swapfs_init(void) { //��ʼ��
ffffffffc0203dde:	e406                	sd	ra,8(sp)
    if (!ide_device_valid(SWAP_DEV_NO)) {   //SWAP_DEV_NO��Ч
ffffffffc0203de0:	eb4fc0ef          	jal	ra,ffffffffc0200494 <ide_device_valid>
ffffffffc0203de4:	cd01                	beqz	a0,ffffffffc0203dfc <swapfs_init+0x22>
        panic("swap fs isn't available.\n");
    }
    //PGSIZE / SECTSIZE = ÿ��ҳ����Ҫ��������
    max_swap_offset = ide_device_size(SWAP_DEV_NO) / (PGSIZE / SECTSIZE);
ffffffffc0203de6:	4505                	li	a0,1
ffffffffc0203de8:	eb2fc0ef          	jal	ra,ffffffffc020049a <ide_device_size>
}
ffffffffc0203dec:	60a2                	ld	ra,8(sp)
    max_swap_offset = ide_device_size(SWAP_DEV_NO) / (PGSIZE / SECTSIZE);
ffffffffc0203dee:	810d                	srli	a0,a0,0x3
ffffffffc0203df0:	0000d797          	auipc	a5,0xd
ffffffffc0203df4:	74a7b823          	sd	a0,1872(a5) # ffffffffc0211540 <max_swap_offset>
}
ffffffffc0203df8:	0141                	addi	sp,sp,16
ffffffffc0203dfa:	8082                	ret
        panic("swap fs isn't available.\n");
ffffffffc0203dfc:	00002617          	auipc	a2,0x2
ffffffffc0203e00:	2dc60613          	addi	a2,a2,732 # ffffffffc02060d8 <default_pmm_manager+0xf08>
ffffffffc0203e04:	45b5                	li	a1,13
ffffffffc0203e06:	00002517          	auipc	a0,0x2
ffffffffc0203e0a:	2f250513          	addi	a0,a0,754 # ffffffffc02060f8 <default_pmm_manager+0xf28>
ffffffffc0203e0e:	d66fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203e12 <swapfs_read>:

int
swapfs_read(swap_entry_t entry, struct Page *page) {
ffffffffc0203e12:	1141                	addi	sp,sp,-16
ffffffffc0203e14:	e406                	sd	ra,8(sp)
    //��
    return ide_read_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0203e16:	00855793          	srli	a5,a0,0x8
ffffffffc0203e1a:	c3a5                	beqz	a5,ffffffffc0203e7a <swapfs_read+0x68>
ffffffffc0203e1c:	0000d717          	auipc	a4,0xd
ffffffffc0203e20:	72473703          	ld	a4,1828(a4) # ffffffffc0211540 <max_swap_offset>
ffffffffc0203e24:	04e7fb63          	bgeu	a5,a4,ffffffffc0203e7a <swapfs_read+0x68>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
ffffffffc0203e28:	0000d617          	auipc	a2,0xd
ffffffffc0203e2c:	70063603          	ld	a2,1792(a2) # ffffffffc0211528 <pages>
ffffffffc0203e30:	8d91                	sub	a1,a1,a2
ffffffffc0203e32:	4035d613          	srai	a2,a1,0x3
ffffffffc0203e36:	00002597          	auipc	a1,0x2
ffffffffc0203e3a:	5425b583          	ld	a1,1346(a1) # ffffffffc0206378 <error_string+0x38>
ffffffffc0203e3e:	02b60633          	mul	a2,a2,a1
ffffffffc0203e42:	0037959b          	slliw	a1,a5,0x3
ffffffffc0203e46:	00002797          	auipc	a5,0x2
ffffffffc0203e4a:	53a7b783          	ld	a5,1338(a5) # ffffffffc0206380 <nbase>
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203e4e:	0000d717          	auipc	a4,0xd
ffffffffc0203e52:	6d273703          	ld	a4,1746(a4) # ffffffffc0211520 <npage>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
ffffffffc0203e56:	963e                	add	a2,a2,a5
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203e58:	00c61793          	slli	a5,a2,0xc
ffffffffc0203e5c:	83b1                	srli	a5,a5,0xc
    return page2ppn(page) << PGSHIFT;
ffffffffc0203e5e:	0632                	slli	a2,a2,0xc
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203e60:	02e7f963          	bgeu	a5,a4,ffffffffc0203e92 <swapfs_read+0x80>
}
ffffffffc0203e64:	60a2                	ld	ra,8(sp)
    return ide_read_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0203e66:	0000d797          	auipc	a5,0xd
ffffffffc0203e6a:	6d27b783          	ld	a5,1746(a5) # ffffffffc0211538 <va_pa_offset>
ffffffffc0203e6e:	46a1                	li	a3,8
ffffffffc0203e70:	963e                	add	a2,a2,a5
ffffffffc0203e72:	4505                	li	a0,1
}
ffffffffc0203e74:	0141                	addi	sp,sp,16
    return ide_read_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0203e76:	e2afc06f          	j	ffffffffc02004a0 <ide_read_secs>
ffffffffc0203e7a:	86aa                	mv	a3,a0
ffffffffc0203e7c:	00002617          	auipc	a2,0x2
ffffffffc0203e80:	29460613          	addi	a2,a2,660 # ffffffffc0206110 <default_pmm_manager+0xf40>
ffffffffc0203e84:	45d9                	li	a1,22
ffffffffc0203e86:	00002517          	auipc	a0,0x2
ffffffffc0203e8a:	27250513          	addi	a0,a0,626 # ffffffffc02060f8 <default_pmm_manager+0xf28>
ffffffffc0203e8e:	ce6fc0ef          	jal	ra,ffffffffc0200374 <__panic>
ffffffffc0203e92:	86b2                	mv	a3,a2
ffffffffc0203e94:	06a00593          	li	a1,106
ffffffffc0203e98:	00001617          	auipc	a2,0x1
ffffffffc0203e9c:	3c860613          	addi	a2,a2,968 # ffffffffc0205260 <default_pmm_manager+0x90>
ffffffffc0203ea0:	00001517          	auipc	a0,0x1
ffffffffc0203ea4:	38850513          	addi	a0,a0,904 # ffffffffc0205228 <default_pmm_manager+0x58>
ffffffffc0203ea8:	cccfc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203eac <swapfs_write>:
...
ffffffffc0203eb0:	00855793          	srli	a5,a0,0x8
ffffffffc0203eb4:	c3a5                	beqz	a5,ffffffffc0203f14 <swapfs_write+0x68>
ffffffffc0203eb6:	0000d717          	auipc	a4,0xd
ffffffffc0203eba:	68a73703          	ld	a4,1674(a4) # ffffffffc0211540 <max_swap_offset>
ffffffffc0203ebe:	04e7fb63          	bgeu	a5,a4,ffffffffc0203f14 <swapfs_write+0x68>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
ffffffffc0203ec2:	0000d617          	auipc	a2,0xd
ffffffffc0203ec6:	66663603          	ld	a2,1638(a2) # ffffffffc0211528 <pages>
ffffffffc0203eca:	8d91                	sub	a1,a1,a2
ffffffffc0203ecc:	4035d613          	srai	a2,a1,0x3
ffffffffc0203ed0:	00002597          	auipc	a1,0x2
ffffffffc0203ed4:	4a85b583          	ld	a1,1192(a1) # ffffffffc0206378 <error_string+0x38>
ffffffffc0203ed8:	02b60633          	mul	a2,a2,a1
ffffffffc0203edc:	0037959b          	slliw	a1,a5,0x3
ffffffffc0203ee0:	00002797          	auipc	a5,0x2
ffffffffc0203ee4:	4a07b783          	ld	a5,1184(a5) # ffffffffc0206380 <nbase>
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203ee8:	0000d717          	auipc	a4,0xd
ffffffffc0203eec:	63873703          	ld	a4,1592(a4) # ffffffffc0211520 <npage>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
ffffffffc0203ef0:	963e                	add	a2,a2,a5
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203ef2:	00c61793          	slli	a5,a2,0xc
ffffffffc0203ef6:	83b1                	srli	a5,a5,0xc
    return page2ppn(page) << PGSHIFT;
ffffffffc0203ef8:	0632                	slli	a2,a2,0xc
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203efa:	02e7f963          	bgeu	a5,a4,ffffffffc0203f2c <swapfs_write+0x80>
}
ffffffffc0203efe:	60a2                	ld	ra,8(sp)
    return ide_write_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0203f00:	0000d797          	auipc	a5,0xd
ffffffffc0203f04:	6387b783          	ld	a5,1592(a5) # ffffffffc0211538 <va_pa_offset>
ffffffffc0203f08:	46a1                	li	a3,8
ffffffffc0203f0a:	963e                	add	a2,a2,a5
ffffffffc0203f0c:	4505                	li	a0,1
}
ffffffffc0203f0e:	0141                	addi	sp,sp,16
    return ide_write_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0203f10:	db4fc06f          	j	ffffffffc02004c4 <ide_write_secs>
ffffffffc0203f14:	86aa                	mv	a3,a0
ffffffffc0203f16:	00002617          	auipc	a2,0x2
ffffffffc0203f1a:	1fa60613          	addi	a2,a2,506 # ffffffffc0206110 <default_pmm_manager+0xf40>
ffffffffc0203f1e:	45f1                	li	a1,28
ffffffffc0203f20:	00002517          	auipc	a0,0x2
ffffffffc0203f24:	1d850513          	addi	a0,a0,472 # ffffffffc02060f8 <default_pmm_manager+0xf28>
ffffffffc0203f28:	c4cfc0ef          	jal	ra,ffffffffc0200374 <__panic>
ffffffffc0203f2c:	86b2                	mv	a3,a2
ffffffffc0203f2e:	06a00593          	li	a1,106
ffffffffc0203f32:	00001617          	auipc	a2,0x1
ffffffffc0203f36:	32e60613          	addi	a2,a2,814 # ffffffffc0205260 <default_pmm_manager+0x90>
ffffffffc0203f3a:	00001517          	auipc	a0,0x1
ffffffffc0203f3e:	2ee50513          	addi	a0,a0,750 # ffffffffc0205228 <default_pmm_manager+0x58>
ffffffffc0203f42:	c32fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203f46 <printnum>:
 * */
static void
...
ffffffffc0203f46:	02069813          	slli	a6,a3,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0203f4a:	7179                	addi	sp,sp,-48
    unsigned mod = do_div(result, base);
ffffffffc0203f4c:	02085813          	srli	a6,a6,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0203f50:	e052                	sd	s4,0(sp)
    unsigned mod = do_div(result, base);
ffffffffc0203f52:	03067a33          	remu	s4,a2,a6
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0203f56:	f022                	sd	s0,32(sp)
ffffffffc0203f58:	ec26                	sd	s1,24(sp)
ffffffffc0203f5a:	e84a                	sd	s2,16(sp)
ffffffffc0203f5c:	f406                	sd	ra,40(sp)
ffffffffc0203f5e:	e44e                	sd	s3,8(sp)
ffffffffc0203f60:	84aa                	mv	s1,a0
ffffffffc0203f62:	892e                	mv	s2,a1
    ...
    if (num >= base) {
        ...
        while (-- width > 0)
ffffffffc0203f64:	fff7041b          	addiw	s0,a4,-1
    unsigned mod = do_div(result, base);
ffffffffc0203f68:	2a01                	sext.w	s4,s4
    if (num >= base) {
ffffffffc0203f6a:	03067e63          	bgeu	a2,a6,ffffffffc0203fa6 <printnum+0x60>
ffffffffc0203f6e:	89be                	mv	s3,a5
        while (-- width > 0)
ffffffffc0203f70:	00805763          	blez	s0,ffffffffc0203f7e <printnum+0x38>
ffffffffc0203f74:	347d                	addiw	s0,s0,-1
            putch(padc, putdat);
ffffffffc0203f76:	85ca                	mv	a1,s2
ffffffffc0203f78:	854e                	mv	a0,s3
ffffffffc0203f7a:	9482                	jalr	s1
        while (-- width > 0)
ffffffffc0203f7c:	fc65                	bnez	s0,ffffffffc0203f74 <printnum+0x2e>
    }
    // then print this (the least significant) digit
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203f7e:	1a02                	slli	s4,s4,0x20
ffffffffc0203f80:	00002797          	auipc	a5,0x2
ffffffffc0203f84:	1b078793          	addi	a5,a5,432 # ffffffffc0206130 <default_pmm_manager+0xf60>
ffffffffc0203f88:	020a5a13          	srli	s4,s4,0x20
ffffffffc0203f8c:	9a3e                	add	s4,s4,a5
}
ffffffffc0203f8e:	7402                	ld	s0,32(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203f90:	000a4503          	lbu	a0,0(s4)
}
ffffffffc0203f94:	70a2                	ld	ra,40(sp)
ffffffffc0203f96:	69a2                	ld	s3,8(sp)
ffffffffc0203f98:	6a02                	ld	s4,0(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203f9a:	85ca                	mv	a1,s2
ffffffffc0203f9c:	87a6                	mv	a5,s1
}
ffffffffc0203f9e:	6942                	ld	s2,16(sp)
ffffffffc0203fa0:	64e2                	ld	s1,24(sp)
ffffffffc0203fa2:	6145                	addi	sp,sp,48
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203fa4:	8782                	jr	a5
        printnum(putch, putdat, result, base, width - 1, padc);
ffffffffc0203fa6:	03065633          	divu	a2,a2,a6
ffffffffc0203faa:	8722                	mv	a4,s0
ffffffffc0203fac:	f9bff0ef          	jal	ra,ffffffffc0203f46 <printnum>
ffffffffc0203fb0:	b7f9                	j	ffffffffc0203f7e <printnum+0x38>

ffffffffc0203fb2 <vprintfmt>:
 *
 * Call this function if you are already dealing with a va_list.
...
ffffffffc0203fb2:	7119                	addi	sp,sp,-128
ffffffffc0203fb4:	f4a6                	sd	s1,104(sp)
ffffffffc0203fb6:	f0ca                	sd	s2,96(sp)
ffffffffc0203fb8:	ecce                	sd	s3,88(sp)
ffffffffc0203fba:	e8d2                	sd	s4,80(sp)
ffffffffc0203fbc:	e4d6                	sd	s5,72(sp)
ffffffffc0203fbe:	e0da                	sd	s6,64(sp)
ffffffffc0203fc0:	fc5e                	sd	s7,56(sp)
ffffffffc0203fc2:	f06a                	sd	s10,32(sp)
ffffffffc0203fc4:	fc86                	sd	ra,120(sp)
ffffffffc0203fc6:	f8a2                	sd	s0,112(sp)
ffffffffc0203fc8:	f862                	sd	s8,48(sp)
ffffffffc0203fca:	f466                	sd	s9,40(sp)
ffffffffc0203fcc:	ec6e                	sd	s11,24(sp)
ffffffffc0203fce:	892a                	mv	s2,a0
ffffffffc0203fd0:	84ae                	mv	s1,a1
ffffffffc0203fd2:	8d32                	mv	s10,a2
ffffffffc0203fd4:	8a36                	mv	s4,a3
    register int ch, err;
...
ffffffffc0203fd6:	02500993          	li	s3,37
            putch(ch, putdat);
        }
        ...
        char padc = ' ';
        width = precision = -1;
ffffffffc0203fda:	5b7d                	li	s6,-1
ffffffffc0203fdc:	00002a97          	auipc	s5,0x2
ffffffffc0203fe0:	188a8a93          	addi	s5,s5,392 # ffffffffc0206164 <default_pmm_manager+0xf94>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
...
ffffffffc0203fe4:	00002b97          	auipc	s7,0x2
ffffffffc0203fe8:	35cb8b93          	addi	s7,s7,860 # ffffffffc0206340 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0203fec:	000d4503          	lbu	a0,0(s10) # 80000 <kern_entry-0xffffffffc0180000>
ffffffffc0203ff0:	001d0413          	addi	s0,s10,1
ffffffffc0203ff4:	01350a63          	beq	a0,s3,ffffffffc0204008 <vprintfmt+0x56>
            if (ch == '\0') {
ffffffffc0203ff8:	c121                	beqz	a0,ffffffffc0204038 <vprintfmt+0x86>
            putch(ch, putdat);
...
ffffffffc0204004:	ff351ae3          	bne	a0,s3,ffffffffc0203ff8 <vprintfmt+0x46>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204008:	00044603          	lbu	a2,0(s0)
        char padc = ' ';
ffffffffc020400c:	02000793          	li	a5,32
        lflag = altflag = 0;
ffffffffc0204010:	4c81                	li	s9,0
ffffffffc0204012:	4881                	li	a7,0
        width = precision = -1;
ffffffffc0204014:	5c7d                	li	s8,-1
ffffffffc0204016:	5dfd                	li	s11,-1
ffffffffc0204018:	05500513          	li	a0,85
                if (ch < '0' || ch > '9') {
ffffffffc020401c:	4825                	li	a6,9
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc020401e:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0204022:	0ff5f593          	zext.b	a1,a1
ffffffffc0204026:	00140d13          	addi	s10,s0,1
ffffffffc020402a:	04b56263          	bltu	a0,a1,ffffffffc020406e <vprintfmt+0xbc>
ffffffffc020402e:	058a                	slli	a1,a1,0x2
ffffffffc0204030:	95d6                	add	a1,a1,s5
ffffffffc0204032:	4194                	lw	a3,0(a1)
ffffffffc0204034:	96d6                	add	a3,a3,s5
...
ffffffffc0204054:	8082                	ret
            padc = '0';
ffffffffc0204056:	87b2                	mv	a5,a2
            goto reswitch;
ffffffffc0204058:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc020405c:	846a                	mv	s0,s10
ffffffffc020405e:	00140d13          	addi	s10,s0,1
ffffffffc0204062:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0204066:	0ff5f593          	zext.b	a1,a1
ffffffffc020406a:	fcb572e3          	bgeu	a0,a1,ffffffffc020402e <vprintfmt+0x7c>
            putch('%', putdat);
ffffffffc020406e:	85a6                	mv	a1,s1
ffffffffc0204070:	02500513          	li	a0,37
ffffffffc0204074:	9902                	jalr	s2
            for (fmt --; fmt[-1] != '%'; fmt --)
ffffffffc0204076:	fff44783          	lbu	a5,-1(s0)
ffffffffc020407a:	8d22                	mv	s10,s0
ffffffffc020407c:	f73788e3          	beq	a5,s3,ffffffffc0203fec <vprintfmt+0x3a>
ffffffffc0204080:	ffed4783          	lbu	a5,-2(s10)
ffffffffc0204084:	1d7d                	addi	s10,s10,-1
ffffffffc0204086:	ff379de3          	bne	a5,s3,ffffffffc0204080 <vprintfmt+0xce>
ffffffffc020408a:	b78d                	j	ffffffffc0203fec <vprintfmt+0x3a>
                precision = precision * 10 + ch - '0';
ffffffffc020408c:	fd060c1b          	addiw	s8,a2,-48
                ch = *fmt;
...
ffffffffc020409a:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc020409e:	02d86463          	bltu	a6,a3,ffffffffc02040c6 <vprintfmt+0x114>
                ch = *fmt;
ffffffffc02040a2:	00144603          	lbu	a2,1(s0)
                precision = precision * 10 + ch - '0';
ffffffffc02040a6:	002c169b          	slliw	a3,s8,0x2
ffffffffc02040aa:	0186873b          	addw	a4,a3,s8
ffffffffc02040ae:	0017171b          	slliw	a4,a4,0x1
ffffffffc02040b2:	9f2d                	addw	a4,a4,a1
                if (ch < '0' || ch > '9') {
ffffffffc02040b4:	fd06069b          	addiw	a3,a2,-48
            for (precision = 0; ; ++ fmt) {
ffffffffc02040b8:	0405                	addi	s0,s0,1
                precision = precision * 10 + ch - '0';
ffffffffc02040ba:	fd070c1b          	addiw	s8,a4,-48
                ch = *fmt;
ffffffffc02040be:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc02040c2:	fed870e3          	bgeu	a6,a3,ffffffffc02040a2 <vprintfmt+0xf0>
            if (width < 0)
ffffffffc02040c6:	f40ddce3          	bgez	s11,ffffffffc020401e <vprintfmt+0x6c>
                width = precision, precision = -1;
ffffffffc02040ca:	8de2                	mv	s11,s8
ffffffffc02040cc:	5c7d                	li	s8,-1
ffffffffc02040ce:	bf81                	j	ffffffffc020401e <vprintfmt+0x6c>
            if (width < 0)
ffffffffc02040d0:	fffdc693          	not	a3,s11
ffffffffc02040d4:	96fd                	srai	a3,a3,0x3f
ffffffffc02040d6:	00ddfdb3          	and	s11,s11,a3
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02040da:	00144603          	lbu	a2,1(s0)
ffffffffc02040de:	2d81                	sext.w	s11,s11
ffffffffc02040e0:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc02040e2:	bf35                	j	ffffffffc020401e <vprintfmt+0x6c>
            precision = va_arg(ap, int);
ffffffffc02040e4:	000a2c03          	lw	s8,0(s4)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02040e8:	00144603          	lbu	a2,1(s0)
            precision = va_arg(ap, int);
ffffffffc02040ec:	0a21                	addi	s4,s4,8
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02040ee:	846a                	mv	s0,s10
            goto process_precision;
ffffffffc02040f0:	bfd9                	j	ffffffffc02040c6 <vprintfmt+0x114>
    if (lflag >= 2) {
ffffffffc02040f2:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc02040f4:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc02040f8:	01174463          	blt	a4,a7,ffffffffc0204100 <vprintfmt+0x14e>
    else if (lflag) {
ffffffffc02040fc:	1a088e63          	beqz	a7,ffffffffc02042b8 <vprintfmt+0x306>
        return va_arg(*ap, unsigned long);
ffffffffc0204100:	000a3603          	ld	a2,0(s4)
ffffffffc0204104:	46c1                	li	a3,16
ffffffffc0204106:	8a2e                	mv	s4,a1
            printnum(putch, putdat, num, base, width, padc);
ffffffffc0204108:	2781                	sext.w	a5,a5
ffffffffc020410a:	876e                	mv	a4,s11
ffffffffc020410c:	85a6                	mv	a1,s1
ffffffffc020410e:	854a                	mv	a0,s2
ffffffffc0204110:	e37ff0ef          	jal	ra,ffffffffc0203f46 <printnum>
            break;
ffffffffc0204114:	bde1                	j	ffffffffc0203fec <vprintfmt+0x3a>
            putch(va_arg(ap, int), putdat);
ffffffffc0204116:	000a2503          	lw	a0,0(s4)
ffffffffc020411a:	85a6                	mv	a1,s1
ffffffffc020411c:	0a21                	addi	s4,s4,8
ffffffffc020411e:	9902                	jalr	s2
            break;
ffffffffc0204120:	b5f1                	j	ffffffffc0203fec <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0204122:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204124:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204128:	01174463          	blt	a4,a7,ffffffffc0204130 <vprintfmt+0x17e>
    else if (lflag) {
ffffffffc020412c:	18088163          	beqz	a7,ffffffffc02042ae <vprintfmt+0x2fc>
        return va_arg(*ap, unsigned long);
ffffffffc0204130:	000a3603          	ld	a2,0(s4)
ffffffffc0204134:	46a9                	li	a3,10
ffffffffc0204136:	8a2e                	mv	s4,a1
ffffffffc0204138:	bfc1                	j	ffffffffc0204108 <vprintfmt+0x156>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc020413a:	00144603          	lbu	a2,1(s0)
            altflag = 1;
ffffffffc020413e:	4c85                	li	s9,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204140:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204142:	bdf1                	j	ffffffffc020401e <vprintfmt+0x6c>
            putch(ch, putdat);
ffffffffc0204144:	85a6                	mv	a1,s1
ffffffffc0204146:	02500513          	li	a0,37
ffffffffc020414a:	9902                	jalr	s2
            break;
ffffffffc020414c:	b545                	j	ffffffffc0203fec <vprintfmt+0x3a>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc020414e:	00144603          	lbu	a2,1(s0)
            lflag ++;
ffffffffc0204152:	2885                	addiw	a7,a7,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204154:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204156:	b5e1                	j	ffffffffc020401e <vprintfmt+0x6c>
    if (lflag >= 2) {
ffffffffc0204158:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc020415a:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc020415e:	01174463          	blt	a4,a7,ffffffffc0204166 <vprintfmt+0x1b4>
    else if (lflag) {
ffffffffc0204162:	14088163          	beqz	a7,ffffffffc02042a4 <vprintfmt+0x2f2>
        return va_arg(*ap, unsigned long);
ffffffffc0204166:	000a3603          	ld	a2,0(s4)
ffffffffc020416a:	46a1                	li	a3,8
ffffffffc020416c:	8a2e                	mv	s4,a1
ffffffffc020416e:	bf69                	j	ffffffffc0204108 <vprintfmt+0x156>
            putch('0', putdat);
ffffffffc0204170:	03000513          	li	a0,48
ffffffffc0204174:	85a6                	mv	a1,s1
ffffffffc0204176:	e03e                	sd	a5,0(sp)
ffffffffc0204178:	9902                	jalr	s2
            putch('x', putdat);
ffffffffc020417a:	85a6                	mv	a1,s1
ffffffffc020417c:	07800513          	li	a0,120
ffffffffc0204180:	9902                	jalr	s2
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0204182:	0a21                	addi	s4,s4,8
            goto number;
ffffffffc0204184:	6782                	ld	a5,0(sp)
ffffffffc0204186:	46c1                	li	a3,16
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0204188:	ff8a3603          	ld	a2,-8(s4)
            goto number;
ffffffffc020418c:	bfb5                	j	ffffffffc0204108 <vprintfmt+0x156>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc020418e:	000a3403          	ld	s0,0(s4)
ffffffffc0204192:	008a0713          	addi	a4,s4,8
ffffffffc0204196:	e03a                	sd	a4,0(sp)
ffffffffc0204198:	14040263          	beqz	s0,ffffffffc02042dc <vprintfmt+0x32a>
            if (width > 0 && padc != '-') {
ffffffffc020419c:	0fb05763          	blez	s11,ffffffffc020428a <vprintfmt+0x2d8>
ffffffffc02041a0:	02d00693          	li	a3,45
ffffffffc02041a4:	0cd79163          	bne	a5,a3,ffffffffc0204266 <vprintfmt+0x2b4>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc02041a8:	00044783          	lbu	a5,0(s0)
ffffffffc02041ac:	0007851b          	sext.w	a0,a5
ffffffffc02041b0:	cf85                	beqz	a5,ffffffffc02041e8 <vprintfmt+0x236>
ffffffffc02041b2:	00140a13          	addi	s4,s0,1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc02041b6:	05e00413          	li	s0,94
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc02041ba:	000c4563          	bltz	s8,ffffffffc02041c4 <vprintfmt+0x212>
ffffffffc02041be:	3c7d                	addiw	s8,s8,-1
ffffffffc02041c0:	036c0263          	beq	s8,s6,ffffffffc02041e4 <vprintfmt+0x232>
                    putch('?', putdat);
ffffffffc02041c4:	85a6                	mv	a1,s1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc02041c6:	0e0c8e63          	beqz	s9,ffffffffc02042c2 <vprintfmt+0x310>
ffffffffc02041ca:	3781                	addiw	a5,a5,-32
ffffffffc02041cc:	0ef47b63          	bgeu	s0,a5,ffffffffc02042c2 <vprintfmt+0x310>
                    putch('?', putdat);
ffffffffc02041d0:	03f00513          	li	a0,63
ffffffffc02041d4:	9902                	jalr	s2
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc02041d6:	000a4783          	lbu	a5,0(s4)
ffffffffc02041da:	3dfd                	addiw	s11,s11,-1
ffffffffc02041dc:	0a05                	addi	s4,s4,1
ffffffffc02041de:	0007851b          	sext.w	a0,a5
ffffffffc02041e2:	ffe1                	bnez	a5,ffffffffc02041ba <vprintfmt+0x208>
            for (; width > 0; width --) {
ffffffffc02041e4:	01b05963          	blez	s11,ffffffffc02041f6 <vprintfmt+0x244>
ffffffffc02041e8:	3dfd                	addiw	s11,s11,-1
                putch(' ', putdat);
ffffffffc02041ea:	85a6                	mv	a1,s1
ffffffffc02041ec:	02000513          	li	a0,32
ffffffffc02041f0:	9902                	jalr	s2
            for (; width > 0; width --) {
ffffffffc02041f2:	fe0d9be3          	bnez	s11,ffffffffc02041e8 <vprintfmt+0x236>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc02041f6:	6a02                	ld	s4,0(sp)
ffffffffc02041f8:	bbd5                	j	ffffffffc0203fec <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc02041fa:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc02041fc:	008a0c93          	addi	s9,s4,8
    if (lflag >= 2) {
ffffffffc0204200:	01174463          	blt	a4,a7,ffffffffc0204208 <vprintfmt+0x256>
    else if (lflag) {
ffffffffc0204204:	08088d63          	beqz	a7,ffffffffc020429e <vprintfmt+0x2ec>
        return va_arg(*ap, long);
ffffffffc0204208:	000a3403          	ld	s0,0(s4)
            if ((long long)num < 0) {
ffffffffc020420c:	0a044d63          	bltz	s0,ffffffffc02042c6 <vprintfmt+0x314>
            num = getint(&ap, lflag);
ffffffffc0204210:	8622                	mv	a2,s0
ffffffffc0204212:	8a66                	mv	s4,s9
ffffffffc0204214:	46a9                	li	a3,10
ffffffffc0204216:	bdcd                	j	ffffffffc0204108 <vprintfmt+0x156>
            err = va_arg(ap, int);
ffffffffc0204218:	000a2783          	lw	a5,0(s4)
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc020421c:	4719                	li	a4,6
            err = va_arg(ap, int);
ffffffffc020421e:	0a21                	addi	s4,s4,8
            if (err < 0) {
ffffffffc0204220:	41f7d69b          	sraiw	a3,a5,0x1f
ffffffffc0204224:	8fb5                	xor	a5,a5,a3
ffffffffc0204226:	40d786bb          	subw	a3,a5,a3
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc020422a:	02d74163          	blt	a4,a3,ffffffffc020424c <vprintfmt+0x29a>
ffffffffc020422e:	00369793          	slli	a5,a3,0x3
ffffffffc0204232:	97de                	add	a5,a5,s7
ffffffffc0204234:	639c                	ld	a5,0(a5)
ffffffffc0204236:	cb99                	beqz	a5,ffffffffc020424c <vprintfmt+0x29a>
                printfmt(putch, putdat, "%s", p);
ffffffffc0204238:	86be                	mv	a3,a5
ffffffffc020423a:	00002617          	auipc	a2,0x2
ffffffffc020423e:	f2660613          	addi	a2,a2,-218 # ffffffffc0206160 <default_pmm_manager+0xf90>
ffffffffc0204242:	85a6                	mv	a1,s1
ffffffffc0204244:	854a                	mv	a0,s2
ffffffffc0204246:	0ce000ef          	jal	ra,ffffffffc0204314 <printfmt>
ffffffffc020424a:	b34d                	j	ffffffffc0203fec <vprintfmt+0x3a>
                printfmt(putch, putdat, "error %d", err);
ffffffffc020424c:	00002617          	auipc	a2,0x2
ffffffffc0204250:	f0460613          	addi	a2,a2,-252 # ffffffffc0206150 <default_pmm_manager+0xf80>
ffffffffc0204254:	85a6                	mv	a1,s1
ffffffffc0204256:	854a                	mv	a0,s2
ffffffffc0204258:	0bc000ef          	jal	ra,ffffffffc0204314 <printfmt>
ffffffffc020425c:	bb41                	j	ffffffffc0203fec <vprintfmt+0x3a>
                p = "(null)";
ffffffffc020425e:	00002417          	auipc	s0,0x2
ffffffffc0204262:	eea40413          	addi	s0,s0,-278 # ffffffffc0206148 <default_pmm_manager+0xf78>
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204266:	85e2                	mv	a1,s8
ffffffffc0204268:	8522                	mv	a0,s0
ffffffffc020426a:	e43e                	sd	a5,8(sp)
ffffffffc020426c:	196000ef          	jal	ra,ffffffffc0204402 <strnlen>
ffffffffc0204270:	40ad8dbb          	subw	s11,s11,a0
ffffffffc0204274:	01b05b63          	blez	s11,ffffffffc020428a <vprintfmt+0x2d8>
                    putch(padc, putdat);
ffffffffc0204278:	67a2                	ld	a5,8(sp)
ffffffffc020427a:	00078a1b          	sext.w	s4,a5
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc020427e:	3dfd                	addiw	s11,s11,-1
                    putch(padc, putdat);
ffffffffc0204280:	85a6                	mv	a1,s1
ffffffffc0204282:	8552                	mv	a0,s4
ffffffffc0204284:	9902                	jalr	s2
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204286:	fe0d9ce3          	bnez	s11,ffffffffc020427e <vprintfmt+0x2cc>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc020428a:	00044783          	lbu	a5,0(s0)
ffffffffc020428e:	00140a13          	addi	s4,s0,1
ffffffffc0204292:	0007851b          	sext.w	a0,a5
ffffffffc0204296:	d3a5                	beqz	a5,ffffffffc02041f6 <vprintfmt+0x244>
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204298:	05e00413          	li	s0,94
ffffffffc020429c:	bf39                	j	ffffffffc02041ba <vprintfmt+0x208>
        return va_arg(*ap, int);
ffffffffc020429e:	000a2403          	lw	s0,0(s4)
ffffffffc02042a2:	b7ad                	j	ffffffffc020420c <vprintfmt+0x25a>
        return va_arg(*ap, unsigned int);
ffffffffc02042a4:	000a6603          	lwu	a2,0(s4)
ffffffffc02042a8:	46a1                	li	a3,8
ffffffffc02042aa:	8a2e                	mv	s4,a1
ffffffffc02042ac:	bdb1                	j	ffffffffc0204108 <vprintfmt+0x156>
ffffffffc02042ae:	000a6603          	lwu	a2,0(s4)
ffffffffc02042b2:	46a9                	li	a3,10
ffffffffc02042b4:	8a2e                	mv	s4,a1
ffffffffc02042b6:	bd89                	j	ffffffffc0204108 <vprintfmt+0x156>
ffffffffc02042b8:	000a6603          	lwu	a2,0(s4)
ffffffffc02042bc:	46c1                	li	a3,16
ffffffffc02042be:	8a2e                	mv	s4,a1
ffffffffc02042c0:	b5a1                	j	ffffffffc0204108 <vprintfmt+0x156>
                    putch(ch, putdat);
ffffffffc02042c2:	9902                	jalr	s2
ffffffffc02042c4:	bf09                	j	ffffffffc02041d6 <vprintfmt+0x224>
                putch('-', putdat);
ffffffffc02042c6:	85a6                	mv	a1,s1
ffffffffc02042c8:	02d00513          	li	a0,45
ffffffffc02042cc:	e03e                	sd	a5,0(sp)
ffffffffc02042ce:	9902                	jalr	s2
                num = -(long long)num;
ffffffffc02042d0:	6782                	ld	a5,0(sp)
ffffffffc02042d2:	8a66                	mv	s4,s9
ffffffffc02042d4:	40800633          	neg	a2,s0
ffffffffc02042d8:	46a9                	li	a3,10
ffffffffc02042da:	b53d                	j	ffffffffc0204108 <vprintfmt+0x156>
            if (width > 0 && padc != '-') {
ffffffffc02042dc:	03b05163          	blez	s11,ffffffffc02042fe <vprintfmt+0x34c>
ffffffffc02042e0:	02d00693          	li	a3,45
ffffffffc02042e4:	f6d79de3          	bne	a5,a3,ffffffffc020425e <vprintfmt+0x2ac>
                p = "(null)";
ffffffffc02042e8:	00002417          	auipc	s0,0x2
ffffffffc02042ec:	e6040413          	addi	s0,s0,-416 # ffffffffc0206148 <default_pmm_manager+0xf78>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc02042f0:	02800793          	li	a5,40
ffffffffc02042f4:	02800513          	li	a0,40
ffffffffc02042f8:	00140a13          	addi	s4,s0,1
ffffffffc02042fc:	bd6d                	j	ffffffffc02041b6 <vprintfmt+0x204>
ffffffffc02042fe:	00002a17          	auipc	s4,0x2
ffffffffc0204302:	e4ba0a13          	addi	s4,s4,-437 # ffffffffc0206149 <default_pmm_manager+0xf79>
ffffffffc0204306:	02800513          	li	a0,40
ffffffffc020430a:	02800793          	li	a5,40
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc020430e:	05e00413          	li	s0,94
ffffffffc0204312:	b565                	j	ffffffffc02041ba <vprintfmt+0x208>

ffffffffc0204314 <printfmt>:
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0204314:	715d                	addi	sp,sp,-80
    va_start(ap, fmt);
ffffffffc0204316:	02810313          	addi	t1,sp,40
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc020431a:	f436                	sd	a3,40(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc020431c:	869a                	mv	a3,t1
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc020431e:	ec06                	sd	ra,24(sp)
ffffffffc0204320:	f83a                	sd	a4,48(sp)
ffffffffc0204322:	fc3e                	sd	a5,56(sp)
ffffffffc0204324:	e0c2                	sd	a6,64(sp)
ffffffffc0204326:	e4c6                	sd	a7,72(sp)
    va_start(ap, fmt);
ffffffffc0204328:	e41a                	sd	t1,8(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc020432a:	c89ff0ef          	jal	ra,ffffffffc0203fb2 <vprintfmt>
}
ffffffffc020432e:	60e2                	ld	ra,24(sp)
ffffffffc0204330:	6161                	addi	sp,sp,80
ffffffffc0204332:	8082                	ret

ffffffffc0204334 <readline>:
...
ffffffffc0204336:	e486                	sd	ra,72(sp)
ffffffffc0204338:	e0a6                	sd	s1,64(sp)
ffffffffc020433a:	fc4a                	sd	s2,56(sp)
ffffffffc020433c:	f84e                	sd	s3,48(sp)
ffffffffc020433e:	f452                	sd	s4,40(sp)
ffffffffc0204340:	f056                	sd	s5,32(sp)
ffffffffc0204342:	ec5a                	sd	s6,24(sp)
ffffffffc0204344:	e85e                	sd	s7,16(sp)
    if (prompt != NULL) {
ffffffffc0204346:	c901                	beqz	a0,ffffffffc0204356 <readline+0x22>
ffffffffc0204348:	85aa                	mv	a1,a0
        cprintf("%s", prompt);
ffffffffc020434a:	00002517          	auipc	a0,0x2
ffffffffc020434e:	e1650513          	addi	a0,a0,-490 # ffffffffc0206160 <default_pmm_manager+0xf90>
ffffffffc0204352:	d69fb0ef          	jal	ra,ffffffffc02000ba <cprintf>
readline(const char *prompt) {
...
ffffffffc0204364:	d98b8b93          	addi	s7,s7,-616 # ffffffffc02110f8 <buf>
        else if (c >= ' ' && i < BUFSIZE - 1) {
ffffffffc0204368:	3fe00a13          	li	s4,1022
        c = getchar();
ffffffffc020436c:	d87fb0ef          	jal	ra,ffffffffc02000f2 <getchar>
        if (c < 0) {
ffffffffc0204370:	00054a63          	bltz	a0,ffffffffc0204384 <readline+0x50>
        else if (c >= ' ' && i < BUFSIZE - 1) {
ffffffffc0204374:	00a95a63          	bge	s2,a0,ffffffffc0204388 <readline+0x54>
ffffffffc0204378:	029a5263          	bge	s4,s1,ffffffffc020439c <readline+0x68>
        c = getchar();
ffffffffc020437c:	d77fb0ef          	jal	ra,ffffffffc02000f2 <getchar>
        if (c < 0) {
ffffffffc0204380:	fe055ae3          	bgez	a0,ffffffffc0204374 <readline+0x40>
            return NULL;
ffffffffc0204384:	4501                	li	a0,0
ffffffffc0204386:	a091                	j	ffffffffc02043ca <readline+0x96>
        else if (c == '\b' && i > 0) {
ffffffffc0204388:	03351463          	bne	a0,s3,ffffffffc02043b0 <readline+0x7c>
ffffffffc020438c:	e8a9                	bnez	s1,ffffffffc02043de <readline+0xaa>
        c = getchar();
ffffffffc020438e:	d65fb0ef          	jal	ra,ffffffffc02000f2 <getchar>
        if (c < 0) {
ffffffffc0204392:	fe0549e3          	bltz	a0,ffffffffc0204384 <readline+0x50>
        else if (c >= ' ' && i < BUFSIZE - 1) {
ffffffffc0204396:	fea959e3          	bge	s2,a0,ffffffffc0204388 <readline+0x54>
ffffffffc020439a:	4481                	li	s1,0
            cputchar(c);
...
ffffffffc02043a4:	009b87b3          	add	a5,s7,s1
ffffffffc02043a8:	2485                	addiw	s1,s1,1
ffffffffc02043aa:	00a78023          	sb	a0,0(a5)
ffffffffc02043ae:	bf7d                	j	ffffffffc020436c <readline+0x38>
        else if (c == '\n' || c == '\r') {
ffffffffc02043b0:	01550463          	beq	a0,s5,ffffffffc02043b8 <readline+0x84>
ffffffffc02043b4:	fb651ce3          	bne	a0,s6,ffffffffc020436c <readline+0x38>
            cputchar(c);
ffffffffc02043b8:	d39fb0ef          	jal	ra,ffffffffc02000f0 <cputchar>
            buf[i] = '\0';
ffffffffc02043bc:	0000d517          	auipc	a0,0xd
ffffffffc02043c0:	d3c50513          	addi	a0,a0,-708 # ffffffffc02110f8 <buf>
ffffffffc02043c4:	94aa                	add	s1,s1,a0
ffffffffc02043c6:	00048023          	sb	zero,0(s1)
            return buf;
        }
    }
}
ffffffffc02043ca:	60a6                	ld	ra,72(sp)
ffffffffc02043cc:	6486                	ld	s1,64(sp)
ffffffffc02043ce:	7962                	ld	s2,56(sp)
ffffffffc02043d0:	79c2                	ld	s3,48(sp)
ffffffffc02043d2:	7a22                	ld	s4,40(sp)
ffffffffc02043d4:	7a82                	ld	s5,32(sp)
ffffffffc02043d6:	6b62                	ld	s6,24(sp)
ffffffffc02043d8:	6bc2                	ld	s7,16(sp)
ffffffffc02043da:	6161                	addi	sp,sp,80
ffffffffc02043dc:	8082                	ret
            cputchar(c);
ffffffffc02043de:	4521                	li	a0,8
ffffffffc02043e0:	d11fb0ef          	jal	ra,ffffffffc02000f0 <cputchar>
            i --;
ffffffffc02043e4:	34fd                	addiw	s1,s1,-1
ffffffffc02043e6:	b759                	j	ffffffffc020436c <readline+0x38>

ffffffffc02043e8 <strlen>:
...
strlen(const char *s) {
ffffffffc02043ec:	872a                	mv	a4,a0
    size_t cnt = 0;
ffffffffc02043ee:	4501                	li	a0,0
    while (*s ++ != '\0') {
ffffffffc02043f0:	cb81                	beqz	a5,ffffffffc0204400 <strlen+0x18>
        cnt ++;
ffffffffc02043f2:	0505                	addi	a0,a0,1
    while (*s ++ != '\0') {
ffffffffc02043f4:	00a707b3          	add	a5,a4,a0
ffffffffc02043f8:	0007c783          	lbu	a5,0(a5)
ffffffffc02043fc:	fbfd                	bnez	a5,ffffffffc02043f2 <strlen+0xa>
...
strnlen(const char *s, size_t len) {
    size_t cnt = 0;
ffffffffc0204402:	4781                	li	a5,0
    while (cnt < len && *s ++ != '\0') {
ffffffffc0204404:	e589                	bnez	a1,ffffffffc020440e <strnlen+0xc>
ffffffffc0204406:	a811                	j	ffffffffc020441a <strnlen+0x18>
        cnt ++;
ffffffffc0204408:	0785                	addi	a5,a5,1
    while (cnt < len && *s ++ != '\0') {
ffffffffc020440a:	00f58863          	beq	a1,a5,ffffffffc020441a <strnlen+0x18>
ffffffffc020440e:	00f50733          	add	a4,a0,a5
ffffffffc0204412:	00074703          	lbu	a4,0(a4)
ffffffffc0204416:	fb6d                	bnez	a4,ffffffffc0204408 <strnlen+0x6>
ffffffffc0204418:	85be                	mv	a1,a5
    }
    return cnt;
}
ffffffffc020441a:	852e                	mv	a0,a1
ffffffffc020441c:	8082                	ret

ffffffffc020441e <strcpy>:
char *
...
ffffffffc020441e:	87aa                	mv	a5,a0
    while ((*p ++ = *src ++) != '\0')
ffffffffc0204420:	0005c703          	lbu	a4,0(a1)
ffffffffc0204424:	0785                	addi	a5,a5,1
ffffffffc0204426:	0585                	addi	a1,a1,1
ffffffffc0204428:	fee78fa3          	sb	a4,-1(a5)
ffffffffc020442c:	fb75                	bnez	a4,ffffffffc0204420 <strcpy+0x2>
        /* nothing */;
    return dst;
...
ffffffffc0204434:	0005c703          	lbu	a4,0(a1)
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0204438:	cb89                	beqz	a5,ffffffffc020444a <strcmp+0x1a>
        s1 ++, s2 ++;
ffffffffc020443a:	0505                	addi	a0,a0,1
ffffffffc020443c:	0585                	addi	a1,a1,1
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc020443e:	fee789e3          	beq	a5,a4,ffffffffc0204430 <strcmp>
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0204442:	0007851b          	sext.w	a0,a5
#endif /* __HAVE_ARCH_STRCMP */
}
ffffffffc0204446:	9d19                	subw	a0,a0,a4
ffffffffc0204448:	8082                	ret
ffffffffc020444a:	4501                	li	a0,0
ffffffffc020444c:	bfed                	j	ffffffffc0204446 <strcmp+0x16>
